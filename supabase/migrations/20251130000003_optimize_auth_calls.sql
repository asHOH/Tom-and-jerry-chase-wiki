-- Categories
DROP POLICY "Reviewers can insert categories" ON public.categories;
...
DROP POLICY "Reviewers can update categories" ON public.categories;
...
DROP POLICY "Reviewers can delete categories" ON public.categories;
...
-- Users
DROP POLICY "Coordinators can insert users" ON public.users;
...
DROP POLICY "Coordinators can update users" ON public.users;
...
DROP POLICY "Coordinators can delete users" ON public.users;
...
-- Article Versions
DROP POLICY "Reviewers can insert versions" ON public.article_versions;
...
DROP POLICY "Reviewers can update versions" ON public.article_versions;
...
DROP POLICY "Reviewers can delete versions" ON public.article_versions;
...
-- Articles
DROP POLICY "Authenticated can view articles" ON public.articles;
...
DROP POLICY "Reviewers can insert articles" ON public.articles;
...
DROP POLICY "Reviewers can update articles" ON public.articles;
...
DROP POLICY "Reviewers can delete articles" ON public.articles;
