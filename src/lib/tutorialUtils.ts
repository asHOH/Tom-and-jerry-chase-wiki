...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    message:
      '视频链接，点击此按钮后可以显示/隐藏视频链接输入框，对于B站上的视频，可以在网址后添加"?t=时间"表示视频开始播放的时间点（单位为s，精确到0.1）。如https://www.bilibili.com/video/BV1xK4y1d7f5?t=61.5，此处对应1分1.5秒。', // video link is generated by AI
    position: 'bottom',
  },
  {
