      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '朵朵进入虚弱时，[向固定方向弹出](电池将固定面朝前上方飞出，前方为墙壁时将反方向弹出)一枚{电池}（可被朵朵碰触，解除朵朵的虚弱状态，并立即恢复其50Hp和100%电量，且对自身半径250范围内造成{30*,电击}伤害和0.7秒眩晕；也可被其他老鼠拾取和投掷，命中敌方时破碎并造成{70*,电击}伤害（伤害来源为电池投掷者，被不同角色投掷时伤害可能不同）和0.7秒眩晕。被其他老鼠投掷的电池在命中敌方或碰到平台、地面时将会消失，电池存在12秒后也会自行消失，也可因{牛仔汤姆}-{斗牛}等技能碰撞而损毁并消失。',
            cooldown: 22,
          },
          {
            level: 3,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '[打自身后](若在锤击前自身剩余Hp不足以抵消锤击伤害，不会进入虚弱)，回复10Hp，随后{Hp上限提高}10（持续10秒，可叠加3层）。（注意：成功提高上限时也会同步回复10Hp；叠加层数达到3层后，再次获得时仅重置时间，不再额外回复Hp）',
            cooldown: 3,
          },
          {
            level: 3,
