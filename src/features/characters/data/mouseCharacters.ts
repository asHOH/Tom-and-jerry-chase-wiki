      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 3,
            description:
              '烟雾持续时间延长；敌方在烟雾内降低移速、跳跃高度和爪刀频率，且禁用技能与道具。',
            detailedDescription:
              '烟雾持续时间延长至6.5秒；敌方在烟雾内减速20%、跳跃高度降低20%、爪刀CD延长50%，且禁用技能与道具。',
            cooldown: 35,
          },
        ],
      },
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '附近1000范围内有敌方角色时，自身[CD倒计时加快33%](效果触发时，技能键上CD的显示值不变，但减少1秒CD所需的实际时间缩短为0.75秒)。',
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription: '无敌的持续时间延长至3.5秒。',
            cooldown: 45,
          },
        ],
      },
  ...
  剑客杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '原地进入1.4秒的格挡状态，该阶段下自身无法移动、[获得强{霸体}](不免疫斯派克的抓取)、使撞击自身的{斗牛}消失。受到爪刀攻击时进入反击阶段，0.4秒前摇后对猫造成[数点伤害](与技能等级有关)和2.5秒眩晕。反击也可通过再次点击技能键主动释放，对前方375、后方50范围内的敌方造成同等效果。\n反击释放后，1.2秒内技能键被替换为翻滚。翻滚阶段下，向前以1000的速度滚动0.9秒。翻滚开始或1.2秒未翻滚后，技能进入cd。被动触发的格挡反击[无视距离且必定命中](包括管道中的猫咪)、触发后自身回复25Hp并减少7秒技能CD。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: '无前摇',
  ...
  泰菲: {
    ...
    knowledgeCardGroups: [
      ...
      },
      {
        ...
        description:
          '干扰卡组，用来打依赖爪刀或有无敌霸体技能的猫。泰菲的{火箭筒}无法取消后摇，{缴械}可以在一定程度上防止霸体卡后摇反杀。',
        detailedDescription: '',
      },
      {
    ...
    skills: [
      {
        ...
        detailedDescription:
          '开始跳舞，期间获得{免控}，持续20秒。舞步分为两段，每段10秒，第二段的效果更强。第一段给予附近老鼠50%推速加成，附近猫咪爪刀CD增加20%，[并使隐身的猫咪显形](若猫咪持有护盾等状态则不会现形)；第二段改为100%推速加成、爪刀CD增加40%。每次受到伤害使跳舞的持续时间缩短6秒。再次点击技能键可以提前退出跳舞。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '被绑上15秒以下的火箭后，火箭引线会返回到15秒。被放飞后以“局外人”返场，Hp上限为624，且Hp以2/秒的速度降低，无法进行大部分交互，无法受到治疗，Hp清零时立即被放飞。返场期间可以用道具键投掷{柠檬}（造成{2.5*,不受来源影响}伤害并在2.5秒内降低10%移速，可触发{投掷命中效果})），内置CD2秒。与{库博}-{虚幻梦影}的天堂火箭[有特殊互动关系](表演者•杰瑞在只被绑上天堂火箭的时候无法触发复活，但如果表演者•杰瑞既被绑上天堂火箭又被绑上了普通火箭，那么引线燃烧完后仍然能触发复活)。',
          },
        ],
      },
    ],
