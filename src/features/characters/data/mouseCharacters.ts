  ...
  罗宾汉泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '在0.7秒后，在[自身前方150处](若拟生成藤蔓的位置有硬性墙体阻挡，实际位置会向罗宾汉泰菲进行移动，最低距离25)生成{藤蔓}。藤蔓生成时先出现高1100、宽250的可攀爬区域；该区域生成1.2秒后，在其顶端生成宽为350的平台和一个{藤蔓纸盒}。友方攀爬藤蔓的速度是爬普通梯子的4倍，敌方不变。敌方登上藤蔓顶端时受到1秒10%减速效果，且其在藤蔓顶端跳跃时会使藤蔓持续时间减少3秒。\n藤蔓纸盒：与{大纸盒}类似，但只会开出以下8种道具：{盘子}、{扁盘}、{玻璃杯}、{碗}、{叉子}、{高尔夫球}、{灰花瓶}、{奶酪}。携带“美食家”知识卡时，改为开出{牛奶}或{蛋糕}，与{小纸盒}/{大纸盒}共计次数。',
        canMoveWhileUsing: true,
        canUseInAir: false,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: '无后摇',
