  ...
  航海士杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        aliases: ['桶', '炸药桶'],
        description:
          '放置{火药桶(衍生物)}，延迟数秒后爆炸，对周围造成不分敌我的伤害和眩晕，对墙缝造成伤害，并{炸毁}范围内的火箭，因此救下老鼠时可以触发相关知识卡，但不获得相关局内金币。猫咪可以通过交互拆除火药桶，老鼠可以通过交互推动火药桶。火药桶被部分道具命中时缩短引爆时间。',
        detailedDescription:
  ...
  牛仔杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '可左右拖动和原地释放，在身边产生琴声区域，且自身向拖动方向移动，期间保留惯性。猫进入琴声区域的瞬间会陷入1秒的僵直（离开范围后可再次触发），在范围内停留超过0.5秒后会受到35%减速，且每秒受到{15*,不受来源影响,无视护盾,无视伤害保护}伤害，持续2.8秒。\n弹琴可通过跳跃键、移动键、道具键*主动结束释放；可空中释放但会立刻结束弹琴；最多持续弹奏5秒。\n{护盾}等状态可抵消吉他相关负面状态；已进入相关负面状态后，后续获得护盾等状态也不会解除。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        canHitInPipe: false,
        forecast: 0.9,
  ...
  恶魔泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '释放{飞行的小淘气}追踪并转化附近指定类型的道具。\n[部分易碎道具](玻璃杯/碗/盘子/扁盘)变成{蓝色小淘气}：被投掷后留在原地，范围内出现敌方时自动飞向对方，命中时造成伤害并使敌方3秒内无法使用技能和道具；\n[部分控制道具](灰花瓶/蓝花瓶/冰块)变成{红色小淘气}：被投掷后沿直线飞行，命中时造成少量伤害，并强制将敌方向当前背对方向击退一段距离；\n{高尔夫球}变成{绿色小淘气}：具有高尔夫球的大部分特点，但伤害更低，弹性更大，命中敌方不会消耗黑暗印记。\n此外，小淘气还可以影响小淘气还可以影响{老鼠夹}和{奶酪}：老鼠夹受影响会立刻打开；奶酪受影响后，搬运和被投掷时的速度更快。\n所有小淘气道具均可以被猫鼠双方使用。',
        detailedDescription:
          '检索一定范围内不处于移动期间的道具，释放{飞行的小淘气}分别追踪并转化这些道具，有数量上限。\n{玻璃杯}/{碗}/{盘子}/{扁盘}变成{蓝色小淘气}：被投掷后留在原地，范围内出现[未隐身的](隐身的敌方不会被蓝色小淘气索敌，且可正常将其拾取)敌方时自动飞向对方，命中时造成{20*}伤害（伤害来源为投掷者，被不同角色投掷时伤害可能不同），并使敌方3秒内无法使用技能和道具。处于等待索敌状态的蓝色小淘气速度为0，因此可[被再次拾取](包括被隐身的敌方拾取)。\n{灰花瓶}/{蓝花瓶}/{冰块}变成{红色小淘气}：被投掷后沿直线飞行，命中时造成{20*}伤害（伤害来源为投掷者，被不同角色投掷时伤害可能不同），并强制将敌方向当前背对方向击退一段距离，击退期间无法进行移动等操作。\n{高尔夫球}变成{绿色小淘气}：具有高尔夫球的大部分特点，但命中时仅造成{10*}伤害（伤害来源为投掷者，被不同角色投掷时伤害可能不同），且有比高尔夫球更大的弹性，命中敌方不会消耗黑暗印记。\n此外，小淘气还可以影响{老鼠夹}和{奶酪}：老鼠夹受影响会立刻被转变为{打开的老鼠夹}；奶酪受影响后附带额外的环绕特效，被搬起时使搬运者获得加速，被投掷时的初速度提高。\n所有小淘气道具均可以被猫鼠双方使用。',
        forecast: 1.5,
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '额外造成伤害和眩晕（可击落道具和老鼠）。',
            detailedDescription: '额外造成{80*}伤害并使敌方眩晕0.4秒、可以击落猫手中道具和老鼠。',
            cooldown: 15,
          },
          {
            level: 3,
        ...
        skillLevels: [
          {
            ...
            description: '',
            cooldown: 22,
            detailedDescription: '吉他每次对敌方造成{10*,不受来源影响,无视护盾}伤害。',
          },
          {
            level: 2,
  ...
  剑客莉莉: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '挥出一道{剑气}，剑气飞行速度1750，击中平台形成持续5秒的{幻影}，剑客莉莉再次点击技能可传送至幻影处；击中墙壁则不生成幻影，剑客莉莉再次点击技能按钮可传送至幻影处；击中墙壁则不生成幻影。剑气首次击中角色/{小黄鸭}时将反弹，击中敌方造成{10*}伤害，并降低其40%移速、跳跃高度，持续5秒；击中[友方](包括处于虚弱状态的友方)使其移速、救援速度、跳跃高度提高25%，持续5秒，且获得持续5秒且仅可使用一次的额外技能：使用额外技能将瞬移至幻影处。初始情况下，剑客莉莉的二段技能以及队友被命中后获得的额外技能均处于不可使用状态，只有幻影生成后才可再次使用。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        // cancelableSkill: '不确定是否可被打断', // FIXME
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription: '对敌方造成的眩晕可击落老鼠。对墙缝的伤害提高至{_15*}。',
            cooldown: 7,
          },
        ],
        cueRange: '本房间可见',
