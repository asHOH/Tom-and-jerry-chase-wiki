...
const mouseCharacterDefinitions = {
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '搬运{奶酪}时，移速大幅增加、跳跃高度大幅增加，同时视野不再降低。（该效果需技能加点后再次搬奶酪才会触发）',
          },
          {
            level: 3,
            description:
            ...
            detailedDescription:
              '每当奶酪被推进或墙缝首次被破坏到80%、60%、40%、20%、0%时，解除虚弱和受伤、回复Hp、且移速提高，持续2.7秒。',
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription: '友方在烟雾内加速20%，跳跃高度提升50%，推速固定提升5.75%/秒。',
            cooldown: 35,
          },
          {
            level: 3,
            description:
              '烟雾持续时间增加；敌方在烟雾内降低移速、跳跃高度和爪刀频率，且禁用技能和道具。',
            detailedDescription:
              '烟雾持续时间增加至6.5秒；敌方在烟雾内减速20%、跳跃高度降低20%、爪刀CD延长50%，且禁用技能和道具。',
            cooldown: 35,
          },
        ],
      },
    ...
    skills: [
      {
        ...
        detailedDescription:
          '全体队友短暂加速10%，并[获得二段跳状态](可被部分免疫状态的效果免疫，例如自身的降落伞降落期间)（可在空中[进行1次额外跳跃](从上一次接触平台/地面起，至多进行2次跳跃，再次接触平台/地面时重置)）。不同等级二段跳提供的移速加成可叠加。\n该状态属于{多段跳}。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        detailedDescription:
          '打开降落伞，[将自身竖直方向的速度重置为向上的100](因此会向上飘一小段距离)，并获得使重力加速度变为1000/秒²的{失重}状态；降落期间无视所有平台，且获得{绝对霸体}状态，接触地面后进入0.65秒不可取消的后摇；降落过程中可随时[进行1次额外跳跃](该跳跃属于技能效果，额外跳跃不受跳跃次数的限制，但仍记为一次跳跃（例如在二段跳情况下可通过普通跳跃+降落伞跳跃进行二段跳，但此时无法再通过二段跳效果进行三段跳；反之若通过普通跳跃+二段跳跳跃进行二段跳，那仍可通过降落伞效果进行三段跳）)，{绝处逢生}也可终止技能。', //包括绝大多数负面和正面效果，如二段跳，干扰器隐身；部分“接触地面时”延迟触发的效果除外，如平底锅的落地伤害和眩晕、Lv.3魅力甲油的使敌方粘在地板上的效果
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '不可取消',
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 10,
            detailedDescription: '降落伞状态结束后，移速和救援速度提高20%，持续3秒。',
          },
          {
            level: 3,
            description: '',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '附近1000范围内有敌方角色时，自身[CD倒计时加快33%](效果触发时，技能键上CD的显示值不变，但减少1秒CD所需的实际时间变为0.75秒)。',
          },
        ],
      },
    ],
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '金币命中敌方会连续造成两段伤害和眩晕，分别为{55}和{60}，可分别击破一层护盾。',
            cooldown: 15,
          },
        ],
      },
      {
        ...
        detailedDescription:
          '放置{火药桶(衍生物)}，延迟数秒后爆炸，对周围造成不分敌我的[伤害](对其他角色（包括敌方和队友，不包括自身）的伤害会受攻击增伤的影响)和眩晕，[对墙缝造成伤害](会直接炸毁墙缝上的泡泡，且仍造成全额伤害)，并{炸毁}[范围内](火药桶的下端判定相对较大)的火箭，若其上有老鼠则[将其救下](视作航海士杰瑞进行的救援，可触发知识卡-无畏/舍己等，但不会获得救人应得的金币)。猫咪可以[通过交互拆除火药桶](动作时长1秒)，老鼠可以通过交互推动火药桶。火药桶被其他道具（如金币、所有易碎道具、火炮发射出的老鼠等）命中时，引爆时间缩短5秒。\n火药桶与其他道具的互动关系：火药桶可被{小鞭炮}或{鞭炮束}炸飞，在火药桶左侧的鞭炮会使火药桶呈抛物线飞出，右侧的鞭炮会使火药桶水平滑行。使用特定道具斜向下45°打击桶外侧可使桶产生横向加速，其中{扁盘}产生的加速较大，约为{玻璃杯}的两倍。未引爆的鞭炮也可以使桶位移，且不会缩短引线。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '火药桶引爆时间为8秒，引爆造成不分敌我的[1](基础伤害1，对其他角色（包括敌方和队友，不包括自身）的伤害会受攻击增伤的影响，例如对敌方造成的伤害为21)伤害与1.4秒眩晕，对墙缝造成{_21.5}伤害，被炸毁的火箭65秒后自动修复。',
            cooldown: 45,
          },
          {
            level: 2,
          ...
          {
            level: 3,
            description: '引爆时间缩短；爆炸伤害进一步提高；被炸毁的火箭不再自动修复。',
            detailedDescription:
              '引爆时间缩短至3秒；爆炸对角色的伤害提升至[50](基础伤害50，对其他角色（包括敌方和队友，不包括自身）的伤害会受攻击增伤的影响，例如对敌方造成的伤害为70)；被炸毁的火箭不再自动修复。',
            cooldown: 30,
          },
        ],
      },
      {
        ...
        detailedDescription:
          '放置{火炮}，持续数秒后消失。老鼠可通过交互键进入火炮（交互动作时长1秒），通过拖拽投掷键选择方向发射自身，无视部分平台阻挡，碰到敌方或[部分物体](包括墙缝泡泡，雪夜古堡卧室国王，天宫嫦娥等)会[反弹](速度不变，方向遵循反射定律，碰撞角色时的反射面固定为竖直面)，若为敌方则对其造成[50](基础伤害50，受被发射者的攻击增伤影响，视作被发射者造成的伤害。例如航海士杰瑞自己使用时会造成70伤害)伤害与1.5秒眩晕，碰到绑在火箭上的队友时自动进行救援交互，碰到地面或跳跃时结束被发射状态。火炮内不会被投掷道具及部分技能命中。若火炮内老鼠进入虚弱，则火炮会提前消失。同一房间最多出现两个火炮。火炮会对所有角色展示在小地图上。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        // cancelableSkill: '不确定是否可被打断', // FIXME
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '武器技能CD减少30秒；额外在一段时间内提升攻击增伤。',
            detailedDescription: '武器技能CD减少30秒；额外提升15攻击增伤，持续14.9秒。',
            cooldown: 10,
          },
        ],
        cooldownTiming: '释放后',
      ...
      },
      {
        ...
        detailedDescription:
          '原地进入1.4秒的格挡状态，该阶段下自身无法移动、[获得强{霸体}](无法免疫斯派克的抓取)、使撞击自身的{斗牛}消失。受到爪刀攻击时进入反击阶段，0.4秒前摇后对猫造成{40}点伤害和2.5秒眩晕。反击也可通过再次点击技能键主动释放，对前方375、后方50范围内的敌方造成同等效果。\n反击释放后，1.2秒内技能键被替换为翻滚。翻滚阶段下，向前以1000的速度滚动0.9秒。翻滚开始或1.2秒未翻滚后，技能进入cd。被动触发的格挡反击[无视距离且必定命中](包括管道中的猫咪)、触发后自身回复25Hp并减少7秒技能CD。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: '无前摇',
  ...
  泰菲: {
    ...
    skillAllocations: [
      {
        ...
        description: '',
        additionaldescription:
          '如果七级就进入墙缝战的话，可以考虑直接点出{3级被动}，毕竟墙缝期容易被爆炸物炸死',
      },
      {
        id: '隐形感应雷',
        pattern: '1313[30]001',
    ...
    knowledgeCardGroups: [
      {
        cards: ['S-舍己', 'S-铁血', 'C-救救我', 'B-食物力量', 'C-美食家'],
        description: '主推卡组，食物力量加快推奶酪速度，美食家有利于前期开箱子快速叠食物力量层数',
      },
      {
        cards: ['S-舍己', 'S-铁血', 'C-救救我', 'S-缴械'],
        description:
          '干扰卡组，用来打依赖爪刀或有无敌霸体技能的猫。泰菲的{火箭筒}不能取消后摇，{缴械}可以在一定程度上防止霸体卡后摇反杀。',
        detailedDescription: '',
      },
      {
        cards: ['S-舍己', 'S-铁血', 'C-救救我', 'C-不屈', 'B-精准投射'],
        description: '干扰卡组，牵制能力强，有{精准投射}在可以做到6秒一个无敌，{不屈}增加续航。',
      },
      {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '发射一枚{火箭筒}，直接命中敌方时造成一段伤害，对猫造成18%减速，且可触发[投掷效果](指的是以投掷命中为条件的效果，包括知识卡-缴械/精准投射/投手/追风，特技-干扰投掷/勇气投掷)；直接命中墙缝时[随机造成4.5~9伤害](泰菲自身破坏增伤0.5+火箭筒基础伤害4~8.5，具体伤害量随机，同一位置出现的伤害也会有不同，具体成因不详)；命中敌方角色/墙壁/平台/其他道具后爆炸，对一定范围内敌方造成伤害和眩晕，对一定范围内墙缝[随机造成3.5~9伤害](泰菲自身破坏增伤0.5+爆炸冲击波基础伤害3~8.5，具体伤害量随机，同一位置出现的伤害也会有不同，具体成因不详)。先结算直接命中伤害，后结算爆炸伤害。爆炸产生的冲击波可以炸飞老鼠夹、叉子等道具。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: '不可取消',
        forecast: 0.8,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '免疫鞭炮、泡泡等爆炸（不免疫{3级追求者出击}的爆炸以及太空堡垒的药水罐爆炸等）；吃食物速度提升45%。',
          },
        ],
      },
    ],
    ...
    specialSkills: [
      ...
      },
      {
        name: '绝处逢生',
        description:
          '可以在队伍无稳救时带，用于硬抗控制伤害，适用相对来说于控多伤少的猫（如剑汤、长爪托普斯），自起本身解控加快速回血配合圆滚滚的解控加无敌效果一共可以免疫两次硬控，并保证健康值充足，达到硬抗控制伤害的效果',
      },
      {
        name: '应急治疗',
        description:
          '适合新手带,{舍己}跳救{圆滚滚}后秒点治疗，用于续航，也可以用于防止被米特的胡椒粉毒死。配合被动使用效果很好',
      },
      {
        name: '干扰投掷',
        description:
          '适合新手带,用来打出干扰投掷接炮，提高炮命中率，增加容错（注意不要手快点出无影炮），也可以先放{隐形感应雷}然后迅速用干扰投掷控住猫，大大增加地雷命中率，用于打机动性高、速度快导致炮和地雷不易命中的猫。',
      },
      {
        name: '冰冻保鲜',
        description:
          '可以在队伍无稳救时带，用于硬抗控制伤害，适用相对来说控少伤多且伤害持续的猫（如兔八哥、布奇、如玉），冰保和圆滚滚的双重无敌可以抵挡绝大部分的灌伤和控制，并且能随时取消释放，防止被卡时间',
      },
    ],
    ...
    skills: [
      {
        ...
        detailedDescription:
          '只有勇气释放期间才能释放本技能。向前冲刺0.7秒，冲刺期间移速提高50%，并恢复少量勇气。途经敌方会对其造成{40}伤害，但消耗一定的勇气。途经[部分NPC](如森林牧场大鸭子、小黄鸭等，尚未详细测试)也会消耗勇气。',
        canMoveWhileUsing: false,
        canUseInAir: false,
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '只有勇气释放期间才能释放本技能。举起{头盔(衍生物)}保护自己和队友，期间{无敌}，但惯性增大；小范围内的队友也{无敌}，但{禁用技能}。头盔受击会减少0.5s；救下队友后头盔剩余时间减半。',
        detailedDescription:
          '只有勇气释放期间才能释放本技能。举起{头盔(衍生物)}保护自己和队友，期间{无敌}，但惯性增大、移速降低3.5%、跳跃速度降低15%；小范围内的队友也{无敌}，但{禁用技能}。头盔[受击](包括爪刀、道具、技能、来自友方的伤害)会减少0.5s；救下队友后头盔剩余时间减半。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        canHitInPipe: false,
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        detailedDescription:
          '蓄力投掷{长枪}。蓄力期间视野扩大到原来的2倍，同时清除原有的视野提升效果。蓄力时间越长，长枪速度越快。蓄力至最大值需0.8s。长枪在空中会缓慢旋转。长枪对触碰的敌方造成{60}伤害和20%减速，持续2.4s。在投掷后的1.8s内，可再次点击技能[上枪](瞬移到长枪尾部跟随飞行)。长枪碰到队友后，可携带1名友方进行飞行，长枪上的老鼠进行[任何操作](包括松开/按下；按键包括移动键、跳跃键、道具键、药水键（需要有药水）、技能键和特技键（包括未冷却完成和被禁用的技能；不包括被动技能的图标）、技能加点（包括被动加点）、交互键、进机器鼠键、商店购买道具（仅松开时；若上枪前已经开始购买，那么在长枪上购买完毕不会导致离开长枪）)都将离开长枪，受到眩晕或虚弱会强制离开；如果上枪时长枪恰好经过平台也会导致立刻脱离长枪。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪最大存在时间为9.9s，在碰到墙壁、地面、向下碰到平台时消失。长枪消失、投掷1.8秒后或自己上枪后技能进入CD。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
        forecast: 0.15,
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '长枪速度大幅提高，蓄力超过2/3时会对敌方造成额外控制效果。勇气释放期间，长枪命中猫咪时将使其无法使用技能并掉落手中道具、带飞友方时解除其受伤和虚弱。',
            cooldown: 8,
            detailedDescription:
              '长枪速度大幅提高，蓄力超过2/3但未到最大值时，命中敌方效果改为造成[2.8s眩晕](不会减速)（无法与部分眩晕效果叠加，详见{眩晕}）；蓄力达到最大值时改为[造成3s眩晕](不会减速)。勇气释放期间，长枪命中猫咪时将使其无法使用技能4.8s并掉落手中道具，带飞友方时解除其受伤和虚弱。',
          },
          {
            level: 3,
  ...
  牛仔杰瑞: {
    ...
    skills: [
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '放置{大仙人掌}，持续90秒。猫咪踩中受到1.2秒硬直、15%减速、7.5/s的伤害，[持续3s](只造成两次伤害)，同时仙人掌消失。同一目标3秒内不会重复触发；减速最多叠加3层。所有老鼠不受仙人掌的影响，但鼠方踩踏两次后仙人掌消失。',
            cooldown: 18,
          },
          {
            level: 2,
            description: '减速和伤害效果加强。被踩中后会分裂为3个效果稍弱的{小仙人掌}。',
            cooldown: 18,
            charges: 2,
            detailedDescription:
              '效果提升至20%减速、10/s的伤害，[持续5s](只造成四次伤害)。{大仙人掌}被踩中后会分裂为3个{小仙人掌}，猫咪踩中受到0.8秒的硬直、13%减速、7.5/s的伤害，[持续3s](只造成两次伤害)；减速最多叠加三层；小仙人掌的减速与持续伤害与大仙人掌独立计算，同时小仙人掌继承大仙人掌的持续时间。小仙人掌被鼠方踩踏两次后消失，大仙人掌老鼠踩一次就会分裂。',
          },
          {
            level: 3,
      ...
      },
      {
        ...
        detailedDescription:
          '可左右拖动和原地释放，弹琴并向拖动方向移动，期间保留惯性。猫首次听到音乐时会陷入1s的僵直，[持续听到音乐](0.5s)后会受到35%减速并以15/s降低Hp，持续2.8s。弹琴可通过跳跃键、移动键、道具键*主动结束释放；空中释放会立刻解除；最多持续弹奏5s。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        canHitInPipe: false,
        forecast: 0.9,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription: '{主动技能}和{武器技能}对猫控制时间提高50%。',
          },
        ],
      },
    ],
    ...
    skills: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '技能读条时间变为12秒，传送门存在时间为30秒，敌方传送后受到额外伤害。',
            detailedDescription:
              '技能读条时间变为12秒，传送门存在时间为30秒，敌方传送后[受到60伤害](该伤害无伤害来源，因此不受攻击增伤影响)。',
            cooldown: 25,
          },
          {
            level: 3,
  ...
  恶魔泰菲: {
    ...
    mousePositioningTags: [
      ...
      },
      {
        ...
        isMinor: false,
        description:
          '一武复制水果盘道具，主动也能吸附道具快速砸墙，二武三级可直接对墙缝造成固伤和易伤，但对泡泡无效。',
        additionalDescription: '',
      },
      {
        tagName: '干扰',
    ...
    knowledgeCardGroups: [
      {
        ...
        description:
          '适合有三级回家的一武恶菲，上限卡，墙缝期高容错，基本上保证打出五层护盾，对意识要求较高，高端局主流配卡',
      },
      {
        cards: ['S-铁血', 'S-舍己', 'C-救救我', 'A-投手', 'C-不屈'],
        description:
          '适合二武恶菲。投手提高牵制能力，不屈提高后期容错，本卡组适合打以斯飞为代表的非单刀且一定程度依赖移速的猫咪。',
      },
      {
        cards: ['S-舍己', 'S-铁血', 'S-缴械', 'C-救救我'],
        description:
          '没21点知识量时的推荐，缴械配合蓝色小淘气让猫变白板，但蓝恶魔只有3秒限制，高端局依旧不好救人',
      },
      {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '释放小淘气们影响附近道具。\n[部分易碎道具](玻璃杯/碗/盘子/扁盘)变成{蓝色小淘气}：被投掷后留在原地，范围内出现敌方时自动飞向对方，命中时造成伤害并使敌方3秒内无法使用技能和道具；\n[部分控制道具](灰花瓶/蓝花瓶/冰块)变成{红色小淘气}：被投掷后沿直线飞行，命中时造成少量伤害，并向右击退敌方；\n{高尔夫球}变成{绿色小淘气}：具有高尔夫球的特点，但伤害更低，且有比高尔夫球更大的弹性，命中敌方不会消耗黑暗印记。\n此外，小淘气还可以影响[捕鼠夹](指未打开的捕鼠夹)和奶酪；捕鼠夹受影响会立刻打开；奶酪受影响后，被搬起时获得加速、被投掷时的初速度提高。\n所有小淘气道具均可以被猫鼠双方使用。',
        detailedDescription:
          '释放小淘气们飞向附近道具，对其产生影响。\n[部分易碎道具](玻璃杯/碗/盘子/扁盘)变成{蓝色小淘气}：被投掷后留在原地，范围内出现[敌方](隐身的敌方除外)时自动飞向对方，命中时造成[20伤害]，会受攻击增伤的影响，例如被恶魔泰菲投掷时的实际伤害为35，并使敌方3秒内无法使用技能和道具。处于等待索敌状态的蓝色小淘气速度为0，因此可[被再次拾取](包括被隐身的敌方拾取)。；\n[部分控制道具](灰花瓶/蓝花瓶/冰块)变成{红色小淘气}：被投掷后沿直线飞行，命中时造成[20伤害](会受攻击增伤的影响，例如被恶魔泰菲投掷时的实际伤害为35)，并使敌方向背对方向击退一段距离，击退期间无法移动。；\n{高尔夫球}变成{绿色小淘气}：具有高尔夫球的特点，但只有[10伤害](会受攻击增伤的影响，例如被恶魔泰菲投掷时的实际伤害为25)，且有比高尔夫球更大的弹性，命中敌方不会消耗黑暗印记。\n此外，小淘气还可以影响[捕鼠夹](指未打开的捕鼠夹)和奶酪：捕鼠夹受影响会立刻打开；奶酪受影响后，被搬起时使搬运者获得加速、被投掷时的初速度提高。\n所有小淘气道具均可以被猫鼠双方使用。',
        forecast: 1.5,
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 12,
            detailedDescription: '花洒持续时间增加至7.6秒。',
          },
          {
            level: 3,
    ...
    skillAllocations: [
      {
        ...
        weaponType: 'weapon1',
        description:
          '一般建议留加点，如{1级被动}可以等猫拍你的时候点，能救一命，打部分[技能输出猫](如牛仔汤姆)可以优先点出{3级被动}。',
        additionaldescription: '',
      },
      {
        id: '止戈雷云',
        ...
        weaponType: 'weapon2',
        description:
          '加点灵活，开局队友暴毙、刷二手火箭则优先祝福，否则被动。后期打部分[技能输出猫](如牛仔汤姆)可以优先点出{3级被动}。',
        additionaldescription: '',
      },
    ],
    knowledgeCardGroups: [
      ...
      },
      {
        ...
        description: '20知识量用的卡组，{夹不住我}可替换为其他3知识量的知识卡，如{孤军奋战}等。',
      },
      {
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '开始吟唱，给予周围范围内火箭上和猫手上的队友[祝福状态](头上出现光圈)，持续30秒。该状态的队友被放飞不会立刻淘汰而是在[固定位置](只与地图有关，每个地图都有固定点位)以复活体的形式返回游戏。复活体会持续暴露小地图位置，且一旦Hp到达[0](即老鼠倒地起身时的血量。这意味着尼宝翻滚、佩克斯三级主动等“免疫虚弱”的效果并不能防止其被淘汰)或被抓起将立刻淘汰。',
        detailedDescription:
          '开始吟唱，解除自身的失明与反向状态，并在约1.1秒后给予周围范围内火箭上和[猫手上](不包括托普斯捕虫网中、泰克抓取、跟随苏蕊跳舞、被塔拉或追风汤姆扔向火箭且正在飞行中)的队友[祝福状态](头上出现光圈)，持续30秒。老鼠从猫手中以绑火箭外的任何形式脱离，[将失去祝福状态](但塔拉或追风汤姆用特殊技能绑火箭时，如果被提前在猫手上祝福过，则可以正常生效)。祝福状态的老鼠从火箭上被救下将返还40秒CD。祝福状态的队友被放飞不会立刻淘汰而是在[固定位置](只与地图有关，每个地图都有固定点位)以复活体的形式返回游戏。复活体一旦Hp到达[0](即老鼠倒地起身时的血量。这意味着尼宝翻滚、佩克斯三级主动等“免疫虚弱”的效果并不能防止其被淘汰)或被抓起将立刻淘汰。复活体会持续暴露小地图位置，但可通过进机器鼠，拿白色花等方式暂时隐藏。如果老鼠在铁血期间被放飞，则重生时为铁血状态、铁血结束直接被淘汰；如果在铁血结束后十秒内被放飞，重生时将是虚弱状态，被猫抓取会直接被淘汰。如果受到流血类伤害钻进机器鼠，且在机器鼠内死亡，则会留下一个机器鼠空壳。\n与其他角色之间的互动：表演者•杰瑞被放飞会优先判定三级被动的复活。如果复活体被托普斯捕虫网抓扔上火箭，则会正常读秒计时，此时再受到祝福会显示图标但无法生效、复活体在火箭被放飞时淘汰。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: '不可主动打断',
        cancelableAftercast: '不可取消',
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '点按技能射出一发{弓箭}，命中友方为其回复Hp；命中敌方造成伤害。长按技能开始蓄力，蓄力满射出一发{蓄力箭}，命中友方为其回复更多Hp；命中敌方造成更高伤害和眩晕。中途取消释放将返还一半CD。',
        detailedDescription:
          '点按技能射出一发{弓箭}，命中友方为其回复25Hp且加速10%，持续1.6秒；命中敌方造成{30}伤害。长按技能开始蓄力，蓄力至少1.83秒后可以射出一发{蓄力箭}，命中友方为其回复50Hp且加速5%，持续1.6秒；命中敌方造成{55}伤害和1.4秒[眩晕](无视苏蕊的跳舞，但不打断跳舞或队友的跟随；无视天使汤姆二级被动的霸体，且可救下队友)。点按可以在空中射出，但蓄力弓箭无法在空中射出。射箭时天使可以调整[出射角度](约上下15度)。射出后的弓箭飞行[无视地形](平台，地板，天花板均不会影响；经典之家的厨房挡板除外)，直到击中其他角色或森林牧场大鸭子。弓箭射出方向为出射时所按的方向键，若未按则为拉弓时角色朝向。弓箭受到重力，但[速度大小不变，只改变方向](不受外力时，箭的竖直速度逐渐增大而水平速度逐渐减小，并非严格的抛物线)。弓箭可被鞭炮影响而改变飞行轨迹。中途可以取消释放，会返还一半CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '治疗、伤害效果增强；蓄力箭命中虚弱老鼠将解除其虚弱状态。',
            cooldown: 12,
            detailedDescription:
              '弓箭伤害提高为{55}，蓄力箭提高为{105}；弓箭对友方治疗效果提高为50，蓄力箭提高为99。蓄力箭命中虚弱友方老鼠将解除其虚弱状态。',
          },
        ],
      },
      {
        ...
        skillLevels: [
          {
            ...
            detailedDescription: '受到来自猫咪的伤害时，禁用其爪刀5秒。（CD：10秒）',
          },
          {
            level: 2,
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '展开光盾，期间获得减伤、转移附近友方所受的部分伤害和控制效果到自身，且附近火箭减缓燃烧速度、倒计时自然归零时暂时不放飞。优先使用怜悯值抵扣转移的伤害。转移队友的控制效果时，如果这个控制效果带有直接抓取效果，免疫该直接抓取效果。',
        detailedDescription:
          '展开光盾，持续12秒，期间获得15减伤、[转移范围内队友所受的部分伤害和控制效果到自身](结算“转移伤害”效果时，使伤害改为由天使泰菲及队友共同承担，比例由转移伤害比例决定；若“受到的伤害值”超过队友的Hp上限，则实际分摊的伤害值改为等同于队友Hp上限；自身因转移受到的伤害视作无来源的伤害。结算“转移控制”效果时，解除队友受到的控制效果，同时自身受到对应的控制效果；若该控制效果附带伤害，则自身会再次受到伤害，因此会出现“1次带控制的伤害=2次伤害”的情况)，且范围内的火箭减缓燃烧速度、倒计时归零时暂时不放飞（对[秒飞火箭](因绑上老鼠立刻减少倒计时而导致倒计时归零的火箭)不生效）。优先使用怜悯值抵扣转移的伤害，每1%怜悯值可承担1伤害。转移队友的控制效果时，如果这个控制效果带有直接抓取效果，免疫该直接抓取效果。\n\n（本技能改动频繁，特性复杂，可能仍有机制暂未探明，数据仅供参考）', //[本技能有争议](另一种减伤说法：25伤害变10,50伤害变35,65伤害变45,75伤害变55,100伤害变65,115虚弱；另一种怜悯值消耗说法：100%怜悯值可承担60伤害)。
        canMoveWhileUsing: false,
        canUseInAir: true,
        ...
        skillLevels: [
          {
            ...
            detailedDescription: '伤害转移比例为50%。火箭在范围内减少20%的燃烧速度。',
            cooldown: 16,
          },
          {
            level: 2,
          ...
          },
          {
            level: 3,
            description:
              '若开启庇护时自身的怜悯值超过50%，消耗20%的怜悯值并在技能持续期间免疫虚弱。',
            cooldown: 16,
          },
        ],
        cueRange: '无音效',
        ...
        skillLevels: [
          {
            level: 1,
            description: '',
            detailedDescription: '消耗怜悯值会增加20反弹伤害。',
            cooldown: 20,
          },
          {
            level: 2,
          ...
          },
          {
            ...
            detailedDescription:
              '消耗怜悯值改为增加35反弹伤害。若开启庇护时自身的怜悯值超过30%，则消耗30%怜悯值获得5秒[霸体](免疫绝大多数控制效果，但不免疫虚弱)。',
            cooldown: 10,
          },
        ],
      },
      {
        ...
        skillLevels: [
          {
            level: 1,
            description: '怜悯值低于80%时，怜悯值自然增长速度提高。',
            detailedDescription: '怜悯值低于80%时，怜悯值自然增长速度提高到2.5%/秒。',
          },
          {
            level: 2,
            description: '怜悯值高于20%时，获得Hp恢复效果。',
            detailedDescription:
              '怜悯值高于20%时，[获得2.5/s的Hp恢复效果](该类效果不会因受伤而失效)。',
          },
          {
            level: 3,
            description: '怜悯值高于40%时，Hp上限提高。',
            detailedDescription: '怜悯值高于40%时，Hp上限提高50。',
          },
        ],
        description:
          '天使泰菲拥有怜悯值充能条。怜悯值自然增长，也在同一房间的队友受到伤害时增加。怜悯值可供{主动技能}和{武器技能}消耗。',
        detailedDescription:
          '天使泰菲拥有怜悯值充能条。怜悯值以1.5%/s的速度自然增长，也在同一房间的队友受到伤害时增加（每1伤害增加0.7%怜悯值）。怜悯值可供{主动技能}和{武器技能}消耗。',
      },
    ],
    specialSkills: [
      {
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '{主动技能}的卡牌命中[任意目标](包括：猫咪/兔子大表哥/森林牧场大鸭子)时，[获得一张随机颜色的新卡牌](若此时魔术师手中有道具，则不触发该效果，也不进入CD)（[该效果有30秒内置CD](吃蛋糕也会减少该CD)）；还会减少{主动技能}与{武器技能}CD各10秒，同时获得两次（400/己方存活人数）点经验。',
          },
          {
            level: 2,
            description:
            ...
            detailedDescription:
              '{主动技能}的卡牌命中[任意目标](包括：猫咪/兔子大表哥/森林牧场大鸭子)时，若魔术师[手中的道具](如果此时魔术师手中没有道具，则为下一个道具)属于[指定类型的道具](包括：玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/冰块/番茄/叉子)，则它被魔术师投掷命中[其他角色](包括猫咪和被冰块误伤的其他老鼠，不包括兔子大表哥等)时，额外[为该角色附加卡牌效果](卡色取决于上一次命中的卡牌；只触发卡牌效果，不会触发Lv.1被动)，[直到魔术师获得下一张卡牌](被该技能影响的道具被放下/被装入蓝花瓶中时，效果依然存在；魔术师获得新卡牌时，上一个被该技能影响的道具的效果会被清除)；若该道具不是[指定类型的道具](包括：玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/冰块/番茄/叉子)，则无事发生。',
          },
          {
            level: 3,
            description:
    ...
    skills: [
      {
        ...
        detailedDescription: '发出声波，击退琴头方向的猫咪1700距离。前摇期间可以移动和跳跃。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: ['道具键*', '跳跃键'],
        forecast: 0.75,
      ...
      },
      {
        ...
        detailedDescription:
          '持续演奏吉他2.6秒，弹奏范围为半径750的圆，友方进入范围后0.35、0.75、1.15、1.55、1.95、2.35秒回复10Hp。猫咪减速22%，并在进入范围后0.35、0.75、1.15、1.55秒叠加一次（覆盖原有效果），此后不再叠加；在进入范围1.95、2.35秒后再施加一次[4级减速效果](减速77%)。减速效果持续0.8秒，猫咪进入范围后1.4秒、2.4秒将分别受到10伤害。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
  ...
  拿坡里鼠: {
    ...
    skills: [
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '披萨饼碰撞会造成[25伤害](该伤害来源为拿坡里鼠，对拿坡里鼠自身造成伤害时不受攻击增伤影响，对其他角色（包括队友）造成的伤害受攻击增伤影响，因此通常为35)和1.9秒眩晕，破碎后基础生成1个披萨块。',
            cooldown: 20,
          },
          {
            level: 2,
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '开始蓄力，期间无法移动、[完全失重](完全不会因受到重力而向下坠落。若该状态下受到其他受力效果（如鞭炮爆炸等），则会以固定速度进行位移)且增大视野；随后可踢出{闪耀足球}，命中敌方时造成“强光耀眼”状态（受到伤害，并且[失明](除自身所在位置以外的大部分区域被黑暗笼罩)，降低交互速度，再次受到来自拿坡里鼠的伤害会眩晕2秒（眩晕有8秒内置CD））。足球存在时间与蓄力时间有关。足球可以反复弹跳。',
        detailedDescription:
          '[点击技能开始蓄力](蓄满力需1.7秒，此后最多保持蓄力状态3.5秒，到达时间后强制施放技能)，蓄力期间无法移动、[完全失重](完全不会因受到重力而向下坠落。若该状态下受到其他受力效果（如鞭炮爆炸等），则会以固定速度进行位移)且增大视野半径100%。松开技能键或一段时间后结束蓄力，踢出{闪耀足球}，命中敌方时造成“强光耀眼”状态（受到[30伤害](不受攻击增伤影响)，并且[失明](除自身所在位置以外的大部分区域被黑暗笼罩)，降低25%交互速度，此期间受来自拿坡里鼠的伤害会眩晕2秒（眩晕有8秒内置CD），该状态持续8秒，免疫失明的技能也会完全免疫该状态）。足球可触发{缴械}/{投手}。[有效蓄力时间越长，足球存在时间越长](有效蓄力时长最长1.7秒，足球持续时间和速度由蓄力时间阶段性决定，并非线性关系)。足球碰到道具/墙壁/地板后会被反弹，可以反复弹跳。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 3,
            description:
              '分身持续时间增加。分身存在期间，可以再次点击技能键与分身换位（CD：8秒）。',
            detailedDescription:
              '分身存在时间增加至11.9秒。分身存在期间，可以再次点击技能键与分身换位（CD：8秒），但爬梯子、被眩晕时无法换位。',
            cooldown: 15,
          },
        ],
        canHitInPipe: false,
        ...
        skillLevels: [
          {
            level: 1,
            description: '',
            detailedDescription: '饮料分身存在9.9秒。',
            cooldown: 28,
          },
          {
            level: 2,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '创造一道{风之屏障}，风墙大小500*500，持续一小段时间。[敌方会被风墙阻挡，无法进出风墙](位于风墙内的敌方仍可通过部分传送及强制位移类技能离开，如莱特宁-瞬移闪击，库博-虚幻梦影)。风墙对所有角色造成判定干扰，如猫的爪刀、拍子无法穿过风墙，风墙卡位时老鼠不能推奶酪。小跳风可将正在绑火箭的猫挤出火箭从而强行阻止猫绑火箭。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        // cancelableSkill: '不确定是否可被打断', // FIXME
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription: '在风墙中心半径850范围内老鼠虚弱时间减少5秒。',
            cooldown: 20,
          },
          {
            level: 3,
            description: '风墙持续时间增加，屏障内猫咪将无法使用技能和道具。',
            detailedDescription: '风墙持续时间增加至4.5秒，屏障内猫咪将无法使用技能和道具。',
            cooldown: 20,
          },
        ],
      },
      {
        ...
        detailedDescription:
          '挥出一道{剑气}，剑气飞行速度1750，击中平台形成持续5秒的{幻影}，剑客莉莉再次点击技能可传送至幻影处；击中墙壁则不生成幻影，剑客莉莉再次点击技能按钮可传送至幻影处；击中墙壁则不生成幻影。剑气首次击中角色/{小黄鸭}时将反弹，击中敌方造成[30](基础伤害10+剑客莉莉攻击增伤20，同时也能享受其他来源的攻击增伤加成)伤害，并降低其40%移速、跳跃高度，持续5秒；击中[友方](包括处于虚弱状态的友方)使其移速、救援速度、跳跃高度提高25%，持续5秒，且获得持续5秒且仅可使用一次的额外技能：使用额外技能将瞬移至幻影处。初始情况下，剑客莉莉的二段技能以及队友被命中后获得的额外技能均处于不可使用状态，只有幻影生成后才可再次使用。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        // cancelableSkill: '不确定是否可被打断', // FIXME
        cancelableAftercast: '无后摇',
  ...
  罗宾汉泰菲: {
    ...
    skills: [
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '碰撞敌方造成{55}点伤害和20%减速，持续2秒，敌方减速期间不会再次受到该技能效果。碰撞墙缝造成{_10.5}点伤害。',
            cooldown: 7,
          },
          {
            level: 2,
          ...
          {
            level: 3,
            description: '对敌方造成的眩晕可击落老鼠。提高对墙缝的伤害。',
            detailedDescription: '对敌方造成的眩晕可击落老鼠。对墙缝的伤害提高至{_15.5}。',
            cooldown: 7,
          },
        ],
        cueRange: '本房间可见',
      },
      {
        ...
        type: 'weapon1',
        description:
          '生成{藤蔓}，并在藤蔓顶端生成平台和{藤蔓纸盒}。藤蔓可攀爬，且被友方攀爬的速度大幅提高。敌方登上藤蔓顶端时受到1秒减速效果，且其在藤蔓顶端跳跃时会使藤蔓持续时间减少。',
        detailedDescription:
          '在0.7秒后，在[自身前方150处](若拟生成藤蔓的位置有硬性墙体阻挡，实际位置会向罗宾汉泰菲进行移动，最低距离25)生成{藤蔓}。藤蔓生成时先出现高1100、宽250的可攀爬区域；该区域生成1.2秒后，在其顶端生成宽为350的平台和一个{藤蔓纸盒}。友方攀爬藤蔓的速度是爬普通梯子的4倍，敌方不变。敌方登上藤蔓顶端时受到1秒减速效果，且其在藤蔓顶端跳跃时会使藤蔓持续时间减少。\n藤蔓纸盒：与{大纸盒}类似，但只会开出以下8种道具：{盘子}、{扁盘}、{玻璃杯}、{碗}、{叉子}、{高尔夫球}、{灰花瓶}、{奶酪}。携带“美食家”知识卡时，改为开出{牛奶}或{蛋糕}，与{小纸盒}/{大纸盒}共计次数。',
        canMoveWhileUsing: true,
        canUseInAir: false,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: '无后摇',
        skillLevels: [
          ...
          {
            level: 2,
            description: '持续时间提高；站上藤蔓平台将回复Hp。',
            detailedDescription:
              '持续时间提高到15秒，友方[站上藤蔓平台](离开再重新回到平台/在平台和平台边缘间来回走动也能触发回复，并刷新持续恢复的持续时间)立刻回复27Hp并获得8Hp/秒的恢复效果，持续3秒。该效果结束后有5秒内置CD。',
            cooldown: 15,
            charges: 2,
          },
          {
        ...
        skillLevels: [
          {
            level: 1,
            description:
              '使猫在5秒内无法使用爪刀（20秒内无法重复触发），并[解除其隐身效果](该效果无视护盾影响)。',
            cooldown: 25,
          },
          {
            level: 2,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '大表哥点击按钮后可选择绑在火箭上和被猫抓在手中的队友，瞬移到其上方并在0.65s后落下，若成功落下且没有受到任何效果打断，可在0.25s后将附近半径250内的道具击飞；当怒气满时，可在下落0.5s内通过向左右拖动按钮来攻击对应方向的目标，前摇0.6s，造成50伤害，并眩晕2.4s，后摇0.75s。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '攥起拳头。再次使用技能将向按键拖动的方向挥出拳头，并在满怒时提升效果。\n按键向上-升龙拳：向上打飞敌方，同时熄灭火箭；满怒时额外打飞火箭。\n按键向前/不拖动-游龙拳：向前打飞敌方，同时熄灭火箭；满怒时增加击退距离、撞到易碎道具时产生额外伤害和眩晕、并可打入一定进度的奶酪。\n按键向下-地龙拳：原地打晕敌方，并施加减速；满怒时增加眩晕时间、可能使敌方掉下其所在的平台。',
        detailedDescription:
          '之后的30秒内，再次使用技能将向按键拖动的方向挥出拳头。挥出拳头后立刻进入CD。成功挥出拳头有0.15s前摇，对前方[范围290](三种拳头都一样)的猫咪造成50点伤害，挥拳后有1s后摇。满怒时，使用技能改为对拳头充气，充气需1.4s，之后可在20s内至多挥出3次拳头，前后摇、伤害不变，但期间[无法使用道具](但可通过商店买道具在手上取消后摇)，每次挥拳有3秒CD。\n按键向上-升龙拳：造成[1s](满怒时为0.9s)眩晕，并击飞1.1s，对墙缝造成1点伤害，熄灭范围内点燃的火箭；满怒时额外向上击飞火箭2.5s。\n按键向前/不拖动-游龙拳：造成1s眩晕，并击退500距离，对墙缝造成1点伤害，熄灭范围内点燃的火箭；满怒时眩晕时间提高至1.5s，击退距离提高至1500，且敌方在击退过程中会撞碎[易碎道具](包括：玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/番茄/水果盘-果子/牛仔杰瑞-仙人掌，不包括冰块)，撞碎时受到2.8s眩晕和[50伤害](受马索尔增伤影响；不会受到道具本身的伤害，且与道具本身无关；眩晕时间与道具本身无关)（无法与部分眩晕效果叠加，详见{眩晕}），还可将洞中的奶酪打入[12.5%](不受其他推速加成影响)。\n按键向下-地龙拳：造成0.9s眩晕，眩晕结束后敌方受到17.5%的减速，持续5s；满怒时眩晕时间提高至1.4s，且若目标站在平台上，可能向下掉落。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: ['道具键*'],
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '技能平时禁用，在米雪儿或附近队友队友受到猫攻击后激活。点击技能将原地大哭诉说委屈，期间将获得1层护盾。友方老鼠进入范围后可对米雪儿进行安抚，期间获得护盾，安抚结束后友方将变成增强版的{比利鼠}。',
        detailedDescription:
          '技能平时禁用，在自己和以自己为中心半径1500内的队友受到猫攻击后激活30秒。点击技能将原地大哭诉说委屈，持续3.9秒，并获得1层持续7.9秒的护盾。哭泣750*750的矩形范围内将下起伤心的雨，对敌方造成25%减速。友方老鼠进入范围后可通过交互对米雪儿进行安抚，安抚前摇[较短](在2026/3/26更新前为0.6秒，之后有所缩短，待测试)，前摇前获得1层持续7.8秒的护盾。安抚结束后友方将变成体型更大且伤害更高的{比利鼠}，持续9.9秒（爪刀前摇0.5秒，后摇0.5秒，爪刀范围[300](与汤姆相同)，对敌方造成110的基础伤害，并造成20%减速，持续1.9秒；对墙伤害为1.5）。哭时使用道具键*取消后摇或安抚成功后，将清除米雪儿的护盾；队友未安抚不会清除米雪儿的护盾；若在队友安抚的途中取消后摇不会清除队友的护盾，且该护盾能抵消虚弱状态。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: ['道具键*'],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 5,
            detailedDescription:
              '变形的持续时间提高至90秒，变身期间攻击力提高15、对墙伤害提升3、救援速度提升60%，并在变身结束后保持3秒。',
          },
        ],
      },
      {
        ...
        type: 'weapon2',
        description:
          '米雪儿浮上气球，可快速漂浮移动，也可选择范围内的目标发起跟随。\n跟随目标后，移除{受伤}、获得{无敌(状态)}和Hp恢复状态、与跟随目标视作一个单位，仅可通过跳跃键主动退出跟随。\n跟随队友时，使用本技能为其加速，并在其Hp比例低于自身时平衡双方Hp。若队友虚弱，米雪儿可主动解除跟随并到队友身边进行治疗。队友被猫抓住或被绑上火箭后解除跟随。被跟随的队友在{铁血}期间无法安抚米雪儿。\n跟随对手时，使用本技能使其减速，并在其Hp比例高于自身时平衡双方Hp。有跟随时间限制。',
        detailedDescription:
          '根据米雪儿的附身情况，本技能的效果有所变化。\n解锁本技能后可展开小轮盘（视作一个额外技能），点击该键后会展开“可跟随目标”轮盘，显示一定范围内的可选目标头像，点击头像后向目标飞去，飞行期间{无敌(状态)}，抵达目标位置后开始跟随对方，成功跟随时会掉落自身手中道具、移除{受伤}。\n进入和解除跟随状态时，该键会进入12秒[固定CD](不受冷却相关状态效果影响)，已在CD中时不会重新计算CD。\n“可跟随目标”轮盘不会实时更新，若选择了范围外的目标则无事发生（不进入CD）。\n\n初始形态下：释放本技能时，在短暂前摇后进入“漂浮”状态（“漂浮”为贴图表现，并无失重效果），期间获得10%加速。“漂浮”状态会因跳跃解除，不会因交互/拾取道具/投掷道具等动作解除。\n跟随任意目标后：自身悬浮在目标左前/右前方固定位置（可通过移动键切换），跟随目标移动，视野切换至与目标一致；持有{无敌(状态)}和Hp恢复状态；可以正常阻挡投掷道具和技能衍生物；无法自主移动、交互、拾取和使用道具；可正常使用主动和武器技能且不解除跟随；可通过跳跃键退出跟随。\n跟随队友时：使用本技能无前摇，使用后立即为其加速，且在其当前Hp与Hp上限的比例低于米雪儿时触发平衡Hp效果。若队友受伤或虚弱，米雪儿可通过交互键立即解除跟随并开始治疗对方。队友被抓住或被绑上火箭后也会解除跟随。被跟随的队友在{铁血}期间无法安抚米雪儿（详见主动技能描述）。\n跟随对手时：使用本技能无前摇，使用后立即使其减速，且在其当前Hp与Hp上限的比例高于米雪儿时触发平衡Hp效果。跟随时技能进入短暂读条，读条结束后自动解除跟随。\n\n平衡Hp效果：将双方当前Hp相加，随后按双方最大Hp的比例进行分配，使分配后双方的当前Hp与Hp上限的比例一致。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '[使用技能](包括主动技能、武器技能、特技等)会触发共鸣冲击波(音乐家杰瑞自身2层，1800范围内队友1层)，共鸣180范围内可对敌方造成{20}伤害并减速3秒。共鸣叠加3层时对敌方造成1秒僵直（可救下猫咪手中的老鼠；内置CD：10秒），僵直期间猫咪不会受到任何伤害及控制。',
          },
          {
            level: 2,
            description: '5秒内对火箭造成5次共鸣后会摧毁火箭，45秒后恢复。',
            detailedDescription: '5秒内对火箭造成5次共鸣后会摧毁火箭。被摧毁的火箭45秒后恢复。',
          },
          {
            level: 3,
            description: '共鸣对墙缝造成伤害。',
            detailedDescription:
              '共鸣对墙缝造成伤害，[基础伤害为2](实际伤害受共鸣冲击波产生者的墙缝增伤加成，例如由自身产生的共鸣冲击波实际造成3伤害)，但不对泡泡造成伤害。',
          },
        ],
      },
    ],
  ...
  尼宝: {
    ...
    knowledgeCardGroups: [
      ...
      },
      {
        ...
        description:
          '提高容错，在只有泥巴一个救援位或者队友不好救下时可以自己下来。下来后翻滚能提高生存能力，所以不用为了幸运把救救我换脱身。同时幸运在一些情况下也可以断节奏（例如可消耗掉猫咪的穷追猛打）。',
      },
      {
        cards: ['S-铁血', 'S-舍己', 'B-逃之夭夭', 'C-不屈', 'C-救救我'],
  ...
  朵朵: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '加装强力能源装置，获得[电量条](电量上限100，获得电量条时电量为100)，电量缓慢下降，虚弱时清空电量；可通过食物、药水回复100电量，从猫手上掉落或从火箭上被救下回复80电量。\n电量条有三种颜色，对应以下三个形态：\n常态-绿色指示灯：无特殊效果。\n过载状态-黄色爆闪指示灯：开启本技能时立刻回复100电量并进入过载状态，再次使用可关闭并退出该状态。爆发性提高移速、跳跃速度、攻击增伤和投掷物的速度，但会加速消耗电量，电量小于30时自动结束过载状态。\n亏电状态-红色指示灯：电量低于30时将进入亏电状态。移速和跳跃速度降低，且无法释放本技能。当电量归零时，[强制原地充能2秒](无法移动、交互、使用道具或技能等)，恢复到80电量。',
        detailedDescription:
          '加装强力能源装置，获得[电量条](电量上限100，获得电量条时电量为100)，电量以0.5/秒的速度下降，虚弱时清空电量；可通过食物、药水、被{仙女鼠}-{仙女棒}1星命中回复100电量，从猫手上掉落或被火箭上救下回复80电量。\n电量条有三种颜色，对应以下三个形态：\n常态-绿色指示灯：无特殊效果。\n过载状态-黄色爆闪指示灯：开启本技能时立刻回复100电量并进入过载状态，再次使用本技能可以主动关闭技能退出过载状态。期间移速和跳跃速度提高20%，攻击增伤提高20，投掷物被投掷时的初速度提高至2000，{主动技能}的充能速度增加100%，但消耗电量速度大幅提高，电量小于30时自动结束过载状态。\n亏电状态-红色指示灯：电量低于30时将进入亏电状态。移速和跳跃速度降低13%，且无法释放本技能。当电量归零时，[强制原地充能2秒](无法移动、交互、使用道具或技能等，同时以20/秒的速度恢复电量，持续4秒，结束后进入1秒动作后摇)，恢复到80电量。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '朵朵进入虚弱时，[向固定方向弹出](电池将固定面朝前上方飞出，前方为墙壁时将反方向弹出)一枚{电池}（可被朵朵碰触，解除虚弱并恢复Hp和电量，且对周围造成[电击伤害](电击伤害会使目标感电，每层感电使受到的电击伤害增加，可叠加)和眩晕；也可被其他老鼠拾取和投掷，命中敌方时破碎并造成[电击伤害](电击伤害会使目标感电，每层感电使受到的电击伤害增加，可叠加)和眩晕。电池一定时间后将自行消失）。',
            detailedDescription:
              '朵朵进入虚弱时，[向固定方向弹出](电池将固定面朝前上方飞出，前方为墙壁时将反方向弹出)一枚{电池}（可被朵朵碰触，解除朵朵的虚弱状态，并立即恢复其50Hp和100%电量，且对自身半径250范围内造成{40}的[电击伤害](电击伤害会对目标附加感电，使受到的电击伤害增加15，持续9.9秒，可叠加。感电结束时获得5秒电免疫状态，免疫电击伤害)和0.7秒眩晕；也可被其他老鼠拾取和投掷，命中敌方时破碎并造成[70](基础伤害70，同时也能享受到其他来源的攻击增伤加成，包括投掷者的角色攻击增伤)的[电击伤害](电击伤害会对目标附加感电，使受到的电击伤害增加15，持续9.9秒，可叠加。感电结束时获得5秒电免疫状态，免疫电击伤害)和0.7秒眩晕。被其他老鼠投掷的电池在命中敌方或碰到平台、地面时将会消失，电池存在12秒后也会自行消失。可因{牛仔汤姆}-{斗牛}等技能碰撞而损毁并消失）。',
            cooldown: 22,
          },
          {
            level: 3,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 3,
            description:
              '当朵朵Hp降低到一定比例时，施放一次电流保护自己，造成[电击伤害](电击伤害会使目标感电，每层感电使受到的电击伤害增加，可叠加)和眩晕，如果处于过载状态，还会提高眩晕时间。',
            detailedDescription:
              '当朵朵Hp降低到现Hp上限的50%时，立即向自身半径250范围内释放电流，造成{40}的[电击伤害](电击伤害会对目标附加感电，使受到的电击伤害增加15，持续9.9秒，可叠加。感电结束时获得5秒电免疫状态，免疫电击伤害)和0.9秒眩晕；如果处于过载状态，还会提高眩晕时间至1.2秒。',
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '拍摄到的猫咪额外[受到60伤害](不受攻击增伤加成；该效果后于照片生成结算，因此敌方被回溯时仍然为原先的Hp)，且在被拍摄状态持续期间[失明](除自身所在位置以外的大部分区域被黑暗笼罩)。',
            cooldown: 30,
          },
          {
            level: 3,
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '开始跳舞，期间获得{免控}，持续20秒，舞步效果在跳舞10秒后增强。期间给予附近老鼠推速加成、增加附近猫咪爪刀CD，[并使隐身的猫咪显形](若猫咪持有护盾等状态则不会现形)。每次受到伤害使跳舞的持续时间减少6秒。再次点击技能键可以提前退出跳舞。',
        detailedDescription:
          '开始跳舞，期间获得{免控}，持续20秒。舞步分为两段，每段10秒，第二段的效果更强。第一段给予附近老鼠50%推速加成，附近猫咪爪刀CD增加20%，[并使隐身的猫咪显形](若猫咪持有护盾等状态则不会现形)；第二段改为100%推速加成、爪刀CD增加40%。每次受到伤害使跳舞的持续时间减少6秒。再次点击技能键可以提前退出跳舞。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        detailedDescription:
          '莱恩扔出{蓝图-投射物(衍生物)}，碰到敌方/平台/地面（不包括{方块}/{强化方块}）、[部分npc](如{大鸭子})或莱恩再次使用本技能时，[展开](蓝图的贴图需要一小段时间才能完全展开，该动画期间莱恩无法使用技能收回蓝图，但蓝图效果在未完全展开时就已经生效)一个大小1000×666的{蓝图(衍生物)}。接触蓝图的{火箭}变为{线条火箭}（燃烧速度减少20%），猫咪[隐身状态暂时失效](离开蓝图时恢复)且受到伤害时会短暂变为线条猫，持续6秒，变身时手持道具与老鼠自然掉落。变身结束后一段时间内{免疫线条猫效果}。再次使用技能或持续较长时间后收回蓝图，蓝图收起后才会进入CD。\n线条猫：只可使用移动、跳跃和爪刀，但受到的伤害和[受控时间](包括虚弱时间)减少50%，爪刀CD减少40%。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: '不可取消',
        skillLevels: [
      ...
      },
      {
        ...
        detailedDescription:
          '在半径800范围内绘制{圆形}、{三角}和{方块}，绘制前摇0.1秒。在蓝图上绘制时，两种图形碰撞可合成其他老鼠的技能道具或召唤物。\n{圆形}○：释放后向莱恩的朝向方向滚动，产生阻挡并对触碰的敌方造成[30伤害](不受攻击增伤影响)、并击落道具；碰撞3次后或存在10秒后消失。\n{三角}△：对踩中的敌方造成[15伤害](不受攻击增伤影响)、12.5%减速和绑火箭速度下降35%，持续7秒；被敌方踩中或持续10秒后消失。\n{方块}□：停留在生成位置，可被推动，可作为平台或墙壁使用；碰撞四次、被爪刀攻击或25秒后消失。\n\n蓝图合成配方：\n△+○={1级火药桶}\n△+□={1级爱之花洒}\n○+□={1级隐形感应雷}\n○+○={1级意式披萨}\n△+△={2级藤蔓}\n□+□={1级烟雾弹}',
        canMoveWhileUsing: true,
        canUseInAir: true,
        canHitInPipe: false,
        skillLevels: [
          ...
          },
          {
            ...
            charges: 3,
            detailedDescription:
              '在蓝图上绘制时，改为绘制对应的强化图形。\n{强化圆形}●：会进行弹跳，[伤害提高为50](不受攻击增伤影响)，但移速减慢至原来的60%。\n{强化三角}▲：踩中后将飞出3个普通{三角}。\n{强化方块}■：反弹碰到的敌方，第一次反弹0.65秒，其余反弹0.1秒。',
          },
          {
            level: 3,
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '共3个效果：\n1.第一次被绑上火箭后触发[星星棒](星星棒是一次挣扎速度较慢，但挣扎进度充满时直接挣脱的特殊火箭挣扎。通过该技能获得的星星棒与幸运不同，不会在下火箭时获得护盾效果)（该效果仅在对局前120秒生效,且优先于{幸运}生效）。\n2.每次从火箭上被解救时，自动释放香甜梦境（不进入CD）。\n3.受到伤害或即将虚弱时，若剩余Hp小于50%，则自动释放香甜梦境（进入CD且直接进入快速移动效果）。',
          },
          {
            level: 2,
            description:
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '进入危险和安全来回切换的不稳定状态，初始为危险状态，每3秒切换一次。\n危险状态：受到伤害会产生爆炸区域，然后退出不稳定状态。爆炸区域持续2秒，进入该区域的敌方受到2秒{爆炸}，进入该区域的友方被弹开，并{炸毁}位于该区域的{火箭}，该火箭12秒后恢复。\n安全状态：移速提高，受到攻击会减少进入危险状态的间隔。',
        detailedDescription:
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '尝试吃掉一个道具，成功吃掉则获得加速、减少武器技能大量CD、同时增加一格饱食度。饱食度积累到三层时，立即变身为{巨大泰菲球}。\n巨大泰菲球：变身时恢复大量Hp但掉落手持道具，随后免疫部分控制且获得{减伤}，但无法进行部分交互。可使用技能撞击敌方，造成伤害、减速并恢复自身Hp，短时间命中三次会额外造成{眩晕}。变身时间耗尽或Hp归零时解除变身。',
        detailedDescription:
          '[尝试吃掉面前200单位距离内的一个道具](优先选择范围内更靠近右侧的道具，可吃掉处于被投掷状态期间的道具)，若成功吃掉一个道具则获得5秒15％加速、减少武器技能30秒CD、同时增加一格饱食度。饱食度积累到三层时，立即变身为{巨大泰菲球}。\n巨大泰菲球：变身时立即恢复150Hp但掉落手持道具。变身期间移速提高30%并获得额外技能，可以进行开关门、钻管道等交互，但无法使用道具或是进行救援、推奶酪等交互。变身期间[免疫部分负面状态](受到伤害及眩晕等状态时会播放“炸毛”动画，该动画可被绝大多数操作取消，不影响行动；变身期间免疫虚弱，但由于Hp归零会导致解除变身，因此实际上仅能在Hp归零前免疫一次会导致虚弱的伤害)，并且{减伤}30%。变身持续20秒，时间耗尽或Hp归零时解除该状态。进入和解除该状态时有特殊动画（因Hp归零而解除该状态时除外）。\n巨大泰菲球-攻击：朝圣者泰菲使用额头向前撞击，撞击范围为300单位距离，命中敌方时恢复自身Hp并对敌方造成{35}伤害和持续2.5秒10％的减速效果，敌方处于撞击造成的减速效果期间被连续撞击三次会进入眩晕状态，持续1.5秒。撞击可对墙缝造成{_3}伤害。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '不可主动打断',
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription: '圆球状态命中敌方改为恢复25Hp。',
            cooldown: 5,
          },
        ],
        cueRange: '全图可见',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '木塞子速度提升，最长存在时间增加至30秒，可命中墙缝。',
            detailedDescription:
              '木塞子飞行速度提升至1800单位长度/秒，最长存在时间增加至30秒，可命中墙缝并对其造成{_3.5}伤害。',
            cooldown: 30,
            charges: 4,
          },
        ],
