      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '{主动技能}的卡牌命中[任意目标](包括：猫咪/兔子大表哥/森林牧场大鸭子)时，尝试为魔术师[手持的道具](若卡牌命中时魔术师手中有道具，则为此道具；反之为下一个道具。不包括各类饮料)附加以下效果：被魔术师投掷命中[其他角色](包括猫咪和被冰块误伤的其他老鼠，不包括兔子大表哥等)时，额外[为该角色附加卡牌效果](卡色取决于上一次命中的卡牌；只触发卡牌效果，不会触发Lv.1被动)。该效果持续到成功触发或[魔术师获得下一张卡牌](被该技能影响的道具被放下/被装入蓝花瓶中时，效果依然存在；魔术师获得新卡牌时，上一个被该技能影响的道具的效果会被清除)。若该道具无法被附加该效果，则无事发生。\n\n可被附加该效果的道具：{盘子}/{扁盘}/{玻璃杯}/{碗}/{叉子}/{高尔夫球}/{香水瓶}/{胡椒瓶}/{番茄}/{冰块}/{灰花瓶}/{蓝花瓶}。',
          },
          {
            level: 3,
            description:
            ...
            detailedDescription:
              '当魔术师[即将进入虚弱状态](有关铁血：即将触发铁血前以及铁血效果结束时均会进行一次判定。其它类似效果同理)时，若手持部分可消耗道具，则有35%的概率消耗该道具并[免疫这次虚弱](仍会受到伤害和其他效果，如受伤、减速和眩晕等)。\n\n可供消耗的道具：{红色卡牌}/{黄色卡牌}/{蓝色卡牌}/{盘子}/{扁盘}/{玻璃杯}/{碗}/{香水瓶}/{胡椒瓶}/{番茄}/{冰块}/{灰花瓶}/{蓝花瓶}。',
          },
        ],
      },
    ],
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 20,
            detailedDescription: '电流改为造成{70*,电击}伤害，且控制时间提升至1.2秒。',
          },
          {
            level: 3,
            description:
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '加装强力能源装置，获得[电量条](电量上限100%，获得电量条时电量为100%)，电量缓慢下降，虚弱时清空电量；可通过食物、药水回复100%电量，从猫手上掉落或从火箭上被救下回复80%电量。\n电量条有三种颜色，对应以下三个形态：\n常态-绿色指示灯：无特殊效果。\n过载状态-黄色爆闪指示灯：开启本技能时立刻回复100%电量并进入过载状态，爆发性提高移速、跳跃速度、攻击增伤和投掷物的速度，但会加速消耗电量，电量小于30%时自动结束过载状态，再次使用可关闭并退出该状态。\n亏电状态-红色指示灯：电量低于30%时将进入亏电状态。移速和跳跃速度降低，且无法释放本技能。当电量归零时，[强制原地充能2秒](无法移动、交互、使用道具或技能等)，恢复到80%电量。',
        detailedDescription:
          '对本技能加点后，朵朵加装强力能源装置，获得[电量条](电量上限100%，获得电量条时电量为100%)，电量以0.5%/秒的速度下降，虚弱时清空电量；可通过食物、药水、被{仙女鼠}-{仙女棒}1星命中回复100%电量，从猫手上掉落或被火箭上救下回复80%电量。\n电量条有三种颜色，对应以下三个形态：\n常态-绿色指示灯：无特殊效果。\n过载状态-黄色爆闪指示灯：开启本技能时立刻回复100%电量并进入过载状态，过载期间移速和跳跃速度提高20%，攻击增伤提高20，投掷物被投掷时的初速度提高至2000，{主动技能}的充能速度增加100%，但消耗电量速度大幅提高，电量小于30%时自动结束过载状态，再次使用本技能可以主动关闭技能退出过载状态。\n亏电状态-红色指示灯：电量低于30时将进入亏电状态。移速和跳跃速度降低13%，且无法释放本技能。当电量归零时，[强制原地充能2秒](无法移动、交互、使用道具或技能等，同时以20%/秒的速度恢复电量，持续4秒，结束后进入1秒动作后摇)，最终恢复到80%电量。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '朵朵进入虚弱时，[向固定方向弹出](电池将固定面朝前上方飞出，前方为墙壁时将反方向弹出)一枚{电池}（可被朵朵碰触，解除朵朵的虚弱状态，并立即恢复其50Hp和100%电量，且对自身半径250范围内造成{30*,电击}伤害和0.7秒眩晕；也可被其他老鼠拾取和投掷，命中敌方时破碎并造成{70*,电击}伤害（伤害来源为电池投掷者，被不同角色投掷时伤害可能不同）和0.7秒眩晕。被其他老鼠投掷的电池在命中敌方或碰到平台、地面时将会消失，电池存在12秒后也会自行消失。可因{牛仔汤姆}-{斗牛}等技能碰撞而损毁并消失）。',
            cooldown: 22,
          },
          {
            level: 3,
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '[可铲飞敌方猫](铲飞效果类似眩晕+向上方的击退，猫在被铲飞时解除其他控制效果，过程中为霸体)，但被铲飞的敌方[在铲飞期间及结束后5秒内](若铲飞被敌方护盾、霸体、无敌等效果免疫，则不会触发后续免疫效果，因此可借助转向来在单次技能期间击破多层护盾)免疫该效果。每次滑铲命中减少CD。乾坤袋在附近时，铲飞还会造成少量伤害和{眩晕}（可击落老鼠）。',
            cooldown: 15,
            detailedDescription:
              '[可铲飞敌方猫1秒](铲飞效果类似眩晕+向上方的击退，猫在被铲飞时解除其他控制效果，铲飞过程中前0.7秒为霸体)，但被铲飞的敌方[在铲飞期间及结束后5秒内](若铲飞被敌方护盾、霸体、无敌等效果免疫，则不会触发后续免疫效果，因此可借助转向来在单次技能期间击破多层护盾)免疫该效果。每次命中减少8秒CD。乾坤袋在附近时，铲飞还会造成{10*,不受来源影响,不可攻击泡泡}伤害和1秒{眩晕}（可击落老鼠）（该效果与铲飞本身合计击破1层护盾）。',
          },
          {
            level: 3,
            description: '',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '被绑上15秒以下的火箭后，火箭引线会返回到15秒。被放飞后以“局外人”返场，Hp上限为624，且Hp以2/秒的速度降低，无法进行大部分交互，无法受到治疗，Hp清零时立即被放飞。返场期间可以用道具键投掷{柠檬}（造成{2.5*,不受来源影响}伤害并在2.5秒内降低10%移速，可触发{投掷命中效果})），内置CD2秒。与{库博}-{虚幻梦影}的天堂火箭[有特殊互动关系](表演者•杰瑞在只被绑上天堂火箭的时候不能触发复活，但如果表演者•杰瑞既被绑上天堂火箭又被绑上了普通火箭，那么引线燃烧完后仍然能触发复活)。',
          },
        ],
      },
    ],
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '进入梦境，期间提高推速，受到伤害时解除控制，然后在短时间内免疫虚弱并进入强制移动状态，该状态下碰到敌方会造成减速和伤害。[香甜梦境持续期间](未进入强制移动状态前)再次点按本技能键可退出梦境状态。',
        detailedDescription:
          '进入梦境，期间推速增加50%，受到伤害会[解除控制](包括自身原有的控制（例如被“老鼠夹”夹住），以及该伤害带来的新控制)，然后[在1.9秒内免疫虚弱并以800的速度强制移动](强制移动期间可跳跃和改变移动方向，只能通过部分动作前摇自行取消（例如“进机器鼠”或{绝处逢生}的前摇）。强制移动不会因受到伤害打断，但会被眩晕打断。若在触发受伤但未导致虚弱的伤害导致的强制移动状态期间被攻击至虚弱，则刷新持续时间。若强制移动期间因受力等原因改变速度，则会持续保持该速度，这可能造成自身被“硬控在原地”)，强制移动时每次碰到敌方会对其造成{20*,不受来源影响}伤害并降低20%移速，持续1.5秒。[香甜梦境持续期间](未进入强制移动状态前)再次点击技能可在1.25秒前摇后结束梦境，后摇1秒。梦境可持续40秒。\n该技能效果先于{铁血}触发。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        forecast: 1.25,
        aftercast: 1,
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '进入危险和安全来回切换的不稳定状态，初始为危险状态，每3秒切换一次。\n危险状态：受到伤害会产生爆炸区域，然后退出不稳定状态。爆炸区域持续3秒，进入该区域的敌方受到2秒{爆炸}控制状态（会掉落道具和老鼠）；位于该区域的友方会被弹开；位于该区域的{火箭}会被{炸毁}，12秒后恢复。\n安全状态：移速提高，受到攻击会减少进入危险状态的间隔。',
        detailedDescription:
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '不稳定状态持续时间提高。爆炸区域可[弹开](为单纯的受力效果，与“投掷”不同，不会命中敌方)附近的部分道具。',
            cooldown: 20,
            detailedDescription:
              '不稳定状态持续时间提高至30秒。爆炸区域可[弹开](为单纯的受力效果，与“投掷”不同，不会命中敌方)附近的部分道具。',
          },
          {
            level: 3,
      ...
      },
      {
        ...
        detailedDescription:
          '本技能可选择对自身或前方释放，通过外置轮盘切换技能状态。\n打自身：对自身造成{1*,不受来源影响}伤害，可用于触发主动技能的爆炸或加速切换。\n打前方：对范围内敌方造成少量伤害（与技能等级有关），并使敌方[强制使用爪刀](该效果无视敌方身上的护盾、无敌、缴械等效果；若敌方处于眩晕、虚弱等动作状态期间则不会出刀)。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: ['道具键*'],
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '打自身时，额外[提高Hp上限并恢复一定Hp](若在锤击前自身剩余Hp不足以抵消锤击伤害，则会先进入虚弱再恢复Hp)，提高上限的效果可叠加3层。打前方时，敌方强制爪刀的伤害降低。',
            cooldown: 3,
          },
          {
            level: 3,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '[尝试吃掉面前200单位距离内的一个道具](优先选择范围内更靠近右侧的道具，可吃掉处于被投掷状态期间的道具)，若成功吃掉一个道具则获得5秒15％加速、减少武器技能30秒CD、同时增加一格饱食度。饱食度积累到三层时，立即变身为{巨大泰菲球}。\n巨大泰菲球：变身时立即恢复150Hp但掉落手持道具。变身期间移速提高30%并获得额外技能，可以进行开关门、钻管道等交互，但无法使用道具或是进行救援、推奶酪等交互。变身期间[免疫部分负面状态](免疫打开的老鼠夹；受到伤害及眩晕等状态时会播放“炸毛”动画，该动画可被绝大多数操作取消，不影响行动；变身期间免疫虚弱，但由于Hp归零会导致解除变身，因此实际上仅能在Hp归零前免疫一次会导致虚弱的伤害)，并且{减伤}30%。变身持续20秒，时间耗尽或Hp归零时解除该状态。进入和解除该状态时有特殊动画（因Hp归零而解除该状态时除外）。\n巨大泰菲球-攻击：朝圣者泰菲使用额头向前撞击，撞击范围为300单位距离，命中敌方时恢复自身Hp并对敌方造成{30*}伤害和2.5秒10％减速状态，敌方处于撞击造成的减速效果期间被连续撞击三次会进入眩晕状态，持续1.5秒。撞击可对墙缝造成{_2.5*}伤害。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '不可主动打断',
        skillLevels: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '木塞子飞行速度提升至1800单位长度/秒，最长存在时间增加至30秒，可命中墙缝并对其造成{_3*}伤害。',
            cooldown: 30,
            charges: 4,
          },
        ],
