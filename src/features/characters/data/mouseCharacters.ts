    ...
    skills: [
      {
        ...
        detailedDescription: '增加自身和920范围内队友的移速和跳跃高度。不同等级的鼓舞效果可以叠加。',
  ...
  恶魔泰菲: {
    ...
    skillAllocations: [
      ...
      },
      {
        ...
        pattern: '013003311',
        weaponType: 'weapon2',
        description: '天宫需要搬奶酪时加点。',
      },
    ],
    knowledgeCardGroups: [
      {
        cards: ['S-铁血', 'S-舍己', 'S-回家', 'C-救救我'],
        description: '适合有三级回家的一武恶菲，上限卡，墙缝期高容错，基本上保证打出五层护盾，对意识要求较高，高端局主流配卡',
      },
      {
        cards: ['S-铁血', 'S-舍己', 'C-救救我', 'A-投手', 'B-夹不住我'],
        description: '适合二武恶菲。投手提高牵制能力，绿色小淘气可以快速叠夹不住我层数。',
      },
      {
        cards: ['S-舍己', 'S-铁血', 'S-缴械', 'C-救救我'],
        description: '没21点知识量时的推荐，缴械配合蓝色小淘气让猫变白板，但蓝恶魔只有3秒限制，高端局依旧不好救人',
      },
      {
