    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '通过外置轮盘选择目标（未选定则为距离最近的目标），点击目标头像后开始吟唱，给予其[祝福状态](头上出现光圈)，持续至该队友被放飞或天使杰瑞更换目标后。祝福状态的队友被放飞不会立刻淘汰，而是在[固定位置](只与地图有关，每个地图都有固定点位)以复活体的形式返回游戏。复活体会持续暴露小地图位置，且一旦Hp到达[0](即老鼠倒地起身时的血量。这意味着尼宝翻滚、佩克斯三级主动等“免疫虚弱”的效果并不能防止其被淘汰)或被抓起将立刻淘汰。',
        detailedDescription:
          '通过外置轮盘选择目标（未选定则为距离最近的目标），点击目标头像后开始吟唱，解除自身的失明与反向状态，并在约1.1秒后给予其[祝福状态](头上出现光圈)，持续至该队友被放飞或天使杰瑞更换目标后。祝福状态的队友被放飞不会立刻淘汰，而是在[固定位置](只与地图有关，每个地图都有固定点位)以复活体的形式返回游戏。复活体一旦Hp到达[0](即老鼠倒地起身时的血量。这意味着尼宝翻滚、佩克斯三级主动等“免疫虚弱”的效果并不能防止其被淘汰)或被抓起将立刻淘汰。复活体会持续暴露小地图位置，但可通过进机器鼠，拿白色花等方式暂时隐藏。如果老鼠在铁血期间被放飞，则重生时为铁血状态、铁血结束直接被淘汰；如果在铁血结束后十秒内被放飞，重生时将是虚弱状态，被猫抓取会直接被淘汰。如果受到流血类伤害钻进机器鼠，且在机器鼠内死亡，则会留下一个机器鼠空壳。\n与其他角色之间的互动：表演者•杰瑞被放飞会优先判定三级被动的复活。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: '不可主动打断',
        cancelableAftercast: '不可取消',
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 60,
            detailedDescription:
              '祝福期间获得护盾，[护盾存在时持续恢复Hp](护盾被打破则恢复效果消失)，共计回复99点Hp。',
          },
          {
            level: 3,
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '点按技能射出一发{弓箭}，命中友方为其回复Hp，命中敌方造成伤害。长按技能开始蓄力，期间暂时无法移动，可调整角度，蓄力一段时间后改为射出一发{蓄力箭}，命中友方为其回复更多Hp；命中敌方造成更高伤害和{眩晕}（眩晕有内置CD）。中途取消释放将返还一半CD。\n任意弓箭命中目标后，为目标添加“爱神标记”状态，持续一段时间。当场上存在两个“爱神标记”时，标记解除并根据阵营触发效果：\n均为友方：每个标记为目标提供1层{护盾}。\n均为敌方：额外造成高额伤害和眩晕。\n一敌一友：双方获得“爱神羁绊”状态，对彼此造成的{伤害}改为等额{回复}。',
        detailedDescription:
          '点按技能射出一发{弓箭}，命中友方为其回复25Hp且加速10%，持续1.6秒；命中敌方造成{30}伤害。长按技能开始蓄力，期间暂时无法移动，可调整角度，蓄力至少1.83秒后改为射出一发{蓄力箭}，命中友方为其回复50Hp且加速5%，持续1.6秒；命中敌方造成{55}伤害和1.4秒[眩晕](无视苏蕊的跳舞，但不打断跳舞或队友的跟随；无视天使汤姆二级被动的霸体，且可救下队友)（眩晕有内置CD）。点按可以在空中射出，但蓄力弓箭无法在空中射出。射出后的弓箭飞行[无视地形](平台，地板，天花板均不会影响；经典之家的厨房挡板除外)，直到击中其他角色或森林牧场大鸭子。弓箭射出方向为出射时所按的方向键，若未按则为拉弓时角色朝向。弓箭会受到重力，但[速度大小不变，只改变方向](不受外力时，箭的竖直速度逐渐增大而水平速度逐渐减小，并非严格的抛物线)。弓箭可被鞭炮影响而改变飞行轨迹。中途可以取消释放，会返还一半CD。\n任意弓箭命中目标后，为目标添加“爱神标记”状态，持续一段时间。当场上存在两个“爱神标记”时，标记解除并根据阵营触发效果：\n均为友方：每个标记为目标提供1层{护盾}。\n均为敌方：额外造成高额伤害和眩晕。\n一敌一友：双方获得“爱神羁绊”状态，对彼此造成的{伤害}改为等额{回复}。',
        canMoveWhileUsing: true,
        canUseInAir: true,
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '展开光盾，期间附近友方所受的部分伤害会转移到天使泰菲并消耗怜悯值抵挡，受到的眩晕控制延迟到离开光盾后结算，自身免疫{打开的老鼠夹}，附近火箭减缓燃烧速度、倒计时自然归零时暂时不放飞。\n光盾生效期间无法使用此技能，且持续消耗怜悯值，耗尽后光盾消失。怜悯值为空时无法使用此技能。\n本技能有后摇动作，但不影响角色行动。',
        detailedDescription:
          '展开光盾，期间[附近友方所受的部分伤害会转移到天使泰菲并消耗怜悯值抵挡](结算“转移伤害”效果时，使伤害改为由天使泰菲及队友共同承担，比例由转移伤害比例决定；若“受到的伤害值”超过队友的Hp上限，则实际分摊的伤害值改为等同于队友Hp上限)（每2%怜悯值可承担1伤害）,受到的眩晕控制延迟到离开光盾后结算，自身免疫{打开的老鼠夹}，范围内的火箭减缓燃烧速度、倒计时归零时暂时不放飞（对[秒飞火箭](因绑上老鼠立刻减少倒计时而导致倒计时归零的火箭)不生效）。\n光盾生效期间无法使用此技能，且持续消耗怜悯值，耗尽后光盾消失。怜悯值为空时无法使用此技能。\n本技能有后摇动作，但不影响角色行动。\n\n**本技能于20260402有一次大幅度改版，此处保留了部分改版前的数值，但可能与实际情况不符。**',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
        skillLevels: [
          {
            level: 1,
            description: '伤害转移比例为30%。',
            detailedDescription: '伤害转移比例为30%。火箭在范围内减少20%的燃烧速度。',
            cooldown: 5,
          },
          {
            level: 2,
            description: '伤害转移比例增加到50%，减缓火箭燃烧速度的效果增强。',
            cooldown: 5,
            detailedDescription: '伤害转移比例增加到50%，减缓火箭燃烧速度的效果增强至50%。',
          },
          {
            level: 3,
            description:
              '光盾每秒消耗的怜悯值降低，开启庇护后天使泰菲获得6秒的免疫虚弱状态，该状态将在光盾消失时立即结束。',
            cooldown: 5,
          },
        ],
        cueRange: '无音效',
      },
      {
        ...
        type: 'weapon1',
        description:
          '展开天使翅膀，持续恢复怜悯值（若已满或无法恢复，则改为恢复Hp），持续一段时间。技能期间仅一次，受到有来源的伤害时，对伤害来源“反弹”一次固定伤害。\n本技能有后摇动作，但不影响角色行动。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '技能期间怜悯值恢复速度提高。',
            cooldown: 10,
          },
          {
            level: 3,
            description: '反弹的固定伤害提高。技能可在被眩晕期间释放，解除眩晕但清空怜悯值。',
            cooldown: 10,
          },
        ],
      },
      {
        ...
        description:
          '天使泰菲拥有怜悯值充能条。怜悯值[无法](原有增长速度为1.5%/s，已改版)自然增长，仅在同一房间的队友受到伤害时增加，也可通过武器技能增加。怜悯值可供主动技能消耗。',
        detailedDescription:
          '天使泰菲拥有怜悯值充能条。怜悯值[无法](原有增长速度为1.5%/s，已改版)自然增长，仅在同一房间的队友受到伤害时增加（每1伤害增加0.7%怜悯值），也可通过武器技能增加。怜悯值可供主动技能消耗。',
      },
    ],
    specialSkills: [
      {
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '技能平时禁用，在米雪儿或附近队友队友受到猫攻击后激活。点击技能将原地大哭诉说委屈，期间将获得1层护盾。友方老鼠进入范围后可对米雪儿进行安抚，期间获得护盾，安抚结束后友方将变成{巨型比利鼠}。',
        detailedDescription:
          '技能平时禁用，在自己和以自己为中心半径1500内的队友受到猫攻击后激活30秒。点击技能将原地大哭诉说委屈，持续3.9秒，并获得1层持续7.9秒的护盾。哭泣750*750的矩形范围内将下起伤心的雨，对敌方造成25%减速。友方老鼠进入范围后可通过交互对米雪儿进行安抚，安抚前摇[较短](在20260326更新前为0.6秒，之后有所缩短又有所回调，待测试)，前摇前获得1层持续7.8秒的护盾。安抚结束后友方将变成比普通比利鼠体型更大、伤害更高的{巨型比利鼠}，持续9.9秒（第二武器附身队友期间对附身的队友改为5秒）（巨型比利鼠攻击前摇0.5秒，后摇0.5秒，爪刀范围[300](与汤姆相同)，对敌方造成110的基础伤害，并造成20%减速，持续1.9秒；对墙伤害为1.5）。哭时使用道具键*取消后摇或安抚成功后，将清除米雪儿的护盾；队友未安抚不会清除米雪儿的护盾；若在队友安抚的途中取消后摇不会清除队友的护盾，且该护盾能抵消虚弱状态。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: ['道具键*'],
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '进入危险和安全来回切换的不稳定状态，初始为危险状态，每3秒切换一次。\n危险状态：受到伤害会产生爆炸区域，然后退出不稳定状态。爆炸区域持续3秒，进入该区域的敌方受到2秒{爆炸}，进入该区域的友方被弹开，并{炸毁}位于该区域的{火箭}，该火箭12秒后恢复。\n安全状态：移速提高，受到攻击会减少进入危险状态的间隔。',
        detailedDescription:
