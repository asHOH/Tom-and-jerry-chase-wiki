      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '跟随队友时，该队友会获得5Hp/秒的恢复状态（持续10秒，脱离附身时提前解除）。',
            cooldown: 10,
          },
          {
            level: 3,
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 20,
            detailedDescription:
              '不稳定状态持续时间提高至30秒。爆炸区域可[弹开](为单纯的受力效果，与“投掷”不同，不会命中敌方)附近的[部分道具](包括投掷道具，以及拍子/夹子/锤子等，不包括果盘/泡泡机)。',
          },
          {
            level: 3,
      ...
      },
      {
        ...
        detailedDescription:
          '本技能可选择对自身或前方释放，通过外置轮盘切换技能状态。\n打自身：对自身造成{1*,不受来源影响}伤害，可用于触发主动技能的爆炸或加速切换。（前摇0.5秒，后摇0.5秒）\n打前方：对范围内敌方造成少量伤害（与技能等级有关），并使敌方[强制使用爪刀](该效果无视敌方身上的护盾、无敌、缴械等效果；若敌方处于爪刀CD或眩晕、虚弱等动作状态期间则不会出刀)。（前摇0.35秒，后摇0.55秒）',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: ['道具键*'],
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '[打自身后](若在锤击前自身剩余Hp不足以抵消锤击伤害，则会先虚弱再触发后续回复)，回复10Hp，随后{Hp上限提高}10（持续10秒，可叠加3层）。（注意：成功提高上限时也会同步回复10Hp；叠加层数达到3层后，再次获得时仅重置时间，不再额外回复Hp）\n打前方时，敌方强制爪刀的伤害降低10%。',
            cooldown: 3,
          },
          {
            level: 3,
      ...
      },
      {
        ...
        detailedDescription:
          '对本技能进行加点后，鲍姆进入虚弱时，同步进入9.85秒倒计时，倒计时归零时在自身所在位置产生一个爆炸区域，效果只取决于当前被动技能等级（与相应等级的主动技能爆炸区域效果一致）。虚弱期间每次跳跃均会减少0.55秒倒计时，成功自爆/被抓起/解除虚弱时也会结束倒计时且不触发自爆。',
        skillLevels: [
          {
            level: 1,
            description: '',
