      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '每当奶酪被推进或墙缝首次被破坏到80%、60%、40%、20%、0%时，解除虚弱和受伤、回复一定Hp、且移速提高，持续2.7秒。',
          },
        ],
      },
    ],
  ...
  侦探杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '引爆烟雾弹产生{烟雾}遮挡猫的视野。在烟雾中猫咪[无法查看小地图](此效果可以被一层护盾抵消)。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: '不可主动打断',
        cancelableAftercast: '不可取消',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '交互行为不会取消隐身效果，持续期间解除并免疫{香水瓶}、{香水烟雾}、{胡椒瓶}、{胡椒烟雾}、{香水区域}效果。',
            cooldown: 20,
          },
          {
            level: 3,
      ...
      },
      {
        ...
        skillLevels: [
          {
            level: 1,
            description: '每隔一段时间，可在小地图上看到敌方猫咪的位置。',
            detailedDescription:
  ...
  罗宾汉杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '打开降落伞，从高处落下不受到任何阻碍，期间获得{绝对霸体}状态，可随时跳跃取消。若落地则进入后摇。',
        detailedDescription:
  ...
  航海士杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        aliases: ['桶', '炸药桶'],
        description:
          '放置一个{火药桶(衍生物)}，延迟数秒后爆炸，对周围造成不分敌我的伤害和眩晕，对墙缝造成伤害，并{炸毁}范围内的火箭。猫咪可以通过交互拆除火药桶，老鼠可以通过交互推动火药桶。火药桶被部分其他道具命中时缩短引爆时间。',
        detailedDescription:
          '放置一个{火药桶(衍生物)}，延迟数秒后爆炸，对周围造成不分敌我的[伤害](对其他角色（包括敌方和队友，不包括自身）的伤害会受攻击增伤的影响)和眩晕，[对墙缝造成伤害](会直接炸毁墙缝上的泡泡，且仍造成全额伤害)，并{炸毁}[范围内](火药桶的下端判定相对较大)的火箭，若其上有老鼠则[将其救下](视作航海士杰瑞进行的救援，可触发知识卡-无畏/舍己等)。猫咪可以[通过交互拆除火药桶](动作时长1秒)，老鼠可以通过交互推动火药桶。火药桶被部分其他道具命中时，引爆时间缩短5秒。\n火药桶与其他道具的互动关系：火药桶可被{小鞭炮}或{鞭炮束}炸飞，在火药桶左侧的鞭炮会使火药桶呈抛物线飞出，右侧的鞭炮会使火药桶水平滑行。使用特定道具斜向下45°打击桶外侧可使桶产生横向加速，其中{扁盘}产生的加速较大，约为{玻璃杯}的两倍。未引爆的鞭炮也可以使桶位移，且不会缩短引线。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '向前翻滚一段距离。本技能可在受到眩晕效果时释放，并立即解除该眩晕效果，但冷却时间会额外增加6秒。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              'Hp恢复提升（受伤状态也触发）；推奶酪时免疫眩晕；搬起奶酪、推奶酪、火箭救援时额外获得恢复和减伤效果；吃食物速度增加。',
            detailedDescription:
              '[获得2.5Hp/秒的恢复效果](与角色基础的Hp恢复效果不同，不会因受伤而失效)；推奶酪时免疫眩晕；搬起奶酪、推奶酪、火箭救援时额外获得恢复和减伤效果；吃食物速度提升20%。',
          },
          {
            level: 3,
