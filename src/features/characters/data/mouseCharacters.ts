  ...
  航海士杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '放置{火药桶(衍生物)}，延迟[数秒](与技能等级有关)后爆炸，对周围造成[不分敌我的伤害](与技能等级有关；对其他角色（包括敌方和队友，不包括自身）的伤害会受攻击增伤的影响)和眩晕，对墙缝造成{_20*}伤害（会直接炸毁墙缝上的泡泡，且仍造成全额伤害），并{炸毁}[范围内](火药桶的下端判定相对较大)的火箭，若其上有老鼠则[将其救下](视作航海士杰瑞进行的救援，可触发知识卡-无畏/舍己等，但不会获得救人应得的金币)。猫咪可以[通过交互拆除火药桶](动作时长1秒)，老鼠可以通过交互推动火药桶。火药桶被其他道具（如金币、所有易碎道具、火炮发射出的老鼠等）命中时，引爆时间缩短5秒。\n火药桶与其他道具的互动关系：火药桶可被{小鞭炮}或{鞭炮束}炸飞，在火药桶左侧的鞭炮会使火药桶呈抛物线飞出，右侧的鞭炮会使火药桶水平滑行。使用特定道具斜向下45°打击桶外侧可使桶产生横向加速，其中{扁盘}产生的加速较大，约为{玻璃杯}的两倍。未引爆的鞭炮也可以使桶位移，且不会缩短引线。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '火药桶引爆时间为8秒，引爆造成不分敌我的{1*}伤害（对自身造成的伤害不受自身攻击增伤等效果影响，为1）与1.4秒眩晕；被炸毁的火箭65秒后自动修复。',
            cooldown: 45,
          },
          {
            level: 2,
            description: '爆炸伤害提高。',
            detailedDescription:
              '爆炸对角色的伤害提升至{25*}（对自身造成的伤害不受自身攻击增伤等效果影响，为25）。',
            cooldown: 30,
          },
          {
            level: 3,
            ...
            detailedDescription:
              '引爆时间缩短至3秒；爆炸对角色的伤害提升至{50*}（对自身造成的伤害不受自身攻击增伤等效果影响，为50）；被炸毁的火箭不再自动修复。',
            cooldown: 30,
          },
        ],
        cueRange: '全图可见',
  ...
  剑客杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '使用三段剑舞近身攻击。\n第一段，前摇0.45秒，对前方200、后方50范围内的敌方造成{5*}点伤害，并减速30%，持续1.9秒；\n第二段，前摇0.45秒，对前方200、后方50范围内的敌方造成{5*}点伤害，并减速50%，持续2.4秒；\n第三段，前摇0.75秒，后摇0.4秒，对前方200、后方70范围内的敌方造成{5*}点伤害，并眩晕3秒。\n开始释放技能后的9.9秒内可以再次点击技能释放下一段，否则进入CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '不可主动打断',
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        detailedDescription:
          '原地进入1.4秒的格挡状态，该阶段下自身无法移动、[获得强{霸体}](无法免疫斯派克的抓取)、使撞击自身的{斗牛}消失。受到爪刀攻击时进入反击阶段，0.4秒前摇后对猫造成[数点伤害](与技能等级有关)和2.5秒眩晕。反击也可通过再次点击技能键主动释放，对前方375、后方50范围内的敌方造成同等效果。\n反击释放后，1.2秒内技能键被替换为翻滚。翻滚阶段下，向前以1000的速度滚动0.9秒。翻滚开始或1.2秒未翻滚后，技能进入cd。被动触发的格挡反击[无视距离且必定命中](包括管道中的猫咪)、触发后自身回复25Hp并减少7秒技能CD。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: '无前摇',
    ...
    skills: [
      {
        ...
        detailedDescription:
          '只有勇气释放期间才能释放本技能。向前冲刺0.7秒，冲刺期间移速提高50%，并恢复少量勇气。途经敌方会对其造成{15*}伤害（注意：勇气释放期间会额外提供15攻击增伤），但消耗一定的勇气。途经[部分NPC](如森林牧场大鸭子、小黄鸭等，尚未详细测试)也会消耗勇气。',
        canMoveWhileUsing: false,
        canUseInAir: false,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '长枪速度大幅提高，蓄力超过2/3时会对敌方造成额外控制效果。\n勇气释放期间，长枪命中猫咪时将使其无法使用技能并掉落手中道具、带飞友方时解除其受伤和虚弱。',
            cooldown: 8,
            detailedDescription:
  ...
  牛仔杰瑞: {
    ...
    skills: [
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '放置{大仙人掌}，持续90秒。猫咪踩中受到1.2秒硬直，随后减速15%且每秒受到{7.5*,无来源,不受来源影响,无视护盾}伤害，[持续3秒](只造成两次伤害)，同时仙人掌消失。同一目标3秒内不会重复触发；减速最多叠加3层。所有老鼠不受仙人掌的影响，但鼠方踩踏两次后仙人掌消失。',
            cooldown: 18,
          },
          {
            level: 2,
            description:
              '减速和伤害效果加强，且消失后会分裂为3个效果稍弱的{小仙人掌}。鼠方改为踩踏一次后就使大仙人掌消失并分裂。',
            cooldown: 18,
            charges: 2,
            detailedDescription:
              '大仙人掌造成的减速提升至20%，改为造成{10*,无来源,不受来源影响,无视护盾}伤害，[持续时间提升至5秒](只造成四次伤害)。\n{大仙人掌}消失后会生成3个{小仙人掌}，猫咪踩中受到0.8秒的硬直，随后减速13%且每秒受到{7.5*,无来源,不受来源影响,无视护盾}伤害，[持续3秒](只造成两次伤害)；减速最多叠加三层；小仙人掌的减速与持续伤害与大仙人掌独立计算，同时小仙人掌继承大仙人掌的持续时间。小仙人掌被鼠方踩踏两次后消失。\n鼠方改为踩踏一次后就使大仙人掌消失并分裂。',
          },
          {
            level: 3,
            ...
            charges: 2,
            detailedDescription:
              '大仙人掌造成的硬直提升至2.2秒、减速提升至25%、[持续时间提升至10秒](只造成九次伤害)。',
          },
        ],
        cueRange: '全图可见',
      },
      {
        ...
        detailedDescription:
          '可左右拖动和原地释放，在身边产生琴声区域，且自身向拖动方向移动，期间保留惯性。猫进入琴声区域的瞬间会陷入1秒的僵直（离开范围后可再次触发），在范围内停留超过0.5秒后会受到35%减速，且每秒受到{15*,不受来源影响,无视护盾}伤害，持续2.8秒。\n弹琴可通过跳跃键、移动键、道具键*主动结束释放；可空中释放但会立刻结束弹琴；最多持续弹奏5秒。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        canHitInPipe: false,
        forecast: 0.9,
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 15,
            detailedDescription:
              '猫咪持续听到音乐时，每秒叠加一层减速，两层时清空层数，受到{25*}点伤害并[眩晕1.4秒](内置CD：10秒)、掉落手中老鼠。',
          },
        ],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '技能读条时间变为12秒，传送门存在时间为30秒，敌方传送后受到{60*,无来源,不受来源影响}伤害。',
            cooldown: 25,
          },
          {
            level: 3,
