  ...
  马索尔: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '马索尔拥有额外的怒气条。当半径1750范围内友方角色（含自身）受到来自敌方的攻击时，自身积攒28%的怒气。怒气达到100%之后将进入持续32秒的满怒状态，期间自身受到的伤害降低5点且{沙包拳头}得到强化，但持续{暴露位置}。退出满怒状态后进入持续34.9秒的冷静状态，期间自身减速25%且不会获得怒气。',
        skillLevels: [
          {
            level: 1,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription: '5秒内对火箭造成5次共鸣后会{摧毁}火箭。被摧毁的火箭45秒后恢复。',
          },
          {
            level: 3,
