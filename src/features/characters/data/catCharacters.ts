      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 0.5,
            detailedDescription:
              '新造成的“防狼锤额外减速”新增禁用[技能](包括主动、武器技能和特技等)和道具的效果。',
          },
          {
            level: 3,
            description: '',
  ...
  塔拉: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '塔拉拖动技能选择极大范围内的一个位置，松开时向该位置发射一个指定种类的仙人球，到达目标位置后与一定范围内的同种仙人球之间产生连线，对碰触该连线的[敌方男性角色](敌方女性角色也可以碰触连线，但对该角色不产生任何效果，且仍然会使爆炸仙人球消失)/塔拉产生不同效果。每个仙人球至多产生1条连线，产生连线时会重置该仙人球的存在时间。点按该技能会直接向原地发射仙人球。长按该技能时，若目标位置周围有可连线的仙人球，会有特殊黄色虚线UI进行提示。\n塔拉可通过外置轮盘切换仙人球种类，各仙人球效果如下：\n{爆炸仙人球}：可连线范围较小，存在时间较短，连线被碰触时消失。敌方男性角色碰触连线时，使其被点燃并受到{持续伤害}（每30秒只能被点燃1次），期间{暴露位置}；塔拉碰触连线时，使其{攻击增伤}提高一段时间。\n{闪电仙人球}：可连线范围中等，存在时间较短，连线被碰触不会消失。敌方男性角色碰触连线时，对其造成一定[固定{伤害}](即“不受增减伤影响”类型的伤害，详见状态效果相关界面)，使其{减速}且救援速度降低一段时间；塔拉碰触连线时，使其主动技能CD缩短至10/5/5秒，并{更改爪刀CD}为2秒(未命中)/2.5秒(命中)，获得该状态时不会影响已处于CD中的主动技能/爪刀的当次CD，已有加速期间触碰闪电仙人球连线不重置持续时间。\n{弹簧仙人球}：可连接范围较大，存在时间较长，连线被碰触时不会消失。敌方男性角色碰触连线时，将其{牵引}向连线中点，到达目标位置或碰触部分平台后进入短暂{眩晕}，该过程期间{完全失重}。',
        detailedDescription:
          '塔拉拖动技能选择极大范围内的一个位置，松开时向该位置发射一个指定种类的仙人球，到达目标位置后与一定范围内的同种仙人球之间产生连线，对碰触该连线的[敌方男性角色](敌方女性角色也可以碰触连线，但对该角色不产生任何效果，且仍然会使爆炸仙人球消失)/塔拉产生不同效果。每个仙人球至多产生1条连线，产生连线时会重置该仙人球的存在时间。点按该技能会直接向原地发射仙人球。长按该技能时，若目标位置周围有可连线的仙人球，会有特殊黄色虚线UI进行提示。\n塔拉可通过外置轮盘切换仙人球种类，各仙人球效果如下：\n{爆炸仙人球}：可连线范围较小，存在时间较短，连线被碰触时消失。敌方男性角色碰触连线时，使其被点燃并受到{持续伤害}（每30秒只能被点燃1次），期间{暴露位置}；塔拉碰触连线时，使其{攻击增伤}提高一段时间。\n{闪电仙人球}：可连线范围中等，存在时间较短，连线被碰触不会消失。敌方男性角色碰触连线时，对其造成一定[固定{伤害}](即“不受增减伤影响”类型的伤害，详见状态效果相关界面)，使其{减速}且救援速度降低一段时间；塔拉碰触连线时，使其主动技能CD缩短至10/5/5秒，并{更改爪刀CD}为2秒(未命中)/2.5秒(命中)，获得该状态时不会影响已处于CD中的主动技能/爪刀的当次CD，已有加速期间触碰闪电仙人球连线不重置持续时间。\n{弹簧仙人球}：可连接范围较大，存在时间较长，连线被碰触时不会消失。敌方男性角色碰触连线时，将其{牵引}向连线中点，到达目标位置或碰触部分平台后进入短暂{眩晕}，该过程期间{完全失重}。',
        canMoveWhileUsing: true,
        canUseInAir: true,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '向前冲刺2s，期间无敌、移速提升75%，若命中敌方将造成{10*}伤害、使其移速降低25%，跳跃高度降低50%，持续3s。冲刺时遇到正常、虚弱、护盾、霸体和[部分无敌效果](罗宾汉降落伞、剑杰格挡、剑菲冲刺、冰冻保鲜特技、变大)的老鼠均可解锁二段技能挑飞，否则技能进入CD。解锁后可在6s内使用二段技能[挑飞](前摇0.35s，可用道具键、其他技能键取消释放；无视护盾和除罗宾汉杰瑞的降落伞、剑客泰菲的冲刺、变大外的其他无敌效果，但不能挑飞霸体老鼠)，向上挑飞脚下的老鼠，对老鼠造成1.9s眩晕并击飞1s。若挑飞老鼠，可在6s内使用三段技能[追踪到老鼠位置](以2000速度飞向敌方，飞行最大时间0.6s，若发生以下情形将不会释放连斩：超过最大飞行时间，被打断，被墙体、拳头盒子、嫦娥阻挡，老鼠在自己下方（泰菲家族由于模型小，若与剑汤站在同一水平面则无法连斩）)进行[连斩](无视护盾、霸体和无敌效果；期间只会受到天使泰菲反伤和可击中管道中的角色的技能伤害)。连斩持续3.1秒，会使[范围内的老鼠](不包括手中的老鼠)浮空4.2秒、每0.55秒受到{10*,不受目标影响,无视护盾}伤害，总共5次。连斩期间老鼠无法移动，但可以使用技能和交互。无法打爆机器鼠。[快速点击可加速连斩](每次点击使连斩持续时间减少0.5s，同时老鼠浮空时间减少0.5s，并且总共至多额外造成两次伤害)。连斩后摇0.8s，可用道具键取消。连斩造成两次伤害后会使老鼠受到[威慑效果](绑上火箭后消失)，被绑上火箭时，引线将额外减少10s。挑飞和连斩[在空中释放](不是跳放)将直接进入CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        forecast: 0,
    ...
    skills: [
      {
        ...
        cueRange: '本房间可见',
        detailedDescription:
          '从远处召唤{追求者}冲至面前距离200的位置，追求者在后摇结束后0.2秒停下(凯特本身静止不动)；随后再次拖动技能键，经0.35秒前摇后使追求者向该方向再度出击，随后进入0.35秒后摇，两段均可对触碰的老鼠造成伤害。{追求者}可以被[部分技能](比如霜月滑铲)击飞。',
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '投掷{百科全书}，命中时造成伤害；落地后书籍会打开，一段时间后或再次施放技能会让书籍闭合，造成伤害并将老鼠夹住。书籍闭合后存在一定时间，凯特可以通过交互键捡起书籍返还部分CD并将老鼠直接抓在手中，拾取书籍还能提高绑火箭和放置{老鼠夹}的速度，并恢复少量Hp。当书籍在凯特附近闭合时，{追求者}会快速冲向书籍将其捡起并送还凯特。',
        detailedDescription:
          '以水平方向1500的速度投掷{百科全书}。书籍对直接命中的老鼠造成{30}伤害；落地后书籍会打开，一段时间后或再次施放技能会让书籍闭合，[造成伤害](受其他攻击增伤影响)并将老鼠夹住，随后技能进入CD。书籍闭合后存在一定时间，凯特可以通过交互键捡起书籍返还5秒CD并将被夹住的老鼠直接抓在手中，拾取书籍还能提高绑火箭和放置{老鼠夹}的速度，并恢复少量Hp。当书籍在凯特附近闭合时，{追求者}会快速冲向书籍将其捡起并送还凯特。\n书籍与夹子有相似和不同之处（可以触发{捕鼠夹}，但无法触发{夹不住我}、{狡诈}）。被投掷的书籍也无法触发{乾坤一掷}。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: ['跳跃键', '道具键'],
        skillLevels: [
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '当老鼠出现在视线范围内时，每1.8秒为老鼠添加一层持续10秒的破绽状态，上限5层。对老鼠造成伤害时，每层破绽增加6点伤害和100经验。每层破绽伤害分独立计算。',
          },
          {
            level: 2,
            description:
              '附近老鼠使用技能、投掷道具、从火箭上救下队友时，会获得破绽，且使凯特增加移速、减少被控制时间（包括虚弱）、加快绑火箭速度，可叠加。',
            detailedDescription:
              '附近老鼠使用技能、投掷道具、从火箭上救下队友时，会获得一层破绽，且使凯特移速增加[16.5％](该加成现已可叠加，不确定数值是否削弱)、减少[50%](该加成现已可叠加，不确定数值是否削弱)被控制时间（对虚弱至多减少2秒）、加快绑火箭速度至[约1秒](该加成现已可叠加，不确定数值是否削弱)，该加成持续7秒，可叠加。',
          },
          {
            level: 3,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '向前方连续挥爪3次，每次造成30伤害，前摇分别为0.3、0.4、0.6秒，范围均为300；疾冲状态下或{武器技能}飞行中，改为以1560的速度向前穿刺0.45秒，造成60点伤害和1.8秒眩晕。技能可以穿门。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        aliases: ['打碟'],
        description:
          '开始狂欢，期间{加速}但无法进行[部分交互](可正常移动、跳跃、抓取老鼠和绑火箭等，但无法进行攀爬等交互)，且免疫部分控制状态（不包括虚弱），持续10秒。技能期间对附近的敌人造成持续伤害和减速。恶魔汤姆头顶会依次出现2条舞步指令（向左移动/向右移动/跳跃），正确执行全部指令会随机获得护盾/恢复/增伤，并强化武器技能。',
        detailedDescription:
          '开始狂欢，期间{加速}但无法进行[部分交互](可正常移动、跳跃、抓取老鼠和绑火箭等，但无法进行攀爬等交互)，且[免疫部分控制状态](包括眩晕、仙女鼠八星的变身，但不包括虚弱、减速、反向、尼宝鱼钩拽取等。技能期间被莱恩变身为线条猫时，技能不中断)，持续10秒。技能期间对附近的敌人造成持续伤害和减速。恶魔汤姆头顶会依次出现2条舞步指令（向左移动/向右移动/跳跃），[正确执行全部指令](若指令出现时已在移动，则保持移动时不会视作执行指令；转向/跳跃/中断并重新移动会视作执行指令；反向期间，指令以角色实际移动方向为判定标准（例如“向左移动”指令需角色向左移动，实际为按向右移动键）)会[随机](在20260409更新后，获得护盾的概率提高)获得护盾/恢复/增伤，且获得一段时间的“列车狂欢”状态，该状态下武器技能会一次性召唤2条轨道&列车。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '拖动技能，在指定位置生成{轨道}，随后会有{列车}沿轨道冲撞，对被撞击的敌人施加伤害，眩晕和击退效果，同一老鼠短时间内被列车命中两次后会受到{易伤}状态（期间不会重复获得）。被主动技能强化期间，本技能会一次性召唤2条轨道&列车。',
        detailedDescription:
          '拖动技能，在[指定位置](位置会根据自身前摇后的实际位置发生变化)立即[迅速](原2.1秒，现已大幅加速)生成{轨道}，轨道会以技能释放的位置为中点，向恶魔汤姆面朝方向伸展，角度在水平、水平偏斜上/斜下27°三者内随机；[短暂延迟后](原为“轨道完全生成后”，现版本已更改)后召唤{列车}进行[迅速](原1.8秒，现已大幅加速)冲撞，对被撞击的敌人施加少量伤害，并造成眩晕和击退效果，同一老鼠短时间内被列车命中两次后会受到{易伤}状态（期间不会重复获得）。“列车狂欢”期间，本技能会一次性召唤2条轨道&列车，两条轨道的角度不同。\n跳跃不会中断技能前摇。前摇状态下可以使用爪刀攻击。前摇期间可以拾取道具/饮用饮料，且会在前摇结束后取消技能的释放（不消耗储存次数）。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '释放列车成功后给予自身一层护盾，持续5秒。列车经过恶魔汤姆时会刷新该护盾。',
            cooldown: 8,
            charges: 3,
          },
          {
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '恶魔汤姆附近的敌方每隔一段时间受到一个随机[异常状态](包括反向、失明、冰冻眩晕、爆炸眩晕)（有[内置触发顺序逻辑](先是2次反向/失明，其后是1次冰冻眩晕/爆炸眩晕，如此循环反复)。所有老鼠受到的效果相同），并扩散给队友。',
            detailedDescription:
              '恶魔汤姆附近500范围内的老鼠[每隔5秒](技能加点后开始产生作用，每隔5秒进行一次判定：若范围内有老鼠则触发效果，反之无事发生（不占用本技能的触发序列）)受到一个随机[异常状态](包括：3秒反向；3秒失明；2.3秒冰冻眩晕和1点伤害；2.1秒爆炸眩晕和1点伤害)（有[内置触发顺序逻辑](先是2次反向/失明，其后是1次冰冻眩晕/爆炸眩晕，如此循环反复)。所有老鼠受到的效果相同），然后[重置由本技能Lv.2效果导致的异常状态的持续时间](仅包括本技能导致的反向、失明、冰冻眩晕、爆炸眩晕。包括由自然触发和因狂欢时刻导致的该效果。重置时间通常是指狂欢时刻与本技能联动导致的异常状态的持续时间。例如：杰瑞先触发狂欢时刻的眩晕并因此获得了本技能提供的冰冻眩晕，此时经过2秒后恰好触发了本技能的效果，则会重置该冰冻眩晕时间为2.3秒，同时还会按序列再获得一个异常状态（可能重复）)，再将上述状态[扩散给约250范围内的队友](指的是让队友受到同样的状态)。该技能效果可被大部分护盾效果免疫或抵消。',
          },
          {
            level: 3,
  ...
  兔八哥: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'passive',
        description:
          '兔八哥可在特定条件下对敌方施加“宣战”状态，或使自身获得“胜利”状态。\n["宣战"](可被护盾免疫，不消耗层数)：获取目标视野，持续10秒，已有该效果则不会重复触发；附近有被宣战的老鼠时，[自身移速提高，并免疫反向失明的影响](状态特效与恢复效果相似，但并不会提高Hp恢复速度)。目标在"宣战"持续期间[进入虚弱](某些免死效果实际为先进入虚弱后解除并触发效果（例如知识卡-铁血本质是解除虚弱并在数秒后再度虚弱），这类效果触发时有可能会多次触发获得“胜利”的效果（例如击倒被宣战的有铁血的老鼠将获得3×2层“胜利”状态）)时，自身会获得3层“胜利”状态。\n"胜利"：每层“胜利”状态将提升Hp上跟，最多叠加5层，在虚弱后失去一半层数（向下取整）。"胜利"还能强化其他技能。',
        detailedDescription:
          '兔八哥可在特定条件下对敌方施加“宣战”状态，或使自身获得“胜利”状态。\n["宣战"](可被护盾免疫，不消耗层数)：获取目标视野，持续10秒，已有该效果则不会重复触发；以自身为中心1300×250范围内有被宣战的老鼠时，[自身移速提高，并免疫反向失明的影响](状态特效与恢复效果相似，但并不会提高Hp恢复速度)。目标在"宣战"持续期间[进入虚弱](某些免死效果实际为先进入虚弱后解除并触发效果（例如知识卡-铁血本质是解除虚弱并在数秒后再度虚弱），这类效果触发时有可能会多次触发获得“胜利”的效果（例如击倒被宣战的有铁血的老鼠将获得3×2层“胜利”状态）)时，自身会获得3层“胜利”状态。\n"胜利"：每层“胜利”状态将提升20Hp上跟，最多叠加5层，在虚弱后失去一半层数（向下取整）。"胜利"还能强化其他技能。',
        skillLevels: [
          {
            level: 1,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '舞起花枪，持续5秒，使用技能瞬间给予如玉一个持续3.2秒的30%的加速，期间免疫碎片、可移动跳跃但无法交互，每隔一段时间对碰触的老鼠造成8伤害和可叠加的减速，持续2.9秒，最高叠加4层。技能期间受到来自老鼠的伤害时，可在1.6秒内点按["花枪反击"键](该按键位置和大小可进行调整)对其触发“花枪反击”。技能开启1秒内受击会立刻自动反击。\n\n“花枪反击”：立刻解除控制，结束技能并减少{主动技能}4秒CD，[若目标距离较近](处于以如玉模型中心为圆心，半径约500的圆内)，则直接对[前方600范围内](高度约与自身平齐，范围较大)进行一次[前摇0.3秒，后摇0.6秒](前后摇无法主动取消)的扫击，对所有命中的目标造成[一定](原伤害75，现已削弱)伤害和1.9秒眩晕；[若目标距离较远](不处于以如玉模型中心为圆心，半径约500的圆内)，则会[传送到对方头顶并在0.3秒后再度传送到其身后](释放技能时立刻传送到目标头顶高约250的位置并失重，0.3秒后再度传送到其身后。前后摇期间无法主动取消动作，但失重落地的瞬间可以通过爪刀强制中止技能，这会吞掉技能的伤害和控制效果)，然后对[前方600范围内](高度约与自身平齐，范围较大)进行一次[前摇0.4秒，后摇0.55秒](前后摇无法主动取消，且动作期间无法移动跳跃)的扫击，对所有命中的目标造成[一定](原伤害75，现已削弱)伤害和1.9秒眩晕。扫击期间不可移动，但可通过方向键转向。若任意老鼠[因扫击伤害虚弱](包括进入“铁血”等状态)，且[扫击方向上有火箭](以如玉为半圆的圆心，半径约800的半圆内有空置火箭，且中间无平台阻挡)，则会[将其击飞到火箭上](将其向火箭方向上直线击飞，击飞期间失重，碰到火箭时自动绑上并点燃，正常触发绑火箭的-10秒引线效果及相关知识卡。该效果的瞄准有一定问题，可能出现多只虚弱老鼠向同一个火箭方向扫击的情况，并且距离火箭过近时可能会出现向上击飞而未击飞到火箭上的情况)。花枪反击可命中管道中的老鼠。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        forecast: 0,
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '减速叠加到第4层时清空，并使目标受到2.4秒眩晕和{20}伤害，但眩晕期间免疫舞花枪的效果。',
            cooldown: 12,
          },
        ],
        cueRange: '本房间可见',
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '掷出{花枪}，对碰到的老鼠造成少量伤害，且花枪存在期间自身移速增加。花枪飞行一段时间后或再次点击技能时以更快的速度折返回如玉身边，[折返时也会造成伤害](老鼠进入花枪范围至离开前只会受到一次伤害，因此折返开始时恰好处于花枪范围内的老鼠不会受到二次伤害)，若折返时命中花枪折返前命中过的目标，可点按["花枪反击"键](该按键位置和大小可进行调整)触发“花枪反击”。\n\n“花枪反击”：解除控制，减少{主动技能}CD，然后进行一次扫击，造成伤害和眩晕；若目标距离较远，则会传送到对方身后扫击。扫击期间不可移动，但可通过方向键转向。若老鼠[因扫击伤害虚弱](包括进入“铁血”等状态)，且扫击方向上有火箭，则会将其击飞到火箭上。花枪反击可命中管道中的老鼠。\n特别地，如果一次性击飞多只老鼠但路径上有且只有一个火箭，没有被绑上火箭的老鼠会在一段时间内做匀速直线运动，直到受到阻挡。该特性可用于在天宫、森林牧场等地图防守时流放老鼠。',
        detailedDescription:
          '向任意指定方向掷出{花枪}，且花枪存在期间自身移速增加；花枪沿直线飞行，飞行速度约1900，对[碰到](碰撞面积为圆形，半径约150)的老鼠造成[一定伤害](不受攻击增伤影响；原伤害5，现已增强)。花枪飞行[一定时间](原1.1秒，现已延长)后或再次技能时以更快的速度[折返回如玉身边](改为向如玉方向飞行，碰到如玉或累计飞行8.1秒后消失)，[折返时也会造成一定伤害](不受攻击增伤影响；原伤害5，现已增强；老鼠进入花枪范围至离开前只会受到一次伤害，因此折返开始时恰好处于花枪范围内的老鼠不会受到二次伤害)，若[折返时命中花枪折返前命中过的目标](包括持有护盾、无敌，或是虚弱的目标，甚至包括火箭起飞时待复活的目标———这会导致如玉瞬移到对方的复活位置进行花枪反击)，可在1.6秒内点按["花枪反击"键](该按键位置和大小可进行调整)对其触发“花枪反击”。\n\n“花枪反击”：立刻解除控制，结束技能并减少{主动技能}4秒CD，[若目标距离较近](处于以如玉模型中心为圆心，半径约500的圆内)，则直接对[前方600范围内](高度约与自身平齐，范围较大)进行一次[前摇0.3秒，后摇0.6秒](前后摇无法主动取消)的扫击，对所有命中的目标造成[一定](原伤害75，现已削弱)伤害和1.9秒眩晕；[若目标距离较远](不处于以如玉模型中心为圆心，半径约500的圆内)，则会[传送到对方头顶并在0.3秒后再度传送到其身后](释放技能时立刻传送到目标头顶高约250的位置并失重，0.3秒后再度传送到其身后。前后摇期间无法主动取消动作，但失重落地的瞬间可以通过爪刀强制中止技能，这会吞掉技能的伤害和控制效果)，然后对[前方600范围内](高度约与自身平齐，范围较大)进行一次[前摇0.4秒，后摇0.55秒](前后摇无法主动取消，且动作期间无法移动跳跃)的扫击，对所有命中的目标造成[一定](原伤害75，现已削弱)伤害和1.9秒眩晕。扫击期间不可移动，但可通过方向键转向。若任意老鼠[因扫击伤害虚弱](包括进入“铁血”等状态)，且[扫击方向上有火箭](以如玉为半圆的圆心，半径约800的半圆内有空置火箭，且中间无平台阻挡)，则会[将其击飞到火箭上](将其向火箭方向上直线击飞，击飞期间失重，碰到火箭时自动绑上并点燃，正常触发绑火箭的-10秒引线效果及相关知识卡。该效果的瞄准有一定问题，可能出现多只虚弱老鼠向同一个火箭方向扫击的情况，并且距离火箭过近时可能会出现向上击飞而未击飞到火箭上的情况)。花枪反击可命中管道中的老鼠。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键'],
        cancelableAftercast: ['道具键'],
