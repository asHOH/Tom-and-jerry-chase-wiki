    ...
    skills: [
      {
        ...
        aliases: ['打碟'],
        description:
          '开始狂欢，期间{加速}但无法进行[部分交互](可正常移动、跳跃、抓取老鼠和绑火箭等，但无法进行攀爬等交互)，且[免疫大多数控制效果](不包括虚弱)，持续10秒。技能期间对附近的敌人造成持续伤害和减速。恶魔汤姆头顶会依次出现2条舞步指令，正确执行全部指令会随机获得护盾/恢复/增伤，并强化武器技能。',
        detailedDescription:
          '开始狂欢，期间{加速}但无法进行[部分交互](可正常移动、跳跃、抓取老鼠和绑火箭等，但无法进行攀爬等交互)，且[免疫大多数控制效果](包括仙女鼠八星的变身效果，但不包括虚弱、减速、尼宝鱼钩拽取等效果。技能期间被莱恩变身为线条猫时，技能不中断)，持续10秒。技能期间对附近的敌人造成持续伤害和减速。恶魔汤姆头顶会依次出现2条舞步指令，正确执行全部指令会随机获得护盾/恢复/增伤，且获得一段时间的“列车狂欢”状态，该状态下武器技能会一次性召唤2条轨道&列车。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '拖动技能，在指定位置生成{轨道}，随后会有{列车}沿轨道冲撞，对被撞击的敌人施加伤害，眩晕和击退效果。强化期间，本技能会一次性召唤2条轨道&列车。',
        detailedDescription:
          '拖动技能，在指定位置[迅速](原2.1秒，现已大幅加速)生成{轨道}，轨道会以技能释放的位置为中点，向恶魔汤姆面朝方向伸展，角度在一定范围内随机（通常趋于水平）；[短暂延迟后](原为“轨道完全生成后”，现版本已更改)后召唤{列车}进行[迅速](原1.8秒，现已大幅加速)冲撞，对被撞击的敌人施加少量伤害，并造成眩晕和击退效果。“列车狂欢”期间，本技能会一次性召唤2条轨道&列车。跳跃不会中断技能前摇。前摇状态下可以使用爪刀攻击。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
        skillLevels: [
  ...
  如玉: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '如玉无法释放常规爪刀，但拥有两种特殊爪刀，特殊爪刀[与技能类似](可在手中有老鼠时释放；可移动释放，但释放期间不能转向；可用道具键取消前后摇，但会进入CD；可打断需要其他技能键才能打断的技能；不会因缴械被封锁)，[无法触发常规爪刀效果](无法直接抓起被拍子控制的老鼠，无法为知识卡-乘胜追击叠加层数，无法破坏莱恩-蘸水笔创造的方块)，[无法受到大部分爪刀相关效果加成](无法受到知识卡-击晕、猛攻、蓄势一击、长爪；特技-全垒打，长爪一击，勇气爪刀影响)，但[CD与爪刀相同](可被影响爪刀CD的效果影响，如变身药水及特技-“我生气了！”)，且[不会被无法释放技能的效果封锁](该特点与共研服测试期间不同，注意多加留意；特殊爪刀也不会因缴械被封锁)。[两种特殊爪刀共用CD](共用爪刀CD，释放跳跃劈枪时会重置前刺回马枪的状态)。\n1.前刺回马枪：在地面时释放，分为2段：前刺枪——[前摇0.35秒，后摇0.1秒](可移动释放，可被道具键取消前后摇（取消前摇会直接进入CD）)，对身前约450范围内的敌方造成{40}伤害，命中非虚弱敌方时获得30%加速，持续3秒；回马枪——[前摇0.35秒，后摇0.35秒](可移动释放，不可空中释放，可被道具键取消前后摇（取消前摇会直接进入CD）)，对身后约450范围内的敌方造成{40}伤害，[击退对方约100距离](若对方处于部分失重状态（例如救援队友时的失重状态），则击飞距离会更长)，若命中[被前刺枪命中过的非虚弱目标](指被同一轮前刺回马枪的第一段命中过的目标，包括初次命中时处于虚弱状态的目标，或是再次命中时持有护盾的目标（对方会先被回马枪击破一层护盾，然后再受到额外伤害，额外伤害也可破盾）)，则额外造成{120}伤害和[0.5秒强控制状态](该状态实际效果与眩晕类似，但角色头顶并未出现“眩晕”图标；动作与击退类似，但击退距离为0，且会中断回马枪原本的击退效果)。\n2.跳跃劈枪：在空中时释放，[前摇0.1秒，后摇0.45秒](可移动释放，可被移动、跳跃、道具键取消前后摇（取消前摇会直接进入CD）)，对身前[约500范围内](500指横向判定范围。该攻击的纵向判定范围远大于常规爪刀)的敌方造成{65}伤害，命中非虚弱敌方时获得30%加速，持续3秒。跳跃劈枪有概率出现bug：距离较远时，有概率出现命中判定但不造成伤害。\n\n如玉从商店购买道具所需的时间较长（需要4秒）。',
      },
    ],
  },
