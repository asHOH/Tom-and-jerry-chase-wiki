    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '选择一只敌方老鼠进行锁定。锁定期间：自身能够在小地图上看到该老鼠的位置；其移动时会留下踪迹，自身接触踪迹会获得加速；自身对非锁定的老鼠造成的伤害降低，受到其对自身造成的伤害和{眩晕}大幅降低。',
        detailedDescription:
          '侦探汤姆通过外置轮盘选择一只敌方老鼠（被{绑上火箭}或{放飞}的老鼠除外）进行锁定，对目标赋予“被锁定”状态，并对自身赋予“锁定”状态，持续时间与技能等级有关。\n\n“锁定”：侦探汤姆对非“被锁定”目标造成的伤害变为原先的0.6倍；“被锁定”目标对侦探汤姆造成的伤害和{眩晕}状态时长变为原先的0.2倍。\n“被锁定”：目标持续在敌方小地图上显示位置；目标每移动约100距离，会生成1片“踪迹”。\n“踪迹”：[侦探汤姆](也包括侦探汤姆的其它队友)接触后{移速}×1.2，重复触碰仅刷新持续时间；场上最多同时存在25片“踪迹”，超出上限后最先生成的“踪迹”会消失；“锁定”与“被锁定”状态结束时，所有“踪迹”统一消失。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键', '道具键'],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '“被看穿”状态受到的所有伤害额外提高。',
            detailedDescription: '“被看穿”状态再额外使{受击减伤}-40（与原先效果合计为-60）。',
            cooldown: 10,
          },
          {
            level: 3,
      ...
      },
      {
        ...
        detailedDescription:
          '侦探汤姆进入{猫虚弱}状态时，2秒后将自动起身，并获得“轮椅状态”。（本效果无需升级被动即会生效）\n“轮椅状态”：持续5秒；{无敌}；可进行移动与跳跃；无法进行交互、捡起道具、使用爪刀、使用技能与特技。\n\n侦探汤姆拥有“线索值”机制。本技能升级后，敌方进行部分行为时会掉落{线索}。\n“线索”：侦探汤姆靠近后自动拾取，并增加自身“线索值”；场上最多同时存在14个“线索”，超出上限后最先生成的“线索”消失。\n“线索值”仅可通过拾取“线索”增加，上限为50点；进入墙缝期后，自身当前“线索值”减少一半。\n\n达到不同“线索值”时，将获得额外能力：\n- 达到10点：获得主动技能“加速轮椅”。CD:6.5秒。进入持续3秒的“[强化轮椅状态](技能特征与“轮椅状态”相同，但不受本技能3级效果加成)”，期间[移速与跳跃能力提高40%](该数值待进一步确认，仅供参考)，并获得持续2秒的{隐身}；释放后每秒恢复10Hp，持续10秒。\n- 达到20点：受到任意来源伤害时，进入“侦探汤姆隐身”：{隐身}，持续4秒，使用道具或进行任意交互后显形。\n- 达到30点：“侦探汤姆隐身”取消显形限制；隐身期间移速不会低于正常移速；爪刀CD减少50%。\n- 达到40点：每15秒对自身施加“发现”状态，并对敌方施加“被发现”状态。“发现”：{暴露位置}，持续3秒，会被{降落伞}免疫。“被发现”：无实际效果，仅对鼠方提示。\n- 达到50点：侦探汤姆在同一局内第3次及以上绑上同一只敌方老鼠时，火箭引线时间减少1000秒（即秒飞）。', //40%+10%？
        canMoveWhileUsing: true,
        canUseInAir: true,
        skillLevels: [
          {
