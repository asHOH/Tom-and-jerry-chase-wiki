  ...
  恶魔汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '拖动技能，在指定位置[迅速](原2.1秒，现已大幅加速)生成{轨道}，轨道会以技能释放的位置为中点，向恶魔汤姆面朝方向伸展，角度在一定范围内随机（通常趋于水平）；[短暂延迟后](原为“轨道完全生成后”，现版本已更改)后召唤{列车}进行[迅速](原1.8秒，现已大幅加速)冲撞，对被撞击的敌人施加少量伤害，并造成眩晕和击退效果。“列车狂欢”期间，本技能会一次性召唤2条轨道&列车。跳跃不会中断技能前摇。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
        skillLevels: [
