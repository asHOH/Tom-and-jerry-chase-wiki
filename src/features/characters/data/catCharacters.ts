    ...
    skills: [
      {
        ...
        detailedDescription:
          '立刻[解除眩晕等控制效果](不包括番茄减速等减速效果)，然后进入一段时间的无敌。前摇期间获得[弱霸体](不免疫虚弱和部分变身效果，且会被冰面打断)。无敌期间加速12.5%，[免疫大部分道具和技能的负面效果](包括会免疫尼宝-尼宝的朋友造成的眩晕效果（不免疫位移）；免疫仙女鼠-星星棒的8星变身效果)，但[仍会受到部分特殊技能影响](不免疫尼宝-尼宝的朋友造成的位移效果（会免疫眩晕）；不免疫仙女鼠-星星棒的1/2/4/6星的效果，且仙女鼠-星星棒的8星仍可打断交互；若在莱恩蓝图内受到仙女鼠的伤害，会变成线条猫；不免疫部分改变或创造地形类的技能)。无敌结束后减速10%，持续2秒，可被护盾抵消。',
  ...
  托普斯: {
    ...
    knowledgeCardGroups: [
      ...
      },
      {
        ...
        description:
          '托普斯爪刀较短，{长爪}能极大幅提高爪刀范围，配合{击晕}、{1级被动}和{我生气了！}打出连续控制和爆发伤害，还能刷取经验。但{长爪}负面效果也很明显，使用时需斟酌利弊。',
      },
      {
        cards: ['S-击晕', 'A-加大火力', 'A-穷追猛打', 'B-皮糙肉厚', 'C-猫是液体'],
        description: '适用于管道图，{加大火力}弥补火箭燃烧效率不足的问题。',
      },
      {
        cards: ['S-击晕', 'S-知识渊博', 'A-熊熊燃烧', 'C-猫是液体'],
        description: '适用于管道图，{知识渊博}提供的大量经验让托普斯更早进入强势期。',
      },
    ],
  ...
  莱特宁: {
    ...
    skills: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 18,
            detailedDescription:
              '垃圾桶持续时间延长至18秒；进入垃圾桶范围改为造成{15*,固定,不可致伤}伤害，后续改为每秒受到{8*,固定,不可致伤}伤害。垃圾桶会对Hp降至最低的老鼠造成1秒眩晕，每5秒触发一次。',
          },
          {
            level: 3,
      ...
      },
      {
        ...
        detailedDescription:
          '从垃圾桶中倒出{咸鱼(衍生物)}并标记在小地图上，咸鱼持续一分钟，鼠方踩到后会受咸鱼影响，持续20秒，期间推速降低40%，救援、治疗速度降低33%，移速降低10%，跳跃高度降低（未测），同时暴露小地图位置。可通过吃{蛋糕}、喝{牛奶}、喝饮料、{应急治疗}、{2级牛仔吉他}来解除。爪刀命中[带有咸鱼效果的敌方](包括虚弱老鼠)时，将重置瞬移闪击CD，爪刀CD缩短至1.9秒，并获得50Hp/秒的恢复效果，持续1秒。瞬移闪击将优先追踪带有咸鱼效果的敌方，并大幅提高追踪范围；手中有老鼠时，则优先追踪最近的咸鱼。\n使用技能后一段时间内，可通过二段技能投掷一条{咸鱼-投射物}，命中老鼠产生与咸鱼相同的效果，命中其它物体则会直接消失。\n本技能在未加点时也会进行冷却。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        detailedDescription:
          '向前冲刺2s，期间无敌、移速提升75%，若命中敌方将造成{10*,可致伤}伤害、使其移速降低25%，跳跃高度降低50%，持续3s。冲刺时遇到正常、虚弱、护盾、霸体和[部分无敌效果](罗宾汉降落伞、剑杰格挡、剑菲冲刺、冰冻保鲜特技、变大)的老鼠均可解锁二段技能挑飞，否则技能进入CD。解锁后可在6s内使用二段技能[挑飞](前摇0.35s，可用道具键、其他技能键取消释放；无视护盾和除罗宾汉杰瑞的降落伞、剑客泰菲的冲刺、变大外的其他无敌效果，但无法挑飞霸体老鼠)，向上挑飞脚下的老鼠，对老鼠造成1.9s眩晕并击飞1s。若挑飞老鼠，可在6s内使用三段技能[追踪到老鼠位置](以2000速度飞向敌方，飞行最大时间0.6s，若发生以下情形将不会释放连斩：超过最大飞行时间，被打断，被墙体、拳头盒子、嫦娥阻挡，老鼠在自己下方（泰菲家族由于模型小，若与剑汤站在同一水平面则无法连斩）)进行[连斩](无视护盾、霸体和无敌效果；期间只会受到天使泰菲反伤和可击中管道中的角色的技能伤害)。连斩持续3.1秒，会使[范围内的老鼠](不包括手中的老鼠)浮空4.2秒、每0.55秒受到{10*,不受目标影响,无视护盾,不可致伤}伤害，总共5次。连斩期间老鼠无法移动，但可以使用技能和交互。无法打爆机器鼠。[快速点击可加速连斩](每次点击使连斩持续时间缩短0.5s，同时老鼠浮空时间缩短0.5s，并且总共至多额外造成两次伤害)。连斩后摇0.8s，可用道具键取消。连斩造成两次伤害后会使老鼠受到[威慑效果](绑上火箭后消失)，被绑上火箭时，引线将额外减少10s。挑飞和连斩[在空中释放](不是跳放)将直接进入CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        forecast: 0,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 20,
            detailedDescription:
              '一段和三段攻击额外造成20%减速，持续3.8s；二段造成的眩晕时间延长至0.8s。',
          },
          {
            level: 3,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '剑气[命中敌方](注意：剑气不会命中“已被当次常规爪击区域造成伤害的目标”)时，{主动技能}的CD缩短30秒。',
          },
        ],
      },
    ],
        ...
        skillLevels: [
          {
            level: 1,
            description: '',
            detailedDescription: '瑜伽球的伤害为{30*,不受来源影响,可致伤}、造成的眩晕持续1.5秒。',
            cooldown: 20,
            charges: 2,
          },
          {
          ...
          },
          {
            ...
            detailedDescription:
              '瑜伽球造成的眩晕持续时间延长至2.5秒、伤害提高至{35*,不受来源影响,可致伤}。',
            cooldown: 15,
            charges: 2,
          },
        ],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '成功释放列车后给予自身一层{护盾}，持续5秒。列车经过恶魔汤姆时会刷新该护盾。',
            cooldown: 8,
            charges: 3,
          },
          {
  ...
  侦探汤姆: {
    ...
    catPositioningTags: [
      ...
      },
      {
        tagName: '翻盘',
        isMinor: true,
        description: '积累50点线索值后，第二次绑同一老鼠可直接秒飞，一旦鼠方出现失误即可翻盘。',
        additionalDescription: '',
      },
    ],
    skillAllocations: [],
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '选择一只敌方老鼠进行锁定。锁定期间：在小地图上展示该老鼠的位置；其移动时会留下踪迹，自身接触踪迹会获得加速；自身对非锁定的老鼠造成的伤害降低，但受到被锁定目标对自身造成的伤害和{眩晕}大幅降低。',
        detailedDescription:
          '侦探汤姆通过外置轮盘选择一只敌方老鼠（被{绑上火箭}或{放飞}的老鼠除外）进行锁定，对目标赋予“被锁定”状态，并对自身赋予“锁定”状态，持续一段时间。\n\n“锁定”：侦探汤姆对非“被锁定”目标造成的伤害变为原先的0.6倍；“被锁定”目标对侦探汤姆造成的伤害和{眩晕}状态时长变为原先的0.2倍。\n“被锁定”：持续在敌方小地图上显示位置；每移动约100距离，会生成1片“踪迹”。\n“踪迹”：[侦探汤姆](包括侦探汤姆的队友)接触后{移速}×1.2，重复触碰仅刷新持续时间；场上最多同时存在25片“踪迹”，超出上限后最先生成的“踪迹”会消失；“锁定”与“被锁定”状态结束时，所有“踪迹”统一消失。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键', '道具键'],
      ...
      },
      {
        ...
        aliases: ['放大镜'],
        description:
          '举起放大镜释放射线照射敌方，叠加“被照射”状态，使其减速。叠满6层后转化为“被看穿”状态，使敌方反向、禁用技能与道具、受到的伤害增加、体型变大，且对该敌方造成伤害后短暂爪刀CD减半、短暂[免疫禁用爪刀效果](具体机制待确认)。',
        detailedDescription:
          '长按并拖动技能键，持续释放一道射线照射指定位置。射线每0.3秒对命中的目标施加1层“被照射”状态；松开技能键结束释放；若技能释放后1.5秒内[主动](因受控制而被动取消时，无减免CD效果)取消，则下一次使用CD变为1秒；若持续长按不取消，则技能最长持续20秒；手中有老鼠时无法使用。\n技能释放期间，侦探汤姆可照常移动、跳跃、使用爪刀或主动技能，且以上行为不会中断技能；但无法使用道具。\n\n“被照射”：减少目标移速与跳跃高度；4秒内未继续叠加时清空层数；最高可叠加6层；减速与减跳效果各自不可叠加。叠加至6层后，目标失去“被照射”状态并获得“被看穿”状态。\n“被看穿”：持续6秒；禁用技能与道具；[受到的伤害提高](具体机制和数值待确认)；被猫抓住时，使抓住自身的猫绑火箭速度×2，持续10秒；目标体型变大（纵向变大；横向待确认）；侦探汤姆对“被看穿”的敌方造成伤害后，自身爪刀CD减半，且[免疫禁用爪刀效果](具体机制待确认)，持续6秒。\n\n“被照射”与“被看穿”均无视{无敌}、{护盾}、{霸体}状态，但{无敌}、{护盾}状态不会受到减速效果影响；两种状态无法同时存在于同一目标。\n手动拖动放大镜射线命中敌方后（无论是否成功施加“被照射”），将触发“光线自动锁定”；当拖动技能按键角度超过240°或目标离开范围时，将退出“光线自动锁定”。\n侦探汤姆对处于“被锁定”状态的目标使用放大镜射线时，若目标位于技能最大范围略小范围内，则会触发“联动自动锁定”；“联动自动锁定”状态下无法通过拖动角度取消，仅能通过目标离开范围解除。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          {
            level: 1,
            description: '射线每0.3秒施加1层“被照射”。',
            cooldown: 10,
          },
          {
            level: 2,
            description: '“被看穿”状态受到的伤害进一步提高。',
            cooldown: 10,
          },
          {
            level: 3,
      ...
      },
      {
        ...
        type: 'passive',
        description:
          '自身虚弱时间大幅降低，但起身后会进入“轮椅状态”，期间仅可移动和跳跃。（本效果无需升级被动即会生效）\n本技能升级后，敌方进行部分行为时会掉落{线索}。侦探汤姆可以拾取线索并逐步强化自身，每收集10线索依次获得以下能力：可主动[坐上轮椅](与常规的轮椅状态类似，但有以下不同：移速和跳跃能力提高，但不受本技能3级效果加成)、获得{隐身}并恢复HP；受击会进入{隐身}；隐身效果强化；间歇性全局透视；强制放飞已被绑多次的老鼠。\n线索值上限为50点。进入墙缝期后，失去一半的线索值。',
        detailedDescription:
          '进入{猫虚弱}状态时，2秒后将自动起身，并获得“轮椅状态”。（本效果无需升级被动即会生效）\n“轮椅状态”：持续5秒；{无敌}；可进行移动与跳跃；无法进行交互、捡起道具、使用爪刀、使用技能与特技。\n\n侦探汤姆拥有“线索值”机制。本技能升级后，敌方进行部分行为时会掉落{线索}。\n“线索”：侦探汤姆靠近后自动拾取，并增加自身“线索值”；场上最多同时存在14个“线索”，超出上限后最先生成的“线索”消失。\n“线索值”仅可通过拾取“线索”增加，上限为50点；进入墙缝期后，自身当前“线索值”减少一半。\n\n达到不同“线索值”时，将获得额外能力：\n- 达到10点：获得主动技能“加速轮椅”。CD:6.5秒。进入持续3秒的“[强化轮椅状态](技能特征与“轮椅状态”相同，但不受本技能3级效果加成)”，期间[移速与跳跃能力提高](具体数值待进一步确认)，并获得持续2秒的{隐身}；释放后每秒恢复10Hp，持续10秒。\n- 达到20点：受到任意来源伤害时，进入“侦探汤姆隐身”：{隐身}，持续4秒，使用道具或进行任意交互后显形。\n- 达到30点：“侦探汤姆隐身”取消显形限制；隐身期间移速不会低于正常移速；爪刀CD缩短50%。\n- 达到40点：每15秒对自身施加“发现”状态，并对敌方施加“被发现”状态。“发现”：显示敌方在地图上的位置，无视部分隐藏小地图效果（如侦探杰瑞Lv.2被动、机器鼠状态），持续3秒，会被{降落伞}免疫。“被发现”：无实际效果，仅对鼠方提示。\n- 达到50点：侦探汤姆在同一局内第2次及以上绑上同一只敌方老鼠时，火箭引线时间缩短1000秒。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        skillLevels: [
          {
            ...
            detailedDescription:
              '敌方老鼠喝药水、拾取道具、推奶酪、救援队友时，或侦探汤姆对敌方造成伤害、受到敌方伤害时，将在目标附近约150范围内生成“线索”；敌方进行推奶酪或救援队友成功时，额外生成1个“线索”。',
          },
          {
            level: 2,
          ...
          {
            level: 3,
            description: '自身虚弱后进入的“轮椅状态”期间移速提高20%。',
          },
        ],
      },
    ],
