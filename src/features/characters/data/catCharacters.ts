  ...
  牛仔汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '前摇0.25s，对前方老鼠造成1点伤害和持续7.9秒的9.5%减速、给自己持续8秒的1%加速和减少2%爪刀CD，能破坏[易碎道具](包括玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/番茄，以及纸盒、吊灯、牛仔杰瑞的仙人掌等)。连续命中敌方角色两次后获得1层[增益](上限5层)，永久增加3%移速和减少6%爪刀CD。老鼠被累计命中两次后，受到50点伤害和2.4秒眩晕效果，并清除鞭子带来的减益。鞭子眩晕期间可被直接抓取。使用技能时还能使场上的{斗牛}加速。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
    ...
    skillAllocations: [
      {
        ...
        weaponType: 'weapon1',
        description:
          '对方无[稳救位](指救援能力较强的老鼠)时，4级可优先点钻地以加强守火箭能力；对方打架欲望强，伤害高可优先点2、3级钻地；火箭位置差可后期点钻地。',
      },
      {
        id: '主点钻地',
        pattern: '200121120',
  ...
  追风汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          'Lv.0: [走地状态下](不处于空中时，即不包括处于跳跃，坠落等状态中)，每秒获得1秒飞行时间，最多储存10秒。未处于飞行状态时爪刀CD减少35%；飞行状态下[视野范围增加55%](覆盖其他大部分远视效果，但可以和天宫-香炉远视效果叠加)，[可托起其他角色](机器鼠等单位除外)，无视小平台阻挡，并提高移速至水平1015、竖直840。悬停时角色会自动向前以水平350、竖直30的速度下落。飞行时[免疫控制](不免疫虚弱)，但无法拾取道具、使用商店或进行交互（抓起老鼠除外）；受到伤害会减少2秒飞行时间。飞行状态可随时退出，但会清空剩余飞行时间。“退出飞行状态”这一操作无cd。飞行被[强制打断](如被变形、被打死)会使{主动技能}进入10秒CD。该CD不可通过吃蛋糕回复。',
    ...
    skills: [
      {
        ...
        detailedDescription:
          '舞起花枪，持续5秒，使用技能瞬间给予如玉一个持续3.2秒的30%的加速，期间免疫碎片、可移动跳跃但无法交互，每隔一段时间对碰触的老鼠造成8伤害和可叠加的减速，最高叠加4层。技能期间受到来自老鼠的伤害时，可在1.6秒内点按["花枪反击"键](该按键位置和大小可进行调整)对其触发“花枪反击”。技能开启1秒内受击会立刻自动反击。\n\n“花枪反击”：立刻解除控制，结束技能并减少{主动技能}4秒CD，[若目标距离较近](处于以如玉模型中心为圆心，半径约500的圆内)，则直接对[前方600范围内](高度约与自身平齐，范围较大)进行一次[前摇0.3秒，后摇0.6秒](前后摇无法主动取消)的扫击，对所有命中的目标造成{75}伤害和1.9秒眩晕；[若目标距离较远](不处于以如玉模型中心为圆心，半径约500的圆内)，则会[传送到对方头顶并在0.3秒后再度传送到其身后](释放技能时立刻传送到目标头顶高约250的位置并失重，0.3秒后再度传送到其身后。前后摇期间无法主动取消动作，但失重落地的瞬间可以通过爪刀强制中止技能，这会吞掉技能的伤害和控制效果)，然后对[前方600范围内](高度约与自身平齐，范围较大)进行一次[前摇0.4秒，后摇0.55秒](前后摇无法主动取消，且动作期间无法移动跳跃)的扫击，对所有命中的目标造成{75}伤害和1.9秒眩晕。扫击期间不可移动，但可通过方向键转向。若任意老鼠[因扫击伤害虚弱](包括进入“铁血”等状态)，且[扫击方向上有火箭](以如玉为半圆的圆心，半径约800的半圆内有空置火箭，且中间无平台阻挡)，则会[将其击飞到火箭上](将其向火箭方向上直线击飞，击飞期间失重，碰到火箭时自动绑上并点燃，正常触发绑火箭的-10秒引线效果及相关知识卡。该效果的瞄准有一定问题，可能出现多只虚弱老鼠向同一个火箭方向扫击的情况，并且距离火箭过近时可能会出现向上击飞而未击飞到火箭上的情况)。花枪反击可命中管道中的老鼠。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        forecast: 0,
