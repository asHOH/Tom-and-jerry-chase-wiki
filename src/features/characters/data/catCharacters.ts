  ...
  侦探汤姆: {
    ...
    catPositioningTags: [
      ...
      },
      {
        tagName: '翻盘',
        isMinor: true,
        description: '积累50点线索值后，第三次绑同一老鼠可直接秒飞，一旦鼠方出现失误即可翻盘。',
        additionalDescription: '',
      },
    ],
    skillAllocations: [],
    ...
    specialSkills: [
      {
        name: '蓄力重击',
        description: '侦探汤姆的击倒手段较为单一，因此需要特技来补充伤害。',
      },
      {
        name: '我生气了！',
        description:
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '选择一只敌方老鼠进行锁定。锁定期间：在小地图上展示该老鼠的位置；其移动时会留下踪迹，自身接触踪迹会获得加速；但自身对非锁定的老鼠造成的伤害降低、受到其对自身造成的伤害和{眩晕}大幅降低。',
        detailedDescription:
