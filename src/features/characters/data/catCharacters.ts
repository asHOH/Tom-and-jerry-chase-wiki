  ...
  兔八哥: {
    ...
    skillAllocations: [
      ...
      },
      {
        ...
        weaponType: 'weapon1',
        description:
          '兔子主流加点之一，可以无脑拿也可看情况拿，但在对面打架能力强时非常推荐使用，当对面前期就爱打架可以5级点二级洞6级点三级洞。',
      },
    ],
    knowledgeCardGroups: [
      {
