...
const catCharacterDefinitions = {
    ...
    knowledgeCardGroups: [
      {
        ...
        groups: [
          ...
          },
          {
            ...
            description: '应对管道图的卡组，大图带{屈打成招}，小图带{熊熊燃烧}。',
          },
        ],
        description: '',
        defaultFolded: false,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription: '对敌方造成伤害时，回复25Hp(游戏原文50)并缩短主动技能3秒CD。',
          },
          {
            level: 3,
  ...
  牛仔汤姆: {
    ...
    knowledgeCardGroups: [
      {
        ...
        groups: [
          ...
          },
          {
            ...
            description: '鞭子经典776卡组，要移速有移速，要控制有控制，要经验有经验。',
          },
          {
            cards: [
              'S-击晕',
              'S-乾坤一掷',
              [CardGroupType.Or, 'A-穷追猛打', 'A-心灵手巧'],
              'B-皮糙肉厚',
            ],
            description:
              '乾坤卡组，{乾坤一掷}配合{3级被动}可一个道具瞬秒老鼠。自身找节奏能力强可把{穷追猛打}换为{心灵手巧}。缺点是牛汤不好维持{乾坤一掷}所需的血量。',
          },
        ],
        defaultFolded: false,
      },
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '挥舞鞭子，对面前敌方角色造成{1*,不受来源影响,不可致伤}伤害和持续7.9秒的9.5%减速，并击落老鼠持有除{金币}外的道具。命中时使自身加速并减少爪刀CD一段时间，持续8秒。两种加成均可叠加，叠加到第2层时清除，对敌方造成{40*,不受来源影响,不可致伤}伤害和2.4秒{眩晕}（老鼠处于该眩晕下可被{直接抓起}）/使自身获得永久加成（可叠加3层）。\n鞭子也会能破坏[易碎道具](包括玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/番茄，以及纸盒、吊灯、牛仔杰瑞的仙人掌、朝圣者泰菲的木塞、面粉袋等)。\n使用技能时还能使场上的{斗牛(衍生物)}加速。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: ['跳跃键', '道具键'],
        ...
        groups: [
          {
            cards: [
              ...
              [
                CardGroupType.Or,
                'S-击晕',
                [CardGroupType.And, 'S-猛攻', 'B-反侦察'],
                [CardGroupType.And, 'A-熊熊燃烧', 'C-猫是液体'],
              ],
            ],
            description:
              '携带{击晕}的卡组在前中后期都有较高强度。{反侦察}提供更多经验，成型更快，后期更强势。{熊熊燃烧}+{猫是液体}适合森林牧场，太空堡垒三等管道图。',
            contributor: 'gezi',
          },
          {
        ...
        groups: [
          {
            cards: [
              ...
              'A-细心',
              'B-捕鼠夹',
              [CardGroupType.Or, 'B-皮糙肉厚', 'C-巡逻戒备'],
            ],
            description: '香水图多常规防守卡组，若无21知识点则将{皮糙肉厚}换为{巡逻戒备}。',
          },
          {
            cards: ['S-乘胜追击', 'S-屈打成招', 'A-穷追猛打', 'A-细心'],
            description: '待补充',
          },
        ],
        defaultFolded: true,
        ...
        skillLevels: [
          {
            ...
            cooldown: 16,
            detailedDescription:
              '香水自然释放频率为1秒/次（单次技能共能自然释放12次）。\n图多盖洛在香水内获得10Hp/秒的恢复效果；敌方在香水内移速降低25%，跳跃速度降低5%，推速降低10%，[造成的伤害降低10](最低为0)，[Hp自然恢复速度降低5/秒](最低为0，只对基础属性中的自然恢复一项生效，对因其他途径获得的恢复效果无效)。',
          },
          {
            level: 2,
            description:
            ...
            cooldown: 16,
            detailedDescription:
              '香水自然释放频率提高至0.8秒/次（自然释放次数增加到18次）。\n图多盖洛在香水内获得的恢复效果改为15Hp/秒，且攻击增伤提高25，爪刀CD缩短30%；敌方在香水区域内移速改为降低35%，跳跃速度改为降低10%，推速改为降低40%，[造成的伤害改为降低20](最低为0)。',
          },
          {
            level: 3,
            description:
            ...
            cooldown: 16,
            detailedDescription:
              '图多盖洛在香水内获得的恢复效果改为20Hp/秒，攻击增伤改为提高50，爪刀CD改为缩短70%，且爪刀范围提高到300；敌方在香水区域内移速改为降低45%，跳跃速度改为降低15%，推速改为降低70%，[造成的伤害改为降低30](最低为0)，且禁用技能。',
          },
        ],
        canHitInPipe: false,
        cooldownTiming: '释放时',
  ...
  侍卫汤姆: {
    ...
    catPositioningTags: [
      {
        ...
        level: 4,
        description:
          '3级被动提供减控和免虚弱能够一定程度上减少敌方干扰所带来的影响；3级皇家火炮的压制力能够一定程度上限制对方行动',
        additionalDescription: '',
      },
      {
        tagName: '追击',
        level: 4,
        description:
          '1级被动、皇家火炮、警戒和皇家盔甲的“旋风斧”都能提升移动速度，且警戒可以使敌方位置暴露在小地图上',
        additionalDescription: '',
      },
      {
        tagName: '后期',
        level: 4,
        description:
          '3级皇家火炮对敌方有很大的压制力；3级警戒只要警戒到敌方就可以获得全部档次的增益，且增益时长与警戒冷却时长一致，可以轻松续杯',
        additionalDescription: '',
      },
      {
        tagName: '防守',
        level: 3,
        description:
          '皇家盔甲的守火箭能力极强，墙缝期左右两盔甲人护法迫使敌方必须先击倒盔甲人或移动到墙缝面前才能造成有效输出；3级皇家火炮的压制力使其也有不错的防守能力',
        additionalDescription: '',
      },
    ],
    skillAllocations: [
    ...
    knowledgeCardGroups: [
      {
        ...
        description: '蓄势一击配合侍卫二级被动可以打死125血量的老鼠，既适用一武也适用二武。',
        defaultFolded: false,
      },
      {
        cards: ['A-熊熊燃烧', 'A-心灵手巧', 'A-细心', 'A-加大火力', 'C-猫是液体'],
        description: '森林牧场专用卡组。',
      },
      {
        id: '击晕',
        description: '',
        groups: [
          {
            cards: [
              ...
              [
                CardGroupType.Or,
                [CardGroupType.And, 'A-穷追猛打', [CardGroupType.Or, 'A-心灵手巧', 'B-皮糙肉厚']],
                [CardGroupType.And, 'A-细心', 'C-猫是液体', 'C-狡诈'],
              ],
            ],
            description: '',
          },
    ...
    specialSkills: [
      ...
      },
      {
        name: '我生气了！',
        description:
          '配合{2级随机应变}、{警戒}、{乘胜追击}等减爪刀CD效果可以做到高频出刀，同时再携带{击晕}也可以造成可观的控制效果。更建议在使用二武器{皇家盔甲}时携带，但该特技并不能减少盔甲人的爪刀CD',
      },
    ],
    recommendedStorePlans: [
      {
    ...
    skills: [
      {
        ...
        detailedDescription:
          '提高视野范围至原先的3.7倍，并警戒房间内[所有老鼠](距离极远的除外)，持续25秒。被警戒到的老鼠推速下降50%，暴露小地图视野，并清除[部分增益](所有药水；侦探杰瑞、侦探泰菲的隐身；大部分护盾效果，如知识卡、角色技能的护盾（罗菲2被与恶魔传送门的盾不会被消除）；部分无敌效果，如无畏、舍己、国王护盾、莉莉2级被动、冰冻保鲜；米雪儿小情绪的变大；仙女鼠星星与2级被动的隐身；红花；太空药水仓的跳跃提升、变大和隐身；熊猫谷药水仓的兴奋；天宫香炉的远视)。若警戒到老鼠，额外获得20%加速；若未警戒到，则返还15秒CD。使用降落伞中的罗宾汉不会被警戒到。',
        canMoveWhileUsing: false,
        canUseInAir: false,
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '点按技能键在指定洞口部署皇家盔甲，或拖动技能键在指定位置部署皇家盔甲。盔甲会自动攻击附近老鼠。侍卫汤姆可穿戴盔甲，继承知识卡效果，并获得斧盾和旋风斧技能。盔甲免疫绝大多数控制效果，但带伤害的控制对盔甲造成的伤害会提升。',
        skillLevels: [
          {
            level: 1,
            cooldown: 50,
        ...
        detailedDescription:
          '侍卫汤姆可通过拖动技能在指定位置放置皇家盔甲，或点击技能选择有老鼠洞的房间放置皇家盔甲，皇家盔甲会出现在老鼠洞位置。每个房间只能存在1个皇家盔甲。皇家盔甲拥有150点健康值，免疫眩晕和[部分其他控制效果](包括缴械、禁技能、反向、失明、减速等)，但如果眩晕效果附带伤害，则该伤害提升25%。皇家盔甲可被侍卫汤姆穿戴，并根据是否被穿戴分为未穿戴状态和穿戴状态。\n\n未穿戴状态：每15秒进行自主攻击，对命中的目标造成50点伤害并降低20%的移速，持续1.5秒。侍卫汤姆使用爪击时，[皇家盔甲将原地进行协同攻击](除非处于攻击的冷却时间内)，对被命中的目标造成30点伤害。\n\n穿戴状态：穿戴状态下盔甲人的健康值提升至280点，同时恢复130点健康值，可进行移动和[攻击](手中抓着老鼠时也能攻击)，攻击的冷却时间固定为5秒（不受其它效果影响），命中造成50点伤害。穿戴状态下可以继承侍卫汤姆的[部分增益](包括一切药水效果，若护盾效果层数为2层或以上，则会刷新层数)和[知识卡效果](知识渊博，乾坤一掷，越挫越勇，细心，皮糙肉厚，斗志昂扬不生效)，并获得“旋风斧”和“斧盾”两个技能。穿戴状态下无法使用道具和饮料，也[无法进行部分交互](无法爬梯子，无法绑火箭，无法钻熊猫馆的{站牌}；但可以钻{管道}，可以捡起老鼠)。\n“旋风斧”：释放后旋转攻击，对命中的敌方造成8点固定伤害并施加持续15秒的警戒效果，若同一目标连续受到3次伤害，则会召唤金丝雀进行攻击，造成1.5秒的眩晕。技能可持续25秒，期间再次点击可提升自身的移速和伤害频率，但会减少5秒技能持续时间，最多可点击3次。穿戴状态下使用旋风斧技能，其它未穿戴的皇家盔甲也会协同使用旋风斧技能。释放该技能时无法捡起老鼠。点击攻击键可提前终止该技能。\n“斧盾”：该技能拥有插斧和插盾两个子技能，两个技能共用冷却时间。插盾时将形成盾牌阻挡，可通过交互拆除，但老鼠交互拆除后会受到20%的减速效果，持续3秒。插斧将形成斧头，触碰到斧头的敌方会受到金丝雀的攻击，眩晕1.5秒，每次触发后5秒内不会重复受到该效果。\n\n皇家盔甲在蓝图内收到伤害会变成粉笔猫，但被三级蓝图命中不会变成粉笔猫；侍卫汤姆手中抓着老鼠进入皇家盔甲并被变成粉笔猫时，手中的老鼠不会掉落，且此时无法退出盔甲。\n恶魔杰瑞的传送门可以把穿戴状态下的皇家盔甲传送，未穿戴状态下的皇家盔甲不能传送。\n皇家盔甲无视剑客莉莉的风墙。\n朵朵释放电流可无视皇家盔甲对盔甲里的猫造成伤害，也可以救下队友。\n皇家盔甲无视仙女鼠的星星（直接穿过皇家盔甲）。\n皇家盔甲无视魔术师的卡牌效果（三种卡牌均不触发效果）。\n皇家盔甲被朝圣者泰菲的木塞子命中头部后不会有免疫木塞子的效果。\n皇家盔甲不会被蓝恶魔追踪，但能被蓝恶魔命中。\n尼宝的钩子无法钩下穿着皇家盔甲的猫手里的老鼠，但可以打断“旋风斧”。\n皇家盔甲完全免疫牛仔杰瑞的两个技能。\n皇家盔甲免疫霜月的滑铲，乾坤袋可以将盔甲吞掉。\n皇家盔甲免疫蒙金奇的主动技能。\n米可采访无法给盔甲叠层，相机可以给盔甲拍照并造成伤害，但盔甲无法被回溯。',
        parts: [
          {
            cueRange: '随距离远近变化',
            forecast: 0.9,
  ...
  米特: {
    ...
    skillAllocations: [
      ...
      },
      {
        ...
        pattern: '101200122',
        weaponType: 'weapon1',
        description: '有{马索尔}的阵容提前点饭盒，阻止马索尔救援。',
      },
    ],
    knowledgeCardGroups: [
      {
      ...
      },
      {
        cards: [
          ...
          [
            ...
            'A-穷追猛打',
            'A-细心',
            [CardGroupType.And, 'C-猫是液体', 'C-狡诈'],
          ],
        ],
        description:
          '击晕流：现版本主流卡组。{加大火力}可换{穷追猛打}，根据角色地图决定。{细心}用于打布局流，适合夹多的地图。{猫是液体}适用管道图。',
      },
    ],
    specialSkills: [
      {
        ...
        groups: [
          {
            cards: [
              ...
              [
                ...
                'A-熊熊燃烧',
                [CardGroupType.And, 'A-加大火力', 'C-猫是液体'],
                [CardGroupType.And, 'A-穷追猛打', 'C-猫是液体'],
                [CardGroupType.And, 'B-皮糙肉厚', 'C-猫是液体'],
              ],
            ],
            description:
              '不同程度舍弃放飞速度以提升其他方面性能，管道重要的地图可以考虑使用{加大火力}和{猫是液体}组合，以此类推，需要更好的前期节奏使用{穷追猛打}，敌方伤害高可以使用{皮糙肉厚}，如有21点知识量且管道不重要可以将{猫是液体}替换为其他3费知识卡（如{攻其不备}）',
          },
        ],
        description: '',
        defaultFolded: false,
        detailedDescription:
          '776是剑客汤姆的底层逻辑，在此基础上舍弃其中一张卡来衍生出不同适用场景的卡组，一般会优先考虑舍弃{熊熊燃烧}来携带其他功能的卡',
      },
      {
        id: '舍弃{击晕} **新手慎用**',
        groups: [
          {
            ...
            description:
              '无{击晕}流派的主流配卡，如果没有21点知识量又要想要携带{猫是液体}的话，可以从除了{乘胜追击}以外的卡舍弃其中一张，不建议舍弃{乘胜追击}，没有{击晕}的情况下维持较高的移动速度对于控制与攻击目标之间的距离尤为重要',
          },
        ],
        description: '无击晕，新手勿用',
        defaultFolded: true,
        detailedDescription:
          '随着游戏不断地更新，剑客汤姆在对战中越发吃力，部分玩家为了弥补角色短板而舍弃{击晕}，虽然最开始引起了许多争议，但不得不承认这确实是一种将上下限拉得更开的行为，有自信能打出更高的上限的话，无{击晕}卡组也是不二之选',
      },
      {
        id: '舍弃{乘胜追击}',
        groups: [
          {
            cards: [
              ...
              [
                CardGroupType.Or,
                [CardGroupType.And, 'A-熊熊燃烧', 'A-穷追猛打', 'B-皮糙肉厚'],
                [CardGroupType.And, 'A-熊熊燃烧', 'B-皮糙肉厚', 'C-猫是液体'],
                [CardGroupType.And, 'A-加大火力', 'A-穷追猛打', 'B-皮糙肉厚', 'C-猫是液体'],
              ],
            ],
            description: '没有{乘胜追击}会更怕拉扯',
          },
        ],
        description: '常用，但无乘胜，怕拉扯',
        defaultFolded: true,
        detailedDescription:
          '一般对局通常不会舍弃{乘胜追击}，比起操作更重思路，某些特定场景可能会更好用',
      },
    ],
    specialSkills: [
      {
    ...
    skills: [
      {
        ...
        detailedDescription:
          '向前冲刺2s，期间无敌并击飞包括老鼠夹在内的多数道具(非投掷)、移速提升75%，若命中敌方将造成{10*,可致伤}伤害、使其移速降低25%，跳跃高度降低50%，持续3s。冲刺时遇到正常、虚弱、护盾、霸体和[部分无敌效果](罗宾汉降落伞、剑杰格挡、剑菲冲刺、冰冻保鲜特技、变大)的老鼠均可解锁二段技能挑飞，否则技能进入CD。使用{绝地反击(特技)}和{急速翻滚（猫特技）}将终止冲刺并使技能进入CD。解锁后可在6s内使用二段技能向上[挑飞](前摇0.35s，可用道具键、其他技能键取消释放；无视护盾和除罗宾汉杰瑞的降落伞、剑客泰菲的冲刺、变大外的其他无敌效果，但无法挑飞霸体老鼠)脚下的老鼠，对老鼠造成1.9s眩晕并击飞1s。若挑飞老鼠，可在6s内使用三段技能[追踪到老鼠位置](以2000速度飞向敌方，飞行最大时间0.6s，若发生以下情形将不会释放连斩：超过最大飞行时间，被打断，被墙体、拳头盒子、嫦娥阻挡，老鼠在自己下方（泰菲家族由于模型小，若与剑汤站在同一水平面则无法连斩）)进行[连斩](无视护盾、霸体和无敌效果；期间只会受到天使泰菲反伤和可击中管道中的角色的技能伤害)。连斩持续3.1秒，会使[范围内的老鼠](不包括手中的老鼠)浮空4.2秒、每0.55秒受到{10*,不受目标影响,无视护盾,不可致伤}伤害，总共5次。连斩期间老鼠无法移动，但可以使用技能和交互。无法打爆机器鼠。[快速点击可加速连斩](每次点击使连斩持续时间缩短0.5s，同时老鼠浮空时间缩短0.5s，并且总共至多额外造成两次伤害)。连斩后摇0.8s，可用道具键取消。连斩造成两次伤害后会使老鼠受到[威慑效果](绑上火箭后消失)，被绑上火箭时，引线将额外减少10s。挑飞和连斩[在空中释放](不是跳放)将直接进入CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        forecast: 0,
  ...
  库博: {
    ...
    knowledgeCardGroups: [
        ...
        groups: [
          ...
          },
          {
            cards: [
              ...
              [
                CardGroupType.Or,
                [CardGroupType.And, 'A-穷追猛打', 'B-皮糙肉厚'],
                [CardGroupType.And, 'B-恐吓', 'B-皮糙肉厚'],
                [CardGroupType.And, 'A-穷追猛打', 'C-猫是液体', 'C-狡诈'],
              ],
            ],
            description:
              '卡组1：{穷追猛打}便于快速展开第一波节奏，{皮糙肉厚}用于提高自身的身板。卡组2为携带{恐吓}时的变种，拖老鼠奶酪进度来放飞天堂火箭上的老鼠。卡组3为携带{猫是液体}时的变种，适用于管道图。',
          },
        ],
        defaultFolded: false,
      },
      {
        id: '击晕',
        description: '以击晕为核心，{乘胜追击}提高机动性，以天堂火箭为主要淘汰手段。',
        groups: [
          {
            cards: [
              'S-击晕',
              ...
              [
                ...
                'S-知识渊博',
                [CardGroupType.And, 'A-穷追猛打', 'C-猫是液体'],
                [CardGroupType.And, 'A-穷追猛打', 'B-捕鼠夹'],
              ],
            ],
            description:
              '卡组1为目前较为通用的卡组，{知识渊博}能让库博更早进入强势期。卡组2为较老的卡组，前期更方便找节奏，适用于一些管道图。卡组3为携带{捕鼠夹}时的变种。在天堂口放夹老鼠几乎必踩，{捕鼠夹}能够增加老鼠挣脱的时间拖延换天堂火箭的节奏。',
          },
        ],
        defaultFolded: false,
      },
    ...
    knowledgeCardGroups: [
      {
        ...
        description:
          '携带{皮糙肉厚}的卡组为常规卡组，面对剑杰等高伤老鼠或管道不重要时使用。{加大火力}适用鼠方打架能力较弱和无管道图。{猫是液体}+{狡诈}适合打管道图或者打架能力不高的队伍。',
      },
      {
    ...
    knowledgeCardGroups: [
      {
        ...
        description:
          '可以作为入门卡组使用，穷追前期也有更多的压制力，屈打提供更多拦截能力。熟悉后可以选择性把穷追换成皮糙应对高伤阵容，也可以穷追换加大提高更多火箭收益。',
      },
      {
        cards: [
          'A-熊熊燃烧',
          ...
          'A-细心',
          'B-皮糙肉厚',
          [CardGroupType.Or, 'B-捕鼠夹', 'B-反侦察', 'C-猫是液体'],
        ],
        description:
          '面对支援能力快的队伍，屈打收益较低，可以换成其他卡。一般可带{捕鼠夹}，也可以选择性的换成反侦察，例如夹子比较少的地图。在牧场天宫等其他管道图使用{猫是液体}。',
      },
    ],
    specialSkills: [
      {
    ...
    knowledgeCardGroups: [
      ...
      },
      {
        cards: [
          ...
          'A-熊熊燃烧',
          'A-穷追猛打',
          [CardGroupType.Or, 'B-皮糙肉厚', [CardGroupType.And, 'C-猫是液体', 'C-狡诈']],
        ],
        description:
          '主流卡组，穷追猛打可以提供第一波节奏，皮糙肉厚可以提高前期容错。管道图则带{猫是液体}。',
      },
      {
        cards: ['S-乘胜追击', 'A-熊熊燃烧', 'A-心灵手巧', 'A-加大火力'],
        description:
          '主流卡组，心灵手巧可以使感电效果几乎持续到绑完火箭。可将最后两张其一换为《穷追猛打》，快速打开前期节奏；如遇打架队则可换为《皮糙肉厚》。',
      },
      {
        cards: [
          'S-乘胜追击',
  ...
  如玉: {
    ...
    knowledgeCardGroups: [
      ...
      {
        cards: ['S-暴怒', 'S-屈打成招', 'A-穷追猛打', 'A-加大火力'],
        description:
          '主打守火箭与墙缝期压制：{屈打成招}在手握老鼠或有老鼠在火箭上时提供其他老鼠视野，{加大火力}加速火箭燃烧，{暴怒}配合如玉被动在墙缝期提供高额攻击加成，{穷追猛打}提升前期追击与压制能力。',
      },
    ],
    specialSkills: [
  ...
  侦探汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '进入{猫虚弱}状态时，2秒后将自动起身，并获得“侦探汤姆虚弱状态”：持续5秒；{无敌}；可进行移动与跳跃；无法进行交互、捡起道具、使用爪刀、使用主动技能或特技。（本效果无需升级被动即会生效）\n\n侦探汤姆拥有“线索值”机制。本技能升级后，敌方进行部分行为时会掉落{线索}。\n“线索”：侦探汤姆靠近后自动拾取，并增加自身“线索值”；场上最多同时存在14个“线索”，超出上限后最先生成的“线索”消失。\n“线索值”仅可通过拾取“线索”增加，上限为50点；进入墙缝期后，自身当前“线索值”减少一半。\n达到不同“线索值”时，将获得额外能力：\n$达到10点$text-blue-700 dark:text-blue-300 font-bold#：获得技能“轮椅”，CD为6.5秒。释放后进入持续3秒的“轮椅状态”，期间移速增加35%，跳跃能力提高40%，并获得持续2秒的{隐身}；释放后每秒恢复10Hp，持续10秒。\n$达到20点$text-blue-700 dark:text-blue-300 font-bold#：健康值降低时，进入“侦探汤姆隐身”：{隐身}，持续4秒，使用道具或进行任意交互后显形。\n$达到30点$text-blue-700 dark:text-blue-300 font-bold#：“侦探汤姆隐身”不再会因为使用道具或进行任意交互而显形，隐身期间移速不会低于正常移速且爪刀CD缩短50%。\n$达到40点$text-blue-700 dark:text-blue-300 font-bold#：每15秒对自身施加“发现”状态，并对敌方施加“被发现”状态。“发现”：显示敌方在地图上的位置，无视部分[隐藏小地图效果](如侦探杰瑞Lv.2被动、机器鼠状态)，持续3秒，会被{降落伞}免疫。“被发现”：无实际效果，仅对鼠方提示。\n$达到50点$text-blue-700 dark:text-blue-300 font-bold#：侦探汤姆在同一局内第2次及以上绑上同一只敌方老鼠时，直接放飞该老鼠。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        skillLevels: [
          {
