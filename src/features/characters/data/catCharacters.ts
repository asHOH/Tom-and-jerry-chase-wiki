      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 18,
            detailedDescription:
              '垃圾桶持续时间提高至18秒；老鼠进入垃圾桶范围瞬间伤害提高至[15](为固定值伤害，伤害值不受任何增伤/减伤效果影响（仍会受伤害转移影响）)，且每秒受到[8伤害](为固定值伤害，伤害值不受任何增伤/减伤效果影响（仍会受伤害转移影响）)。垃圾桶会对Hp降至最低的老鼠造成1秒眩晕，每5秒触发一次。',
          },
          {
            level: 3,
  ...
  牛仔汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '对前方老鼠造成极低伤害和减速，能破坏[易碎道具](包括玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/番茄，以及纸盒、吊灯、牛仔杰瑞的仙人掌等)。连续命中敌方角色两次后获得1层[增益](上限5层)，永久增加移速和减少爪刀CD。老鼠被累计命中两次后，受到伤害和眩晕效果，眩晕期间可被直接抓取。使用技能时还能使场上的{斗牛}加速。。',
        detailedDescription:
