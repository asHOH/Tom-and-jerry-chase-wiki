...
export const catKnowledgeCards: Record<string, Card> = {
  ...
  减速警告: {
    ...
    rank: 'B',
    cost: 4,
    description: '猫咪的爪刀使老鼠**减速**，持续5秒。',
    detailedDescription: '猫咪的爪刀使老鼠短暂**减速**，老鼠解除受伤时将同时解除减速效果。',
    levels: [
  ...
  攻其不备: {
    ...
    rank: 'B',
    cost: 3,
    description: '当老鼠推奶酪时，猫咪获得**加速**，持续8秒。',
    detailedDescription: '当老鼠在推奶酪时，猫咪试图快速接近老鼠，获得**加速**，持续8秒。',
    levels: [
  ...
  都是朋友: {
    ...
    cost: 3,
    description:
      '猫咪不会再受到斯派克的攻击，且靠近斯派克时**略微**加速，持续10秒，每30秒至多触发1次。此外，免疫女主人的眩晕效果。',
    detailedDescription:
