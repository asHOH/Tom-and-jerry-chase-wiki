...
const mouseKnowledgeCardDefinitions: Record<string, Card> = {
    ...
    levels: [
      {
        level: 1,
        description: '额外**略微加速**。',
        detailedDescription: '额外使**移速提高5%、跳跃能力提高7%**。',
      },
      {
        level: 2,
        description: '再额外**提升Hp恢复速度**。',
        detailedDescription:
          '再额外使**恢复速度+2.5Hp/秒**（该效果与基础Hp恢复不同，不会因受伤而失效）。',
      },
      {
        level: 3,
        description: '再额外**获得2层护盾**。',
        detailedDescription:
          '再额外**获得2层护盾并回复25Hp**（该护盾持续时间无限，但会被碎片消耗）。',
      },
    ],
    priority: '3级质变',
  },
  ...
  铁血: {
    ...
    detailedDescription:
      '受到{鼠虚弱}时，立即清除自身持有的虚弱状态及其它[部分状态](会清除所有隶属于“分组7”的状态，该分组包含了大多数控制类状态)，随后获得**一段时间**的“铁血”状态，期间免疫鼠虚弱，但无法使用技能与道具、无法购物、免疫大部分{护盾}及{无敌(状态)}；“铁血”状态结束时，自身受到{999*}伤害并掉落手中道具。(CD: 60秒)',
    levels: [
  ...
  冲冠一怒: {
    ...
    cost: 4,
    description:
      '当队友被猫咪抓住时，自身{攻击力}提高15%，且附近没有敌方角色时额外提升**一定**移速和跳跃能力。',
    detailedDescription:
      '当队友被猫咪抓住时：自身{攻击力}提高15%；如果自身半径800范围内[没有敌方角色](不包括部分NPC类敌方角色)时，额外提升**一定**移速和跳跃能力（移速和跳跃能力加成将在敌方进入该范围后暂时失效）。',
    levels: [
      { level: 1, description: '移速和跳跃能力提升**18%**。' },
      { level: 2, description: '移速和跳跃能力提升**19%**。' },
      { level: 3, description: '移速和跳跃能力提升**20%**。' },
    ],
    priority: '几乎无提升',
  },
  ...
  闭门羹: {
    ...
    rank: 'A',
    cost: 4,
    description: '关闭{木门}后获得**短暂**加速，并弹开门附近的敌方。(CD: 5秒)',
    detailedDescription:
      '关闭{木门}后：自身移速提高50%、跳跃能力提高10%，持续较短时间；对靠近门的敌方造成1.5秒[眩晕](不掉落道具和老鼠)和小幅击退。(CD: 5秒)\n趣闻：以前的闭门羹是对所有玩家造成眩晕，包括自己。',
    levels: [
  ...
  孤军奋战: {
    ...
    rank: 'B',
    cost: 3,
    description: '如果自己附近没有其他可行动的老鼠，则被猫咪追击时，移速**提升**。',
    detailedDescription:
      '如果自身半径200范围内没有其他可行动的老鼠，且半径500范围内有猫咪（包括{隐身}或{间歇性隐身}期间的猫咪），则移速**提升**。',
    levels: [
  ...
  幸运: {
    ...
    cost: 5,
    description:
      '幸运的老鼠，上火箭后第1次挣扎必然可以从火箭上挣扎下来，且该次挣扎所需时间**缩短**，并在成功挣脱后获得1层护盾，持续2秒。（[每局只能触发1次](若在触发该效果后通过其它方式被救下火箭，则该效果保留并可再次触发)，墙缝期不可触发）',
    detailedDescription:
      '幸运的老鼠，上火箭后第1次挣扎必然出现“星星棒”挣脱（可以从火箭上挣扎下来），且该次挣扎所需时间**缩短**（[实际效果与游戏描述不同](游戏内描述为“使挣扎速度提升10/20/35%”，实际为挣扎所需时间缩短)），并在成功挣脱后获得1层护盾，持续2秒。（[每局只能触发1次](若在触发该效果后通过其它方式被救下火箭，则该效果保留并可再次触发)，墙缝期不可触发）\n（注：“星星棒”需要21次挣扎）',
    levels: [
      { level: 1, description: '首次挣扎所需时间缩短至原本的**92.9%**。' },
      { level: 2, description: '首次挣扎所需时间缩短至原本的**78.6%**。' },
      { level: 3, description: '首次挣扎所需时间缩短至原本的**64.3%**。' },
    ],
    priority: '提升明显',
  },
  ...
  相助: {
    ...
    detailedDescription:
      '守望相助的老鼠们，使自身及左右两侧各400范围内的所有友方的治疗、救援速度得到**提升**。（注：基础救援时长为1s，基础治疗时长为2.4s）',
    levels: [
