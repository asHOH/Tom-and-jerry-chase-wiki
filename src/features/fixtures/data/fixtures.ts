...
const FixtureDefinitions: Record<string, FixtureDefinition> = {
  ...
  抽屉: {
    ...
    detailedDescription:
      '抽屉初始为打开状态，角色可通过交互关闭/打开抽屉。抽屉被打开时会随机生成一个道具，且被打开期间其上方可被当做{平台}。抽屉每次被打开/关闭后5秒内无法再次被交互。抽屉有可能生成：{高尔夫球}、{冰（道具）}、{玻璃杯（道具）}、{碗（道具）}、{夹子（道具）}、{拍子}、{盘子}、{碟子}、{胡椒粉（道具）}、{香水瓶}、{灰色大花瓶}、{蓝白大花瓶}、{大鞭炮}、{小鞭炮}、{随机药水}，概率待测量',
  },
  玉璧: {
    type: ['组件类', '可交互'],
    source: '地图组件',
    ...
    supportedMaps: ['天宫'],
    description:
      '玉璧可被鼠方角色持续缓慢推动/被猫方角色一次性大力推动，可被{佩克斯}主动技能推动少量距离。玉璧在坠落时碰到敌方角色将对其造成伤害及眩晕，坠落至地面和部分平台时销毁。',
    specialImageUrl: '/images/maps/%E5%A4%A9%E5%AE%AB.png',
    collision: ['地面', '平台'],
    detailedDescription:
      '玉璧可被鼠方角色持续缓慢推动/被猫方角色一次性大力推动，可被{佩克斯}主动技能推动少量距离。玉璧在坠落时碰到敌方角色将对其造成伤害及眩晕，坠落至地面和部分平台时销毁。（并未测试坠落墙壁，实际上难以做到？如果有谁有兴趣和方法测量，请及时补充并删除本行）',
  },
  香炉: {
    type: ['平台类', '组件类'],
    source: '地图组件',
