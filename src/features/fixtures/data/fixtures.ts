...
const FixtureDefinitions: Record<string, FixtureDefinition> = {
  ...
  嫦娥: {
    ...
    detailedDescription:
      '嫦娥怀抱玉兔在广寒宫来回散步。\n当任意{鞭炮}在广寒宫房间内被引爆时，嫦娥将会生气，周身在1分20秒内被寒气环绕，对范围内的所有角色持续地施加“深寒”状态，该状态下移速降低且会熄灭鞭炮，可叠加，叠加至第5层时清除并造成伤害和冰冻控制（与{冰块}状态完全相同）。\n当嫦娥接触到{萝卜墩-天宫}时，她怀中的玉兔将会开始进食，6秒后为周围所有角色提供[增益状态](防御、恢复、加速、攻击力上升中的一种，其中前两种增益持续1分30秒，后两种增益持续30秒)，并平息嫦娥的怒火。\n当{鼠角色}与{舰艇火炮}交互并发射时若碰到嫦娥，则会撞到嫦娥并被弹开。\n当{罗宾汉泰菲}使用{弹力圆球}弹射时若碰到嫦娥，则会撞到嫦娥并被弹开。\n当{塔拉}使用{牛仔鞭索}扔出手中老鼠时若该老鼠碰到嫦娥，则该老鼠会被嫦娥挡住并下落。',
    specialImageUrl: '/images/maps/%E5%A4%A9%E5%AE%AB.png',
  },
  吴刚: {
    type: ['NPC', '平台类'],
