...
export default function ArticleDiffViewer({
  ...
  return (
    <div className='space-y-8'>
      ...
      <Card className='overflow-hidden border border-slate-200 p-0 shadow-sm ring-1 ring-slate-900/5 dark:border-slate-700 dark:bg-slate-900 dark:ring-white/5'>
      ...
      <section aria-labelledby='newer-version-content'>
        ...
        <Card className='border border-slate-200 p-6 shadow-sm md:p-8 dark:border-slate-700'>
