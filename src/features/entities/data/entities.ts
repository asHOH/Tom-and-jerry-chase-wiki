...
export const entityDefinitions = {
  ...
  轨道: {
    ...
    gravity: false,
    description:
      '轨道开始生成的短暂延迟后，出现{列车}沿轨道冲撞，对被撞击的敌人施加伤害，眩晕和击退效果。\n轨道会以恶魔汤姆技能释放的位置为中点，向恶魔汤姆面朝方向伸展，角度在一定范围内随机（通常趋于水平）。',
    create: '由恶魔汤姆-迷乱列车召唤。',
  },
  列车: {
  ...
  蓄力箭: {
    ...
    gravity: true,
    description:
      '命中友方为其回复更多Hp并提高移速，命中敌方造成更高伤害和眩晕（有内置CD）。\n任意弓箭命中目标后，为目标添加“爱神标记”状态，持续一段时间。当场上存在两个“爱神标记”时，标记解除并根据阵营触发效果：\n均为友方：每个标记为目标提供1层{护盾}。\n均为敌方：额外造成高额伤害和眩晕。\n一敌一友：双方获得“爱神羁绊”状态，对彼此造成的{伤害}改为等额{回复}。',
    detailedDescription:
      '命中友方为其回复50/50/99Hp和1.6秒的5%加速；命中敌方造成[55/55/105](基础伤害50/50/100+天使杰瑞攻击增伤5，同时也能受到其他来源的攻击增伤加成)伤害和1.4秒眩晕（有内置CD）（无视苏蕊的跳舞，但不打断跳舞或队友的跟随；无视天使汤姆二级被动的霸体，且可救下队友）。弓箭受到重力，但速度大小不变，只改变方向（不受外力时，箭的竖直速度逐渐增大而水平速度逐渐减小，并非严格的抛物线）。弓箭可被鞭炮影响而改变飞行轨迹。\n任意弓箭命中目标后，为目标添加“爱神标记”状态，持续一段时间。当场上存在两个“爱神标记”时，标记解除并根据阵营触发效果：\n均为友方：每个标记为目标提供1层{护盾}。\n均为敌方：额外造成高额伤害和眩晕。\n一敌一友：双方获得“爱神羁绊”状态，对彼此造成的{伤害}改为等额{回复}。',
