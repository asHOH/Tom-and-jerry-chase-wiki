...
export const entityDefinitions = {
  ...
  火箭炮: {
    ...
    detailedDescription:
      '直接命中敌方时造成50伤害，可触发投掷类知识卡和特技：{缴械}、{投手}、{追风}、{精准投射}、{干扰投掷}、{勇气投掷}；直接命中墙缝时[随机造成4.5~9伤害](泰菲自身破坏增伤0.5+火箭炮基础伤害4~8.5，具体伤害量随机，同一位置出现的伤害也会有不同，具体成因不详)；命中敌方角色/墙壁/平台/其他道具后爆炸，再对一定范围内敌方造成15/30/30伤害和1.5/2.1/2.1秒爆炸眩晕，对一定范围内墙缝[随机造成3.5~9伤害](泰菲自身破坏增伤0.5+爆炸冲击波基础伤害3~8.5，具体伤害量随机，同一位置出现的伤害也会有不同，具体成因不详)。先结算直接命中伤害，后结算爆炸伤害。爆炸产生的冲击波可以炸飞老鼠夹、叉子等道具。火箭炮造成的伤害可受攻击增伤影响。',
    create: '由泰菲-火箭筒技能射出。',
  },
  感应雷: {
