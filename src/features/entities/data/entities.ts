...
export const entityDefinitions = {
  ...
  旋转桶盖: {
    ...
    detailedDescription:
      '对命中的敌方造成[55](基础伤害30+布奇攻击增伤25，同时也能受到其他来源的攻击增伤加成)伤害并眩晕1.5秒；友方再次碰到桶盖时将其拾取，使自身受到的伤害降低20，持续6秒。桶盖被投掷时的初速度较快，会被道具和墙壁反弹。Lv.2及以上时，命中敌方减少旋转桶盖技能6秒CD（每次施放只生效1次）。Lv.3时，桶盖飞行速度增加；捡到桶盖会获得[霸体](免疫虚弱和绝大多数控制效果)。',
    create: '由布奇-旋转桶盖召唤。',
  },
  板凳猫: {
    entitytag: ['变形', '彩蛋'],
  ...
  垃圾桶: {
    ...
    detailedDescription:
      '阻挡道路，可被推动且被猫推动时的力度更大，可被爪刀打飞，受到4次攻击后会摧毁。垃圾桶的异味会使老鼠在进入范围时受到[10/15/25伤害](为固定值伤害，伤害值不受任何增伤/减伤效果影响（仍会受伤害转移影响）)，未离开范围还会受到减速且每秒受到[5/8/12伤害](为固定值伤害，伤害值不受任何增伤/减伤效果影响（仍会受伤害转移影响）)。每造成1次伤害会降低0.6秒爪刀CD，每秒只生效一次。垃圾桶造成的伤害不会使老鼠虚弱，但仍会持续减少爪刀CD。垃圾桶不会对已虚弱的老鼠造成伤害，也不会因此降低爪刀CD，在垃圾桶范围内倒地并起身的老鼠不会受到垃圾桶的伤害，但重新进入垃圾桶范围仍会受到伤害。Lv.2及以上时，垃圾桶会对Hp降至最低的老鼠造成1秒眩晕，每5秒触发一次。',
    create: '由莱特宁-垃圾桶召唤。',
  },
  咸鱼: {
    entitytag: '触发',
