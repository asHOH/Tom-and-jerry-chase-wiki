...
export const entityDefinitions = {
  ...
  爆炸仙人球: {
    ...
    gravity: false,
    description:
      '被召唤时向指定位置直线飞行，到达位置后停止移动，若较小范围内存在其它未连线的爆炸仙人球，则与其进行连线并重置双方的存在时间，自身存在一定时间后或自身所在的连线被碰触时消失。敌方男性角色碰触连线时，使其被点燃并受到{持续伤害}（每30秒只能被点燃1次），期间{暴露位置}；塔拉碰触连线时，使其{攻击增伤}提高一段时间。',
  ...
  闪电仙人球: {
    ...
    gravity: false,
    description:
      '被召唤时向指定位置直线飞行，到达位置后停止移动，若中等范围内存在其它未连线的闪电仙人球，则与其进行连线并重置双方的存在时间，自身存在一定时间后消失。敌方男性角色碰触连线时，对其造成一定[固定{伤害}](即“不受增减伤影响”类型的伤害，详见状态效果相关界面)，使其{减速}且救援速度降低一段时间；塔拉碰触连线时，使其主动技能CD缩短至10/5/5秒，并{更改爪刀CD}为2秒(未命中)/2.5秒(命中)，获得该状态时不会影响已处于CD中的主动技能/爪刀的当次CD，已有加速期间触碰闪电仙人球连线不重置持续时间。',
    create: '由塔拉-牛仔的礼物选择位置发射。',
  },
  弹簧仙人球: {
    ...
    gravity: false,
    description:
      '被召唤时向指定位置直线飞行，到达位置后停止移动，若较大范围内存在其它未连线的弹簧仙人球，则与其进行连线并重置双方的存在时间，自身存在较长时间后消失。敌方男性角色碰触连线时，将其{牵引}向连线中点，到达目标位置或碰触部分平台后进入短暂{眩晕}，该过程期间{完全失重}。',
    create: '由塔拉-牛仔的礼物选择位置发射。',
  },
  天空扶梯: {
    entitytag: ['功能', '交互', '复用'],
