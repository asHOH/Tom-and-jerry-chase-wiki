    ...
    skills: [
      {
        ...
        detailedDescription:
          '提高视野范围至原先的3.7倍，并警戒房间内[所有老鼠](距离极远的除外)，持续25秒。被警戒到的老鼠推速下降50%，暴露小地图视野，并清除[部分增益](所有药水；侦探杰瑞、侦探泰菲的隐身；大部分护盾效果，如知识卡、角色技能的护盾（罗菲2被与恶魔传送门的盾不会被消除）；部分无敌效果，如无畏、舍己、国王护盾、莉莉二被；米雪儿小情绪的变大；仙女鼠星星与二被的隐身；红花；太空药水仓的跳跃提升、变大和隐身；熊猫谷药水仓的兴奋；天宫香炉的远视)。若警戒到老鼠，额外获得20%加速；若未警戒到，则返还15秒CD。使用降落伞中的罗宾汉不会被警戒到。',
        canMoveWhileUsing: false,
        canUseInAir: false,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '掏出{胡椒粉罐头}，自身持续受到轻微伤害，并因此获得“刺激”状态，移速和跳跃高度提高20%。再次使用技能将投掷胡椒粉、直接命中会造成30伤害，命中或落地后破碎并形成胡椒粉烟雾，持续20秒，[每秒对范围内角色造成5伤害](不会破米特的护盾)、在停止接触后会残留约3秒。米特在烟雾中也会获得“刺激”状态。胡椒粉在掏出后立刻进入CD；技能冷却完成后，若未投掷出胡椒粉，可双击技能，胡椒粉会原地向下扔。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableAftercast: '无后摇',
        cancelableSkill: ['跳跃键'],
  ...
  如玉: {
    ...
    counterEachOther: [
      ...
      },
      {
        id: '玛丽',
        description:
          '玛丽的主动技能无法封锁如玉的爪刀，折扇会触发如玉的花枪反击；但如玉较怕鼠方的拉扯破局，而玛丽折扇能救起队友或快速推入奶酪，有助于拉扯破局；玛丽后期的禁用技能效果也克制如玉的反击。',
        isMinor: true,
      },
      {
        id: '尼宝',
