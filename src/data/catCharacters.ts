  ...
  牛仔汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '对前方老鼠造成1点伤害和减速，能破坏[易碎道具](包括玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/冰块，以及牛仔杰瑞的仙人掌/吊灯等)。连续命中敌方角色两次后获得1层[增益](上限5层)，永久增加移速和减少爪刀CD。老鼠被累计命中两次后，受到伤害和眩晕效果，眩晕期间可被直接抓取。',
        detailedDescription:
  ...
  如玉: {
    ...
    counters: [
      ...
      },
      {
        id: '国王杰瑞',
        description:
          '国王杰瑞开盾救援队友时能被回马枪戳飞，如果同时被前刺回马枪命中甚至可能直接虚弱。',
        isMinor: true,
      },
      {
        id: '剑客泰菲',
        description:
          '剑客泰菲开启头盔救援队友时能被回马枪戳飞，他的长枪和冲刺可以触发如玉的“花枪反击”。但剑菲勇气释放期间的长枪有禁用技能效果，能反制如玉的反击。',
        isMinor: true,
      },
      {
        id: '尼宝',
        description: '尼宝救援队友时能被回马枪戳飞。但如玉也难以处理尼宝的鱼钩救援。',
        isMinor: true,
      },
      {
        id: '玛丽',
