    ...
    skills: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '爪刀有一定概率造成极高额外伤害；技能和道具造成的控制时间小幅度增加。',
            detailedDescription:
              '爪刀有30%概率[造成200额外伤害](与原伤害分为不同的两段，若原伤害命中在敌方护盾上时则不造成额外伤害)；技能和道具造成的控制时间增加1秒。',
          },
        ],
      },
    ],
  ...
  莱特宁: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '从垃圾桶中倒出咸鱼并标记在小地图上，咸鱼持续一分钟，鼠方踩到后会受咸鱼影响，持续20秒，期间推速降低40%，救援、治疗速度降低33%，移速降低10%，跳跃高度降低（未测），同时暴露小地图位置。可通过吃{蛋糕}、喝{牛奶}、喝饮料、{应急治疗}、{牛仔吉他}Lv.2来解除。爪刀命中[带有咸鱼效果的敌方](包括虚弱老鼠)时，将重置瞬移闪击CD，爪刀CD减少至1.9秒，并获得50Hp/秒的恢复效果，持续1秒。瞬移闪击将优先追踪带有咸鱼效果的敌方，并大幅提高追踪范围；手中有老鼠时，则优先追踪最近的咸鱼。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '释放一个飞吻，飞吻将锁定并追踪附近的老鼠，持续一段时间后消失，也可被护盾、无敌、虚弱抵消，被[部分地形](包括门、厚墙壁、地面等)阻挡。命中老鼠后，其移动、跳跃、搬动奶酪等行为期间会受到持续伤害；受到其他[伤害或部分控制效果](包括爪刀攻击（指甲油外刀除外）、碎片的僵直、夹子、虚弱、部分变身效果（包括变身饮料效果）等，不包括香水反向、烟雾失明、场景物-轮胎造成的击退等)才能解除被吻效果。',
        detailedDescription:
          '释放一个飞吻，飞吻将锁定并全图追踪半径1200范围内的老鼠，锁定后将追踪且不会更换目标，若追踪途中命中其他老鼠将由其他老鼠承担吻效果；飞吻最多存在18秒，超过18秒将自动消失；飞吻可被护盾、无敌、虚弱抵消，也可被[部分地形](包括门、厚墙壁、地面等)阻挡。飞吻命中老鼠后，其移动、跳跃、搬动奶酪等行为期间会受到持续伤害，通常只有受到其他[伤害或部分控制效果](包括爪刀攻击（指甲油外刀除外）、碎片的僵直、夹子、虚弱、部分变身效果（包括变身饮料效果）等，不包括香水反向、烟雾失明、场景物-轮胎造成的击退等)才能解除被吻效果（{牛仔杰瑞}-{牛仔吉他}Lv.2也可以直接解除）。',
        canMoveWhileUsing: true,
        canUseInAir: true,
      ...
      },
      {
        ...
        detailedDescription:
          '喷洒香水，获得[香水释放状态](贴图：图多盖洛周身围绕一圈香水雾气，该雾气隐身期间也能被敌方看到)，期间每隔一段时间在自身途径区域释放香水区域，爪刀和投掷道具命中敌方时在敌方位置生成香水区域，香水释放状态持续一段时间。图多盖洛在香水内获得增益，敌方在香水内的属性下降。香水区域重叠时持续时间会少量减少。香水区域可被部分受力效果影响而弹飞，沿指定方向飞出地图外。\n可影响香水区域的效果：{小鞭炮}或{鞭炮束}爆炸；{航海士杰瑞}-{火药桶}或{泰菲}-{火箭筒}的爆炸；{佩克斯}-{魔音贯耳}的弹飞道具效果；{马索尔}-{闪亮营救}传送落地触发的弹飞道具效果；{蒙金奇}-{勇往直前}的撞飞道具效果；{霜月}-{滑步踢}的踢飞道具效果。另外{侦探杰瑞}-{视觉干扰器}可以短暂免疫香水效果。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['道具键'],
        cancelableAftercast: '无后摇',
  ...
  侍卫汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        forecast: 0.684,
        description:
          '原地召唤{皇家火炮(衍生物)}，对附近老鼠造成短暂眩晕和少量伤害，侍卫汤姆获得短暂的两层护盾。火炮存在期间，可以拖动技能键远程操纵火炮发射，命中时对老鼠造成眩晕和伤害，同时侍卫汤姆获得大幅加速和护盾。火炮可射击数次，有内置CD。',
        detailedDescription:
          '原地召唤{皇家火炮(衍生物)}，对附近老鼠造成0.93秒眩晕及10点伤害，侍卫汤姆获得两层护盾，持续1.95秒。火炮存在期间，侍卫汤姆可以自由活动，拖动技能键远程操纵火炮发射，命中时对老鼠造成0.56秒眩晕和[50伤害](不受攻击增伤加成)、移除其[部分增益](隐身、兴奋、远视；天宫图香炉的远视；除了尼宝三级翻滚和魔术师三级卡牌以外的技能与被动隐身)；同时侍卫汤姆加速49%并获得两层护盾，效果持续2.96秒。火炮可射击数次，每次射击之间有最短间隔。',
        skillLevels: [
          {
            level: 1,
            description: '火炮能射击三次。',
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '按住技能键持续地喵喵叫，期间可以移动，也可以使用爪刀和《绝地反击(特技)》；松开技能键可提前取消技能；喵喵叫期间对附近的老鼠持续施加[喵喵叫减速](喵喵叫减速与防狼锤减速的层数互通，但具体数值有差异)，叠加到第五层时造成伤害和眩晕，并清空减速层数。被打断或提前取消技能会按比例返还CD。',
        detailedDescription:
          '按住技能键，在前摇后持续地喵喵叫，期间可以通过按住方向键不松开的方式移动，也可以正常使用爪刀和《绝地反击(特技)》，松开技能键可提前取消技能；喵喵叫期间对周围半径1000范围内的老鼠持续施加[喵喵叫减速](喵喵叫减速与防狼锤减速的层数互通，但具体数值有差异)，每层[喵喵叫减速](喵喵叫减速与防狼锤减速的层数互通，但具体数值有差异)将使老鼠移速和跳跃速度降低8%，并暴露小地图视野；[喵喵叫减速](喵喵叫减速与防狼锤减速的层数互通，但具体数值有差异)叠加到第五层时对其造成{60}伤害并眩晕2秒，然后清空减速层数。被打断或提前取消技能会按比例返还CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        canHitInPipe: true,
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        detailedDescription:
          '挥动防狼锤，对前方300范围内的老鼠造成5伤害和一层[防狼锤减速](防狼锤减速与喵喵叫减速的层数互通，但具体数值有差异)；每层[防狼锤减速](防狼锤减速与喵喵叫减速的层数互通，但具体数值有差异)将使老鼠移速和跳跃速度降低30%（最多降低90%），并暴露小地图视野；[防狼锤减速](防狼锤减速与喵喵叫减速的层数互通，但具体数值有差异)叠加到第五层时对其造成{60}伤害并眩晕2秒，然后清空减速层数。使该技能时，会因惯性而向前移动一小段距离，且自身也会受到10伤害。Hp低于10时不能使用本技能。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键'],
        cancelableAftercast: ['道具键'],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '增加饭盒伤害。爆炸后留下食物，米特触碰后会获得持续Hp恢复效果。大幅提高放置老鼠夹的效率。', // （连招：击晕接捕鼠夹）
            cooldown: 20,
          },
          {
            level: 3,
  ...
  塔拉: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '拖动技能选择面前135度范围内的一个方向，松开时甩出套索，若套中老鼠，对老鼠造成伤害和减速；再次点击按钮使塔拉位移向该老鼠位置。当塔拉手中抓有老鼠时，本技能改为可向任意方向扔出老鼠，老鼠碰到火箭将直接绑上，但[不减少引线时间](Lv.2被动和知识卡仍能触发)；飞行过程中的老鼠在碰到平台，墙壁，拳头盒子，火箭后停止飞行，然后获得短暂无敌和加速。',
        detailedDescription:
          '拖动技能选择面前135度范围内的一个方向，松开技能键时在前摇0.5秒后甩出套索，套索存在时间0.75秒，存在时间内最大飞行距离为1750，对套中的老鼠造成{30}伤害并减速20%；在使用技能后进入2.9秒技能读条（若未套中老鼠则提前结束读条），套中老鼠后可再次点击技能，塔拉将[以1850的速度位移向该老鼠位置](位移期间获得无法选中效果，位移时间最多4.9秒，超过时间将会被直接传送至老鼠旁边)。当塔拉用技能位移到老鼠旁边时或套中老鼠4.9秒后，解除[套索效果](包括老鼠受到的减速效果，以及塔拉与老鼠之间连接的套绳贴图效果)。当塔拉手中抓有老鼠时，本技能改为可向任意方向以2000速度扔出老鼠，期间老鼠无敌，碰到火箭将直接绑上，但[不减少引线时间](Lv.2被动和知识卡仍能触发)；飞行过程中的老鼠在碰到平台，墙壁，拳头盒子，火箭后停止飞行，获得无敌效果并加速20%，持续2.9秒;飞行过程中[受力不停止飞行](包括鞭炮爆炸，电风扇吹风，轮胎击飞等效果。虽然不停止飞行，但仍会受力并可能改变方向)。套索的捆绑效果不会被无敌，护盾，霸体、[机器鼠](不会破坏机器鼠)等效果抵消或免疫，但造成的伤害、减速、眩晕会被抵消或免疫。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        aliases: ['天梯'],
        description:
          '使用时获得加速和间歇性隐身，但靠近老鼠时，对方头顶会有感叹号提示；再次使用进入天堂并留下{天空扶梯}（最多存在2个）。库博在天堂中持有强霸体，可在天堂内的{天空扶梯}获知所有老鼠的位置，并任意选择房间传送；老鼠则可通过其传送到随机洞口。天堂内有2个天堂火箭，能绑上老鼠的虚影，[拥有强制放飞机制](300秒倒计时，结束时直接淘汰对应老鼠)。虚影被救援时，改为绑上救援者的虚影，救援所需时间较长，救援位置较普通火箭[偏下](如果火箭下有捕鼠夹，会导致踩夹)。已被绑上天堂火箭的老鼠无法进行天堂火箭救援。在对应老鼠被绑上地面火箭或进入墙缝期后，倒计时速度会加快。',
        detailedDescription:
  ...
  斯飞: {
    ...
    skills: [
      ...
      },
      {
        name: '猎',
        type: 'weapon1',
        description: '扔出项坠，随后斯飞向项坠飞去，对碰到的老鼠造成伤害和短暂眩晕。',
        detailedDescription:
          '扔出项坠，0.75秒后或项坠碰撞到地面/墙壁后，斯飞以2000的速度向项坠飞去，飞行期间对碰到的老鼠造成50点普通伤害、10点[电击伤害](电击伤害会使目标感电，每层感电使受到的电击伤害增加15，可叠加)和0.6秒眩晕。释放瞬间如果角色方向改变，将同时改变项坠方向。技能可以穿门。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
  ...
  恶魔汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '召唤列车冲撞。列车冲撞前需要2.1秒生成[轨道](轨道必然途径技能释放的位置，以该位置为中点，但轨道方向随机)，随后进行1.8秒的冲撞，对被撞击的敌人施加50伤害，并造成眩晕和击退效果。冲撞完成后重新生成下一段列车，重复数次。被冲撞过的老鼠短时间内获得冲撞免疫效果（免疫列车冲撞带来的伤害和控制，但被撞击仍会造成小幅度位移）。\n注：列车前摇释放完毕后进入技能冷却，列车冲撞结束后，技能剩余CD为技能真空期。1级真空期约10秒，2级真空期约2秒，3级真空期约6秒。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键', '道具键'],
        cancelableAftercast: '无后摇',
