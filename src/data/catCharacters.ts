  ...
  恶魔汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '召唤列车冲撞。列车冲撞前需要2.1秒生成[轨道](轨道以技能释放的位置为中点生成，但方向随机)，随后进行1.8秒的冲撞，对被撞击的敌人施加50伤害，并造成眩晕和击退效果。冲撞完成后重新生成下一段列车，重复数次。被冲撞过的老鼠短时间内获得冲撞免疫效果（免疫列车冲撞带来的伤害和控制，但被撞击仍会造成小幅度位移）。\n注：列车前摇释放完毕后进入技能冷却，列车冲撞结束后，技能剩余CD为技能真空期。1级真空期约10秒，2级真空期约2秒，3级真空期约6秒。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键', '道具键'],
        cancelableAftercast: '无后摇',
  ...
  追风汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '未处于飞行状态时，向前释放{飓风}，对敌方造成少量伤害和击退。击退期间对触碰到的[所有单位](包括追风汤姆)造成少量伤害，对敌方额外造成眩晕效果。\n处于飞行状态时，向正下方扔出{铁砧}，砸中敌方造成少量伤害和短暂眩晕。\n当手中有老鼠时，会优先扔出老鼠并自动绑上碰到的火箭，但会被其他敌方单位阻挡。',
        detailedDescription:
