  ...
  图茨: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '前摇0.5s，向任意方向扔出汽水罐，飞行速度1500。若未命中，飞行1.2s后开始旋转，盘旋路线半径250，飞行速度1000，持续20s。喵喵叫范围内盘旋的汽水罐运动速度每秒提升50，半径每秒增加200，喵喵叫结束后速度和半径将逐渐恢复正常。命中时，对小范围所有老鼠造成15伤害、[两层喵喵叫减速](无法被护盾、霸体、无敌抵挡；火箭上的老鼠也会受影响)和3s冰冻。两个汽水罐相撞时将产生更大范围的冰爆，对半径350范围内所有老鼠造成造成30伤害、[四层喵喵叫减速](无法被护盾、霸体、无敌抵挡；火箭上的老鼠也会受影响)和3s冰冻。由于汽水罐而被施加[大于五层减速](如已有4层减速时被汽水罐命中，将达到6层减速)的老鼠，每多出一层都将额外受到一次60点伤害(5层为正常的60伤害，6层总共120伤害，以此类推)。', // FIXME: 命中老鼠的爆炸范围
        canMoveWhileUsing: true,
        canUseInAir: true,
