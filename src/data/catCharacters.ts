    ...
    counteredByKnowledgeCards: [
      {
        id: '不屈',
        description:
          '不屈增加的额外血量和移速增大了追汤打倒老鼠的难度，增加的推速使老鼠发育更快从而更易来到后期。',
        isMinor: false,
      },
      {
        id: '祝愿',
