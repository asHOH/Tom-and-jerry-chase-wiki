  ...
  如玉: {
    ...
    catPositioningTags: [
      ...
      },
      {
        ...
        isMinor: true,
        description:
          '特殊爪刀CD极短，命中敌方有高额加速效果，自身的“花枪反击”也能让敌方投掷道具时有所忌惮。',
        additionalDescription: '',
      },
    ],
    skillAllocations: [
      {
        ...
        pattern: '120002[12]1',
        weaponType: 'weapon1',
        description: '被动提供免疫眩晕和延迟虚弱，是如玉的核心技能。',
      },
    ],
    knowledgeCardGroups: [
      {
        cards: ['S-屈打成招', 'A-熊熊燃烧', 'A-穷追猛打', 'A-心灵手巧'],
        description:
          '常规卡组。如玉擅长追击和打架，能给老鼠很强的压迫感，屈打成招让如玉主动找节奏的能力大幅提高，还能预防老鼠的偷袭。',
      },
      {
        cards: ['S-知识渊博', 'A-熊熊燃烧', 'A-穷追猛打', 'A-越挫越勇'],
        description:
          '打架卡组1。知识渊博能让如玉快速升级，利用被动提供的免控免死与老鼠打群架。如玉的被动让她很容易将越挫越勇叠起来，提供可观的移速和打架能力。',
      },
      {
        cards: ['S-暴怒', 'A-熊熊燃烧', 'A-穷追猛打', 'A-加大火力'],
        description:
          '打架卡组2。如玉的被动使她无需虚弱即可享受暴怒效果，但通常只有爪刀能享受其攻击力加成。',
      },
      {
        cards: ['A-熊熊燃烧', 'A-穷追猛打', 'A-细心', 'A-心灵手巧', 'C-猫是液体'],
        description: '十分灵活的卡组。细心、心灵手巧和猫是液体为如玉提供了较高的机动性。',
      },
    ],
    specialSkills: [
      {
    ...
    skills: [
      {
        ...
        aliases: [],
        description:
          '舞起花枪，持续5秒，期间可移动跳跃但无法交互，每隔一段时间对碰触的老鼠造成伤害和可叠加的减速，最高叠加4层。技能期间受到来自老鼠的伤害时，可在1.6秒内点按["花枪反击"键](出现在屏幕右下方略靠近屏幕中间的区域，位置和大小可以调整)对其触发“花枪反击”。技能开启1秒内受击会立刻自动反击。\n\n“花枪反击”：立刻解除控制，结束技能并减少主动技能4秒CD，并对前方大范围进行一次扫击，造成伤害和[眩晕](该眩晕期间保持惯性)；若目标距离较远，则会传送到对方身后扫击。若老鼠因该次伤害虚弱，且扫击方向上有火箭，则会将其击飞到火箭上。',
        detailedDescription:
          '舞起花枪，持续5秒，期间可移动跳跃但无法交互，每隔一段时间对碰触的老鼠造成8伤害和可叠加的减速，最高叠加4层。技能期间[受到来自老鼠的伤害](且伤害来源不处于被绑上火箭或被放飞等状态)时，可在1.6秒内点按["花枪反击"键](出现在屏幕右下方略靠近屏幕中间的区域，位置和大小可以调整)对其触发“花枪反击”。技能开启1秒内受击会立刻自动反击。\n\n“花枪反击”：立刻解除控制，结束技能并减少主动技能4秒CD，[若目标距离较近](处于以如玉模型中心为圆心，半径约500的圆内)，则直接对前方[大范围](长约600，高度约与自身平齐)内进行一次[前摇0.3秒，后摇0.6秒](前后摇无法主动取消，且动作期间无法转向、移动、跳跃)的扫击，对所有命中的目标造成{65}伤害和1.9秒[眩晕](该眩晕期间保持惯性)；[若目标距离较远](不处于以如玉模型中心为圆心，半径约500的圆内)，则会[传送到对方头顶并在0.3秒后落下](释放技能时立刻传送到目标头顶高约250的位置并失重，0.3秒后落下。前后摇无法主动取消，动作期间无法转向、移动、跳跃)，然后对前方[大范围](长约600，高度约与自身平齐)内进行一次[前摇0.4秒，后摇0.55秒](前后摇无法主动取消，且动作期间无法移动跳跃)的扫击，对所有命中的目标造成{65}伤害和1.9秒[眩晕](该眩晕期间保持惯性)。若任意老鼠因扫击伤害虚弱，且[扫击方向上有火箭](以老鼠为圆心，半径约800的半圆内有空置火箭，且中间无平台阻挡)，则会[将其击飞到火箭上](将其向火箭方向上直线击飞，击飞期间失重，碰到火箭时自动绑上并点燃，正常触发绑火箭的-10秒引线效果及相关知识卡)。\n\n（技能仍在共研服测试中，数值可能有所调整）',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cooldownTiming: '前摇前',
        skillLevels: [
          {
            level: 1,
            description: '每0.8秒造成一次伤害。',
            cooldown: 12,
            detailedDescription: '技能释放时立刻造成一次伤害，随后每0.8秒造成一次伤害，共7次。',
          },
          {
            level: 2,
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '向任意指定方向掷出旋转的花枪，对碰到的老鼠造成少量伤害。花枪飞行一段时间后或再次点击技能时折返回如玉身边，[折返时也会造成伤害](老鼠进入花枪范围至离开前只会受到一次伤害，因此折返开始时恰好处于花枪范围内的老鼠不会受到二次伤害)，若折返时[命中被花枪命中过的非虚弱目标](指花枪折返前命中过的目标，包括初次命中时处于虚弱状态的目标)，可在1.6秒内点按["花枪反击"键](出现在屏幕右下方略靠近屏幕中间的区域，位置和大小可以调整)对其触发“花枪反击”。\n\n“花枪反击”：立刻解除控制，减少主动技能4秒CD，并对前方大范围进行一次扫击，造成伤害和[眩晕](该眩晕期间保持惯性)；若目标距离较远，则会传送到对方身后扫击。若老鼠因该次伤害虚弱，且扫击方向上有火箭，则会将其击飞到火箭上。',
        detailedDescription:
          '[向任意指定方向掷出旋转的花枪](花枪沿直线飞行，飞行速度约1900)，对[碰到](碰撞面积为圆形，半径约150)的老鼠造成5伤害。花枪飞行1.1秒后或在1秒内再次技能时[折返回如玉身边](改为向如玉方向飞行，碰到如玉或累计飞行8.1秒后消失)，[折返时也会造成5伤害](老鼠进入花枪范围至离开前只会受到一次伤害，因此折返开始时恰好处于花枪范围内的老鼠不会受到二次伤害)，若折返时[命中被花枪命中过的非虚弱目标](指花枪折返前命中过的目标，包括初次命中时处于虚弱状态的目标)，可在1.6秒内点按["花枪反击"键](出现在屏幕右下方略靠近屏幕中间的区域，位置和大小可以调整)对其触发“花枪反击”。\n\n“花枪反击”：立刻解除控制，结束技能并减少主动技能4秒CD，[若目标距离较近](处于以如玉模型中心为圆心，半径约500的圆内)，则直接对前方[大范围](长约600，高度约与自身平齐)内进行一次[前摇0.3秒，后摇0.6秒](前后摇无法主动取消，且动作期间无法转向、移动、跳跃)的扫击，对所有命中的目标造成{65}伤害和1.9秒[眩晕](该眩晕期间保持惯性)；[若目标距离较远](不处于以如玉模型中心为圆心，半径约500的圆内)，则会[传送到对方头顶并在0.3秒后落下](释放技能时立刻传送到目标头顶高约250的位置并失重，0.3秒后落下。前后摇无法主动取消，动作期间无法转向、移动、跳跃)，然后对前方[大范围](长约600，高度约与自身平齐)内进行一次[前摇0.4秒，后摇0.55秒](前后摇无法主动取消，且动作期间无法移动跳跃)的扫击，对所有命中的目标造成{65}伤害和1.9秒[眩晕](该眩晕期间保持惯性)。若任意老鼠因扫击伤害虚弱，且[扫击方向上有火箭](以老鼠为圆心，半径约800的半圆内有空置火箭，且中间无平台阻挡)，则会[将其击飞到火箭上](将其向火箭方向上直线击飞，击飞期间失重，碰到火箭时自动绑上并点燃，正常触发绑火箭的-10秒引线效果及相关知识卡)。\n\n（技能仍在共研服测试中，数值可能有所调整）',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键'],
        cancelableAftercast: ['道具键'],
        ...
        skillLevels: [
          {
            level: 1,
            description:
              '[因其他原因虚弱时](即不因本技能提供的“坚毅”导致虚弱时)改为进入“坚毅”状态：立即解除控制并回复Hp、且移速提高、免疫眩晕和虚弱，期间成功对任意敌方造成虚弱则提前解除该状态。“坚毅”状态正常结束时，如玉进入虚弱。',
            detailedDescription:
              '[因其他原因虚弱时](即不因本技能提供的“坚毅”导致虚弱时)[改为进入12秒“坚毅”状态](仍会触发以虚弱为判定条件的效果，如鼠方的击倒敌方获得金钱效果及终结赏金，和知识卡-越挫越勇，暴怒，乘胜追击（失去层数）等)：立即解除控制并回复100Hp、且移速提高15%、免疫眩晕和虚弱，期间成功对任意敌方造成虚弱则提前解除该状态。“坚毅”状态正常结束时，如玉进入虚弱。',
          },
          {
            level: 2,
            description:
              '使如玉进入“坚毅”状态的敌方[在30秒内](老鼠被抓起时提前解除该状态)无法对如玉造成眩晕和虚弱。',
            detailedDescription:
              '使如玉进入“坚毅”状态的敌方[在30秒内](老鼠被抓起时提前解除该状态)无法对如玉造成眩晕和虚弱。',
          },
          {
            level: 3,
            description:
              '“坚毅”会回复更多Hp，且对敌方造成眩晕即可解除该状态。使如玉进入“坚毅”状态的敌方改为[在60秒内](老鼠被抓起时提前解除该状态)无法对如玉造成眩晕和虚弱。',
            detailedDescription:
              '“坚毅”改为回复200Hp，且对敌方造成眩晕即可解除该状态。使如玉进入“坚毅”状态的敌方改为[在60秒内](老鼠被抓起时提前解除该状态)无法对如玉造成眩晕和虚弱。',
          },
        ],
        description:
          '如玉无法释放常规爪刀，但拥有两种特殊爪刀，特殊爪刀[与技能类似](可在手中有老鼠时释放；可移动释放，但释放期间不能转向；可用道具键取消前后摇，但会进入CD；可打断需要其他技能键才能打断的技能；不会因缴械被封锁，但会被无法释放技能的效果封锁)，[无法触发常规爪刀效果](无法直接抓起被拍子控制的老鼠，无法为知识卡-乘胜追击叠加层数)，[无法受到大部分爪刀相关效果加成](无法受到知识卡-击晕、猛攻、蓄势一击、长爪；特技-全垒打，长爪一击，勇气爪刀影响)，但[CD机制与爪刀相同](可被影响爪刀CD的效果影响，如特技-我生气了)。[两种特殊爪刀共用CD](共用爪刀CD，释放跳跃劈枪时会重置前刺回马枪的状态)。\n1.前刺回马枪：在地面时释放，分为2段：前刺枪对身前敌方造成少量伤害，命中非虚弱敌方时获得加速；回马枪对身后敌方造成少量伤害，击退对方一小段距离，若命中[被前刺枪命中过的非虚弱目标](指被同一轮前刺回马枪的第一段命中过的目标，包括初次命中时处于虚弱状态的目标)，则额外造成伤害。\n2.跳跃劈枪：在空中时释放，对身前大范围内敌方造成伤害，命中非虚弱敌方时获得加速。\n\n如玉开局手持道具替换为鞭炮束，投掷道具和拍子不会对敌方造成受伤，从商店购买道具所需的时间较长。',
        detailedDescription:
          '如玉无法释放常规爪刀，但拥有两种特殊爪刀，特殊爪刀[与技能类似](可在手中有老鼠时释放；可移动释放，但释放期间不能转向；可用道具键取消前后摇，但会进入CD；可打断需要其他技能键才能打断的技能；不会因缴械被封锁，但会被无法释放技能的效果封锁)，[无法触发常规爪刀效果](无法直接抓起被拍子控制的老鼠，无法为知识卡-乘胜追击叠加层数)，[无法受到大部分爪刀相关效果加成](无法受到知识卡-击晕、猛攻、蓄势一击、长爪；特技-全垒打，长爪一击，勇气爪刀影响)，但[CD机制与爪刀相同](可被影响爪刀CD的效果影响，如特技-我生气了)。[两种特殊爪刀共用CD](共用爪刀CD，释放跳跃劈枪时会重置前刺回马枪的状态)。\n1.前刺回马枪：在地面时释放，分为2段：前刺枪——[前摇0.35秒，后摇0.1秒](可移动释放，可被道具键取消前后摇（取消前摇会直接进入CD）)，对身前约450范围内的敌方造成{30}伤害，命中非虚弱敌方时获得30%加速，持续3秒；回马枪——[前摇0.35秒，后摇0.35秒](可移动释放，不可空中释放，可被道具键取消前后摇（取消前摇会直接进入CD）)，对身后约450范围内的敌方造成{30}伤害，击退对方约100距离，若命中[被前刺枪命中过的非虚弱目标](指被同一轮前刺回马枪的第一段命中过的目标，包括初次命中时处于虚弱状态的目标)，则额外造成{55}伤害。\n2.跳跃劈枪：在空中时释放，[前摇0.1秒，后摇0.45秒](可移动释放，可被移动、跳跃、道具键取消前后摇（取消前摇会直接进入CD）)，对身前约500范围内敌方造成{55}伤害，命中非虚弱敌方时获得30%加速，持续3秒。\n\n如玉开局手持道具替换为鞭炮束，投掷道具和拍子不会对敌方造成受伤，从商店购买道具所需的时间较长（为4秒）。\n\n（技能仍在共研服测试中，数值可能有所调整）',
      },
    ],
    counters: [],
    counteredBy: [
      {
        id: '侦探杰瑞',
        description: '推奶酪速度快，自保和破局能力强，烟雾弹还能封锁技能，十分克制如玉。',
        isMinor: false,
      },
    ],
    attackBoost: 0,
