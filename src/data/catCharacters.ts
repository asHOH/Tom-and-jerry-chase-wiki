  ...
  牛仔汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '前摇0.25s，对前方老鼠造成1点伤害和持续7.9秒的9.5%减速、给自己持续8秒的1%加速和减少2%爪刀CD，能破坏[易碎道具](包括玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶，以及纸盒、吊灯、牛仔杰瑞的仙人掌等)。连续命中敌方角色两次后获得1层[增益](上限5层)，永久增加3%移速和6%减少爪刀CD。老鼠被累计命中两次后，受到50点伤害和2.4秒眩晕效果，并清除鞭子带来的减益。鞭子眩晕期间可被直接抓取。使用技能时还能使场上的{斗牛}加速。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '不可被取消',
  ...
  侍卫汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '前摇0.684秒，原地召唤{皇家火炮(衍生物)}，对附近老鼠造成0.93秒眩晕及10点伤害，侍卫汤姆获得两层护盾，持续1.95秒。火炮存在期间，侍卫汤姆可以自由活动，拖动技能键远程操纵火炮发射，命中时对老鼠造成0.56秒眩晕和[50伤害](不受攻击增伤加成)、移除其[部分增益](隐身、兴奋、远视；天宫图香炉的远视；除了尼宝三级翻滚和魔术师三级卡牌以外的技能与被动隐身)；同时侍卫汤姆加速49%并获得两层护盾，效果持续2.96秒。火炮可射击数次，每次射击之间有最短间隔。',
        skillLevels: [
          {
            level: 1,
            description: '火炮能射击三次。',
    ...
    skills: [
      {
        ...
        detailedDescription:
          '按住技能键，在前摇0.6秒后持续地喵喵叫，期间可以通过按住方向键不松开的方式移动，也可以正常使用爪刀和《绝地反击(特技)》，松开技能键可提前取消技能；喵喵叫期间对周围半径1000范围内的老鼠持续施加[喵喵叫减速](喵喵叫减速与防狼锤减速的层数互通，但具体数值有差异)，每层[喵喵叫减速](喵喵叫减速与防狼锤减速的层数互通，但具体数值有差异)将使老鼠移速和跳跃速度降低8%，并暴露小地图视野；[喵喵叫减速](喵喵叫减速与防狼锤减速的层数互通，但具体数值有差异)叠加到第五层时对其造成{60}伤害并眩晕2秒，然后清空减速层数。被打断或提前取消技能会按比例返还CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        canHitInPipe: true,
        cancelableAftercast: '无后摇',
