      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '增加眩晕时间、命中的老鼠攻击力短暂降低；震碎附近的[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/冰块)。',
            detailedDescription:
              '眩晕延长至2.4秒、命中的老鼠10秒内攻击力短暂降低固定值100；震碎附近的[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶/冰块)。',
            cooldown: 18,
          },
          {
            level: 3,
    ...
    skillAllocations: [
      {
        ...
        weaponType: 'weapon1',
        description:
          '优先二级被动提供霸体和回血，但容易被断飞行。最后三个加点提升幅度较为一般，因此加点顺序随意。',
      },
      {
        id: '优先二级飞行',
        pattern: '12210[0012]',
        weaponType: 'weapon1',
        description:
          '霸体会晚一点点出来，手绑火箭能力可能较差，但不容易被干扰断飞行，但吸火箭范围大砍后，长时间飞行可能会罚站。最后三个加点提升幅度较为一般，因此加点顺序随意。',
      },
    ],
    knowledgeCardGroups: [
      {
