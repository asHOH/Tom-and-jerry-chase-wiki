    ...
    skills: [
      {
        ...
        type: 'active',
        aliases: ['闪现'],
        description: '向前移动一段距离。如果附近有老鼠，可以瞬移到老鼠身后，该范围会在小地图显示。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        canHitInPipe: false,
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '释放一个飞吻，释放后将追踪并锁定附近的老鼠，锁定后将全图追踪且不会更换目标，若追踪途中命中其他老鼠将由其他老鼠承担吻效果；飞吻持续一段时间后消失，也可被护盾、无敌、虚弱抵消，被[部分地形](包括门、厚墙壁、地面等)阻挡。命中老鼠后，其移动、跳跃、搬动奶酪等行为期间会受到持续伤害；只有受到[控制效果](包括碎片的僵直、夹子、虚弱、部分变身效果（包括变身饮料效果）等)才能解除被吻效果。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        ...
        skillLevels: [
          {
            ...
            description: '',
            detailedDescription:
              '伤害：每次跳跃受到1.3伤害；移动期间以0.55Hp/次，折合8.3Hp/秒的速度受到伤害；搬动奶酪以折合15Hp/秒的速度受到伤害（现版本推奶酪不扣血）（{朵朵}的Lv.2{机械身躯}可令伤害减半）。',
            cooldown: 15,
          },
          {
            level: 2,
        ...
        cueRange: '全图可见',
        detailedDescription:
          '在前摇0.35秒后，释放一个飞吻，技能后摇0.8秒。飞吻释放后将追踪并锁定吻半径1200范围内的老鼠，锁定后将全图追踪且不会更换目标，若追踪途中命中其他老鼠将由其他老鼠承担吻效果；飞吻最多存在18秒，超过18秒将自动消失；飞吻可被护盾、无敌、虚弱抵消，也可被[部分地形](包括门、厚墙壁、地面等)阻挡。飞吻命中老鼠后，其移动、跳跃、搬动奶酪等行为期间会受到持续伤害，只有受到[控制效果](包括碎片的僵直、夹子、虚弱、部分变身效果（包括变身饮料效果）等)才能解除被吻效果。',
        aliases: ['吻'],
      },
      {
        name: '魅力香水',
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 16,
            detailedDescription:
              '图多盖洛在香水内获得的恢复效果改为20Hp/秒，攻击增伤改为提高50，爪刀CD改为减少70%，且爪刀范围获得提升；敌方在香水区域内移速改为降低80%，跳跃速度改为降低30%，推速改为降低70%，[造成的伤害改为降低30](最低为0)，且无法使用技能。',
          },
        ],
        canHitInPipe: false,
        cooldownTiming: '释放时',
    ...
    skills: [
      {
        ...
        detailedDescription:
          '[获得霸体，持续10秒](该霸体免疫绝大部分控制效果，包括仙女鼠八星的变身效果，但不免疫虚弱。技能期间被莱恩变身为线条猫时，技能不中断)。技能期间对附近的敌人造成持续伤害和减速，且敌人头顶会出现舞步指令，若未按照头顶提示的方向移动则会受到伤害和眩晕，且可[随机触发一次Lv.2被动的效果](不占用Lv.2被动的触发序列，四种效果随机触发)。技能释放期间同步进入读条，释放完毕后才会进入冷却。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        detailedDescription:
          '召唤列车沿固定轨道冲撞，对被撞击的敌人施加50伤害，并造成眩晕和击退效果。冲撞完成后重新生成下一段列车，重复数次。被冲撞过的老鼠短时间内获得冲撞免疫效果（免疫列车冲撞带来的伤害和控制，但被撞击仍会造成小幅度位移）。\n注：列车前摇释放完毕后进入技能冷却，列车冲撞结束后，技能剩余冷却时间为技能真空期。1级真空期约10秒，2级真空期约2s，3级真空期约6s。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['跳跃键', '道具键'],
        cancelableAftercast: '无后摇',
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '释放列车成功后给予一层护盾，列车冲撞次数提升至5次，列车经过恶魔汤姆会使恶魔汤姆获得一层护盾，撞击老鼠会使恶魔汤姆移速提高，爪刀CD固定降低，持续一段时间。',
            cooldown: 20,
            detailedDescription:
              '释放列车成功后给予一层护盾。列车冲撞次数提升至5次，共持续约18秒。列车经过恶魔汤姆会使恶魔汤姆获得一层护盾。撞击老鼠会使恶魔汤姆移速提高，[爪刀CD固定降低3.5秒](空刀CD由命中时的CD乘角色内置的空刀返还CD比例得到。对于恶魔汤姆来说，2级列车减少爪刀CD后，空刀冷却约2.2s，命中敌方冷却约4.5s)，持续数秒。',
          },
          {
            level: 3,
  ...
  追风汤姆: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          'Lv.0: [走地状态下](不处于空中时，即不包括处于跳跃，坠落等状态中)，每秒获得1秒飞行时间，最多储存10秒。未处于飞行状态时爪刀CD减少35%；飞行状态下[视野范围增加55%](覆盖其他远视效果)，[可托起其他角色](机器鼠等单位除外)，无视小平台阻挡，并提高移速至水平1015、竖直840。悬停时角色会自动向前以水平350、竖直30的速度下落。飞行时[免疫控制](不免疫虚弱)，但无法拾取道具、使用商店或进行交互（抓起老鼠除外）；受到伤害会减少2秒飞行时间。飞行状态可随时退出，但会清空剩余飞行时间。“退出飞行状态”这一操作无cd。飞行被[强制打断](如被狗抓、被打死)会使主动技能进入10秒CD。该冷却不可通过吃蛋糕回复。',
