    ...
    skills: [
      {
        ...
        detailedDescription:
          '舞动开始时将恢复50点生命值。过程中[免疫部分眩晕效果](包括控制道具等大部分老鼠的控制手段，但不免疫大部分NPC的控制)。移动和跳跃不会中断此技能。爪击将替换为以苏蕊为中心、范围更大的舞动亮相，其冷却时间为6秒（未命中老鼠）和12秒（命中老鼠），伤害为70点。舞动时每隔13秒会在中心出现爱心提示，此时点击技能按钮将恢复30点生命值，并提升10%移动速度和15点攻击力。在舞动过程中，若接触到不在老鼠夹上的虚弱老鼠（包括触发知识卡“铁血”的老鼠），该老鼠将自主跟随苏蕊。在此状态下，老鼠无法主动使用技能、移动等操作。若老鼠与苏蕊距离较远（如钻管道后），则老鼠会解除跟随状态。跟随效果持续30秒，期间老鼠遇到火箭会被立刻绑上。舞动总持续时间为40秒。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '不可取消',
        cancelableAftercast: '无后摇',
