...
// CardGroup can be nested to any depth (up to 5 levels), e.g. { cards: ['A', 'B', [true, [false, 'C', 'D'], [false, 'E', 'F']]] } means "(A and B and ((C and D) or (E and F)))"
// the root definition implies "and" relationship
