...
const mouseEntitiesDefinitions: Record<string, EntityDefinition> = {
  ...
  '金币(道具)': {
    ...
    detailedDescription:
      '金币命中敌方时造成2秒眩晕,但被命中的敌方在眩晕期间及眩晕结束后1秒内免疫该道具效果。金币不会因虚弱而从手中掉落。Lv.3金币命中敌方会造成两段伤害，基础伤害分别为35和40（受攻击增伤影响，因此通常是55+60），可分别击破护盾。',
  ...
  火炮: {
    ...
    detailedDescription:
      '老鼠可通过交互键进入火炮（交互动作时长1秒），通过拖拽投掷键选择方向发射自身，无视部分平台阻挡，碰到敌方会反弹并对其造成50伤害与1.5秒眩晕，碰到绑在火箭上的队友时自动进行救援交互，碰到地面或跳跃时结束被发射状态。火炮内不会被投掷道具及部分技能命中。若火炮内老鼠进入虚弱，则火炮会提前消失。同一房间最多出现两个火炮。火炮持续15/25/25秒后消失。火炮会在小地图上全程暴露位置。火炮造成的伤害以乘坐者为伤害来源，可受其的攻击增伤影响。',
  ...
  蓝色小淘气: {
    ...
    ignore: ['道具', '平台', '墙壁'],
    description:
      '被投掷后留在原地自动索敌，范围内出现敌方时自动飞向对方，命中时造成20伤害（受攻击增伤影响），并使敌方3秒内无法使用技能和道具。',
  ...
  绿色小淘气: {
    ...
    collsion: true,
    description:
      '具有高尔夫球的特点，但伤害更低，且有比高尔夫球有更大的弹性。被恶魔泰菲投掷时，命中敌方不会消耗恶魔泰菲的黑暗印记。',
