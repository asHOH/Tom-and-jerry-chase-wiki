...
const mouseEntitiesDefinitions: Record<string, EntityDefinition> = {
  ...
  绿色小淘气: {
    ...
    detailedDescription:
      '具有高尔夫球的特点，但只有10伤害，且有比高尔夫球有更大的弹性。被恶魔泰菲投掷时，命中敌方不会消耗恶魔泰菲的黑暗印记。绿色小淘气造成的伤害以被投掷者为伤害来源，可受其攻击增伤影响。',
  ...
  弓箭: {
    ...
    collsion: false,
    description:
      '普通箭命中友方为其回复一定Hp并提高移速；命中敌方造成伤害。蓄力箭命中友方为其回复更多Hp并提高移速，命中敌方造成更高伤害和眩晕。',
    detailedDescription:
      '普通箭命中友方为其回复25/25/50Hp且移速提高10%，持续1.6秒；命中敌方造成25/25/50伤害。蓄力箭命中友方为其回复50/50/99Hp和1.6秒的5%加速；命中敌方造成50/50/100伤害和1.4秒眩晕（无视苏蕊的跳舞，但不打断跳舞或队友的跟随；无视天使汤姆二级被动的霸体，且可救下队友）。弓箭受到重力，但速度大小不变，只改变方向（不受外力时，箭的竖直速度逐渐增大而水平速度逐渐减小，并非严格的抛物线）。弓箭可被鞭炮影响而改变飞行轨迹。Lv.3蓄力箭命中虚弱友方老鼠会解除其虚弱状态。弓箭造成的伤害可受攻击增伤影响。',
    create: '通过天使杰瑞-丘比特之箭射出，可通过蓄力射出更强大的蓄力箭。',
  },
  /* ToDo: Add  蓄力箭 and 雷云 */
  红色卡牌: {
    entitytype: '道具类' as const,
  ...
  尼宝的朋友: {
    ...
    collsion: false,
    description:
      '朋友持续一段时间后消失。尼宝可使用技能使附近的朋友向尼宝扔出鱼钩。鱼钩碰到道具会携带之；碰到角色会将其勾回，并救下猫咪手中的老鼠。',
    detailedDescription:
      '朋友在30秒后自然消失。尼宝可使用技能使附近的朋友向尼宝扔出鱼钩。朋友扔出鱼钩过程中再次点击技能会使朋友将鱼钩收回（有前摇）。鱼钩碰到道具会携带之，碰撞猫咪时造成相应效果；碰到角色会将其勾回，并救下[猫咪](包括部分护盾、霸体状态下的猫咪)手中的老鼠。',
    create: '由尼宝-尼宝的朋友召唤。',
  },
  鱼钩: {
    entitytype: '投射物类' as const,
