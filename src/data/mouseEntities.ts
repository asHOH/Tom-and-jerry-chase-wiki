...
const mouseEntitiesDefinitions: Record<string, EntityDefinition> = {
  ...
  火箭筒: {
    ...
    detailedDescription:
      '直接命中敌方时造成50伤害，该伤害先于爆炸伤害结算且可触发投掷类知识卡和特技：{缴械}、{投手}、{追风}、{精准投射}、{干扰投掷}、{勇气投掷}；命中敌方角色/墙壁/平台/其他道具后爆炸，对一定范围内敌方造成15/30/30伤害和1.5/2.1/2.1秒爆炸眩晕。火箭筒可对墙缝造成伤害。爆炸产生的冲击波可以炸飞老鼠夹、叉子等道具。火箭筒造成的伤害可受攻击增伤影响。',
    create: '由泰菲-火箭筒技能射出。',
  },
  感应雷: {
    entitytype: '召唤物',
    ...
    detailedDescription:
      '被放置一小段时间后进入隐身状态，敌方靠近时现身，并在1.5秒延迟后飞向敌方并爆炸，对小范围内的敌方造成50/50/80伤害和1.9秒爆炸眩晕，对墙缝造成10/10/15伤害，对范围内所有角色产生小幅度的爆炸击退效果。感应雷被道具击中会原地倒计时并爆炸。感应雷30秒后自然消失。Lv.2感应雷可击落敌方手中的老鼠和道具。感应雷造成的伤害可受攻击增伤和墙缝增伤影响。',
  ...
  '乾坤袋(投射物)': {
    ...
    detailedDescription:
      '未落地时可命中猫咪使其移速降低40%持续5秒，或命中墙缝造成3伤害，可触发投掷类知识卡和特技：{缴械}、{投手}、{追风}、{精准投射}、{干扰投掷}、{勇气投掷}；命中敌方角色/墙缝/平台/地面后生成乾坤袋(召唤物)，若因极端情况导致乾坤袋(道具)飞行时间过长，则在飞行数秒后会立刻生成乾坤袋(召唤物)。霜月再次使用技能时，乾坤袋(召唤物)变回乾坤袋(道具)，并飞向霜月。',
