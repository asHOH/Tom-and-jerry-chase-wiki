...
const mouseEntitiesDefinitions: Record<string, EntityDefinition> = {
  ...
  饮料印记: {
    ...
    ignore: ['道具'],
    description:
      '一旦印记与猫咪处在同一个房间，印记会召唤1个[模拟自己或队友外形](只包括存活的鼠方队友)的{饮料分身}。分身被击倒时使敌方短暂失明。存在{侦探泰菲分身}或{饮料分身}时，印记不会召唤新的分身；使用分身大师将使饮料分身立即消失。',
    detailedDescription:
      '一旦印记与猫咪处在同一个房间，印记会召唤1个[模拟自己或队友外形](只包括存活的鼠方队友)的{饮料分身}，持续9.9/9.9/20秒。分身被击倒时使敌方失明1.75秒，但不会破盾或减少护盾时间。当场上存在[由自身召唤](即不包括其他侦探泰菲召唤的分身)的{侦探泰菲分身}或{饮料分身}时，印记不会召唤新的分身；使用分身大师将使饮料分身立即消失。同一房间同时召唤的分身越多，分身存在时间越短。饮料分身Hp上限为角色Hp上限减49并[按比例继承本体Hp](如124血的剑杰Hp为24，召唤出的分身Hp将为15)，若同房间内出现出现猫咪将跑向最近的道具/水果盘/冰桶处，若半径800范围内出现猫咪将使用相应道具进行攻击。Lv.2及以上时，[猫咪](不论是否隐身)进入印记半径1250范围内时，对所有友方暴露小地图视野25秒，且侦探泰菲加速20%、跳跃速度提升20%，持续20秒。若饮料召唤出分身，将立即结束加速效果和猫咪视野暴露。',
    create: '由侦探泰菲-追踪饮料召唤。',
  },
  饮料分身: {
    entitytype: 'NPC类' as const,
    ...
    ignore: ['道具'],
    description:
      '饮料分身会[模拟自己或队友外形](只包括存活的鼠方队友)，会自由走动，被击倒时使敌方短暂失明。',
    detailedDescription:
      '饮料分身持续9.9/9.9/20秒，会[模拟自己或队友外形](只包括存活的鼠方队友)，被击倒时使敌方失明1.75秒，但不会破盾或减少护盾时间。使用分身大师将使饮料分身立即消失。同一房间同时召唤的分身越多，分身存在时间越短。饮料分身Hp上限为角色Hp上限减49并[按比例继承本体Hp](如124血的剑杰Hp为24，召唤出的分身Hp将为15)，若同房间内出现出现猫咪将跑向最近的道具/水果盘/冰桶处，若半径800范围内出现猫咪将使用相应道具进行攻击。',
