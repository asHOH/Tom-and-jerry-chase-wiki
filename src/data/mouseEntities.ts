...
const mouseEntitiesDefinitions: Record<string, EntityDefinition> = {
  ...
  爱心之吻: {
    ...
    create: '由雪梨-爱心之吻召唤。',
    specialImageUrl: '/images/mouseSkills/雪梨1-爱心之吻.png', //ToDo: add this entity's image
  },
  花洒: {
    entitytype: '召唤物类' as const,
    characterName: '雪梨',
  ...
  蓄力箭: {
    ...
    specialImageUrl: '/images/mouseSkills/天使杰瑞2-丘比特之箭.png', //ToDo: add this entity's image
  },
  雷云: {
    entitytype: '召唤物类' as const,
    characterName: '天使杰瑞',
  ...
  闪耀足球: {
    ...
    detailedDescription:
      '命中敌方时造成“强光耀眼”状态（受到[30伤害](不受攻击增伤影响)，并且[失明](除自身所在位置以外的大部分区域被黑暗笼罩)，降低25%交互速度，此期间受来自拿坡里鼠的伤害会眩晕2秒（眩晕有8秒内置CD），该状态持续8秒，免疫失明的技能也会完全免疫该状态效果）。足球可触发{缴械}/{投手}。[有效蓄力时间越长，足球存在时间越长](有效蓄力时长最长1.7秒，足球持续时间和速度由蓄力时间阶段性决定，并非线性关系)。足球碰到道具/墙壁/地板后会被反弹，可以反复弹跳。',
  ...
  魔镜: {
    ...
    create: '由仙女鼠-魔镜召唤咒召唤。',
    specialImageUrl: '/images/mouseSkills/仙女鼠1-魔镜召唤咒.png', //ToDo: add this entity's image
  },
  星星: {
    entitytype: '投射物类' as const,
    characterName: '仙女鼠',
  ...
  照片: {
    ...
    specialImageUrl: '/images/mouseSkills/米可2-记录美好瞬间.png', //ToDo: add this entity's image
  },
  金币符: {
    entitytype: '投射物类' as const,
    characterName: '霜月',
  ...
  '乾坤袋(NPC)': {
    ...
    specialImageUrl: '/images/mouseSkills/霜月2-乾坤袋.png', //ToDo: add this entity's image
  },
  柠檬: {
    entitytype: '投射物类' as const,
  ...
  '蓝图(召唤物)': {
    ...
    description:
      ...
      figureDescription,
    detailedDescription:
      '大小1000×666。接触蓝图(召唤物)的{火箭}变为{线条火箭}（燃烧速度减半），猫咪[隐身状态暂时失效](离开蓝图时恢复)且受到伤害时会短暂变为线条猫，持续8秒（变身结束后20秒内不会再次变为线条猫），并使手中老鼠掉落。莱恩再次使用技能或持续较长时间后收回蓝图。\n线条猫：只可使用移动、跳跃和爪刀，但受到的伤害、爪刀CD、受控时间、虚弱时间减半。' +
      figureDescription,
  ...
  毛线球: {
    ...
    ignore: ['道具', '平台'],
    description:
      '{毛线球}与{梦游杰瑞}通过{毛线}连接。毛线球与敌方碰撞时使其受到减速，拉出的毛线也能使敌方受到减速。毛线球分为抛出、滞留和收回三个阶段。1.抛出：抛出毛线球，无视平台，会被敌方或墙壁反弹，坠落至地面时进入滞留状态；2.滞留：暂时不移动；3.收回：沿着毛线的轨迹进行移动，带回自身碰到的部分道具（有数量上限）和虚弱队友。',
    detailedDescription:
      '{毛线球}与{梦游杰瑞}通过{毛线}连接。毛线球与敌方碰撞时使其受到减速（可触发{缴械}/{投手}），拉出的毛线也能使敌方受到减速（不触发知识卡）。毛线球分为抛出、滞留和收回三个阶段。1.抛出：抛出毛线球，无视平台，会被敌方或墙壁反弹，坠落至地面时进入滞留状态；2.滞留：暂时不移动；3.收回：沿着毛线的轨迹进行移动，带回自身碰到的{奶酪}/{盘子}/{高尔夫球}/{灰花瓶}/{蓝花瓶}/打开的{老鼠夹}/虚弱队友，携带道具有数量上限（队友不计入在内）。',
