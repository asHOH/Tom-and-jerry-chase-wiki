...
export const catKnowledgeCards: Record<string, Card> = {
  ...
  '乘胜追击': {
    ...
    rank: 'S',
    cost: 7,
    description: '爪刀命中老鼠或使老鼠进入虚弱时，提升2.5%移速和2%爪刀频率，可以**叠加**。猫咪进入虚弱状态移除当前一半层数。',
    // detailedDescription: '',
    levels: [
      { level: 1, description: '效果最多叠加**5层**。'},
      { level: 2, description: '效果最多叠加**6层**。'},
      { level: 3, description: '效果最多叠加**7层**。'}
    ]
  },
  ...
  '乾坤一掷': {
    ...
    rank: 'S',
    cost: 6,
    description: '保持60% Hp以上**一段时间**进入乾坤一掷状态，提高移速和投掷物伤害，Hp低于60%后移除该状态。',
    detailedDescription: '保持60% Hp以上**一段时间**进入乾坤一掷状态，提高移速和投掷物伤害，Hp低于60%后移除该状态。“待吾择良辰回首，今朝一掷定乾坤！”',
    levels: [
      { level: 1, description: '保持60% Hp以上**20秒**后进入乾坤一掷。'},
      { level: 2, description: '保持60% Hp以上**19秒**后进入乾坤一掷。'},
      { level: 3, description: '保持60% Hp以上**18秒**后进入乾坤一掷。'}
    ]
  },
  ...
  '击晕': {
    ...
    levels: [
      { level: 1, description: '击晕**0.8秒**。'},
      { level: 2, description: '击晕**0.9秒**。'},
      { level: 3, description: '击晕**1.0秒**。'}
    ]
  },
  ...
  '屈打成招': {
    ...
    detailedDescription: '逼问意志不坚定的老鼠，你将得到对方队友的位置信息！手持老鼠或将老鼠绑在火箭上时，能在小地图上获得**其他老鼠**的位置。',
    levels: [
  ...
  '暴怒': {
    ...
    rank: 'S',
    cost: 6,
    description: '墙缝**即将**被破开时，猫咪进入暴怒状态，攻击力增加50，但技能CD会延长50%。虚弱起身后也会获得10秒暴怒状态。',
    // detailedDescription: '',
    levels: [
  ...
  '猛攻': {
    ...
    levels: [
      ...
      { level: 2, description: '禁用技能和道具持续**6秒**。'},
      { level: 3, description: '禁用技能和道具持续**7秒**。'}
    ]
  },
  ...
  '蓄势一击': {
    ...
    rank: 'S',
    cost: 6,
    description: '每隔**一段时间**，获得蓄势一击状态，下次爪刀将附带50点额外伤害。受到来自老鼠的眩晕和硬直效果会移除该状态。虚弱起身或升级后立刻获得蓄势一击状态。',
    detailedDescription: '每一次的潜伏，都是为了今后的爆发。每隔**一段时间**，获得蓄势一击状态，下次爪刀将附带50点额外伤害。受到来自老鼠的眩晕和硬直效果会移除该状态。虚弱起身或升级后立刻获得蓄势一击状态。',
    levels: [
      { level: 1, description: '每隔**14秒**，获得蓄势一击状态。'},
      { level: 2, description: '每隔**13秒**，获得蓄势一击状态。'},
      { level: 3, description: '每隔**12秒**，获得蓄势一击状态。'}
    ]
  },
  ...
  '加大火力': {
    ...
    rank: 'A',
    cost: 4,
    description: '将老鼠绑上火箭后，火箭燃烧速度变得**更快**！在绑有老鼠的火箭附近击倒老鼠，会额外减少火箭5秒燃烧时间。(CD：20秒)',
    detailedDescription: '点燃火箭吧！将老鼠绑上火箭后，火箭燃烧速度变得**更快**！在绑有老鼠的火箭附近击倒老鼠，会额外减少火箭5秒燃烧时间。(CD：20秒)',
    levels: [
  ...
  '威压': {
    ...
    detailedDescription: '给附近的老鼠带来强大的压迫感，**降低**老鼠移速，并在使用技能后一段时间内造成更强的减速。',
    levels: [
  ...
  '心灵手巧': {
    ...
    detailedDescription: '那些笨手笨脚的老鼠！心灵手巧的猫咪在布置捕鼠夹、绑火箭、修复火箭时，交互速度得到**提升**。',
    levels: [
  ...
  '熊熊燃烧': {
    ...
    levels: [
      { level: 1, description: '火箭引信额外缩短**3秒**。'},
      { level: 2, description: '火箭引信额外缩短**4秒**。'},
      { level: 3, description: '火箭引信额外缩短**5秒**。'}
    ]
  },
  ...
  '穷追猛打': {
    ...
    rank: 'A',
    cost: 4,
    description: '穷追不舍状态给予猫攻击和速度**强化**效果，该状态在成功将老鼠绑上火箭或累计击倒8次老鼠时移除。',
    detailedDescription: '必胜的信念让猫都燃起来了，穷追不舍状态给予猫攻击和速度**强化**效果，该状态在成功将老鼠绑上火箭或累计击倒8次老鼠时移除。“追寻的路上不乏激情，但成功后空虚往往随之而来，火总会熄灭的，捉老鼠如此，猫生亦是如此。”',
    levels: [
  ...
  '长爪': {
    ...
    rank: 'A',
    cost: 4,
    description: '攻击范围**大幅**提升，但普通攻击伤害固定为25点，不受任何攻击力加成影响。使用拍子时只能造成效果而不能造成伤害。',
    // detailedDescription: '',
    levels: [
  ...
  '寻踪': {
    ...
    // detailedDescription: '',
    levels: [
      { level: 1, description: '最多看到**2只**老鼠。'},
      { level: 2, description: '最多看到**3只**老鼠。'},
      { level: 3, description: '最多看到**4只**老鼠。'}
    ]
  },
  ...
  '攻其不备': {
    ...
    detailedDescription: '当老鼠在推奶酪且猫咪周围没有老鼠时，猫咪试图快速接近老鼠，移速得到**提升**。',
    levels: [
  ...
  '斗志昂扬': {
    ...
    levels: [
      { level: 1, description: '爪刀CD缩短**5%**。'},
      { level: 2, description: '爪刀CD缩短**6%**。'},
      { level: 3, description: '爪刀CD缩短**7%**。'}
    ]
  },
  ...
  '皮糙肉厚': {
    ...
    detailedDescription: '老鼠虐我千百遍，我待老鼠如初恋！皮糙肉厚的猫咪受到老鼠造成的伤害后，4秒内获得**固定减伤**。',
    levels: [
  ...
  '观察员': {
    ...
    detailedDescription: '猫咪通过监控设备得知机器鼠的动向。游戏开始后**一段时间**内，猫咪可以看到所有机器鼠的位置。',
    levels: [
      { level: 1, description: '效果持续到游戏开始后**20秒**。'},
      { level: 2, description: '效果持续到游戏开始后**25秒**。'},
      { level: 3, description: '效果持续到游戏开始后**30秒**。'}
    ]
  },
  ...
  '春风得意': {
    ...
    detailedDescription: '终于抓住了一只小老鼠！手握老鼠时，**提高**移动、跳跃速度，并免疫捕鼠夹和碎片。',
    levels: [
  ...
  '气势如牛': {
    ...
    levels: [
      { level: 1, description: '效果持续**10秒**。'},
      { level: 2, description: '效果持续**15秒**。'},
      { level: 3, description: '效果持续**20秒**。'}
    ]
  },
  ...
  '狡诈': {
    ...
    // detailedDescription: '',
    levels: [
      { level: 1, description: '加速持续**6秒**。'},
      { level: 2, description: '加速持续**7秒**。'},
      { level: 3, description: '加速持续**8秒**。'}
    ]
  },
  ...
  '猫是液体': {
    ...
    detailedDescription: '猫咪使自己身体变得更柔软，能够**更快**、更频繁地穿过管道，并且不用“排队”。',
    levels: [      { level: 1, description: '钻管道速度提升**60%**。'},
  ...
  '都是朋友': {
    ...
    rank: 'C',
    cost: 3,
    description: '猫咪不会再受到斯派克的攻击，但靠近斯派克时，移速**略微**降低。此外，免疫主人的眩晕效果',
    detailedDescription: '猫咪与斯派克成为塑料朋友后，不会再受到斯派克的攻击，但靠近斯派克时，移速**略微**降低。此外，免疫主人的眩晕效果',
    levels: [      { level: 1, description: '靠近斯派克时降低**5%**移速。'},
  ...
  '铁手': {
    ...
    // detailedDescription: '',
    levels: [      { level: 1, description: '老鼠挣扎速度降低**4%**。'},
  ...
  '震慑': {
    ...
    // detailedDescription: '',
    levels: [      { level: 1, description: '老鼠推速降低**8%**。'},
