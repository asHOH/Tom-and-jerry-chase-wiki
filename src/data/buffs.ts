...
const buffDefinitions: Record<string, BuffDefinition> = {
  ...
  失明: {
    ...
    buffclass: '效果',
    aliases: ['#失明', '%致盲'],
    description: '角色视野范围不变，但除角色周身极小一圈以外的其他视野均被黑色覆盖。',
    detailedDescription:
      '角色视野范围不变，但除角色周身极小一圈以外的其他视野均被黑色覆盖。此外，失明大多伴随{隐藏小地图键}的效果。',
  ...
  隐匿: {
    ...
    bufftype: '常规类',
    buffclass: '效果',
    aliases: ['隐藏小地图位置', '#[(小地图)(位置)(不显示)(隐匿)]{2,}'],
  ...
  反向: {
    ...
    aliases: ['#反向'],
    description:
      '使左右移动的效果互换，且通常伴随[视野扭曲](使角色视野以波浪形和固定的频率幅度进行扭曲)。跳跃和[飞行中的上下移动](此处仅包括天使汤姆和追风汤姆的飞行摇杆操作。飞行过程中的上下移动不会受到反向影响)不受影响。',
  ...
  隐藏指定键位: {
    ...
    buffclass: '效果',
    aliases: ['%隐藏'],
    description: '使角色的某些键位被隐藏，例如小地图键、某一技能键等。',
    source: '{胡椒瓶}的失明及{1级烟雾弹}等效果能隐藏小地图键，部分{变身}效果能隐藏指定技能键。',
  ...
  禁用指定键位: {
    ...
    aliases: ['%禁用', '%无法使用', '%沉默'],
    description:
      '使角色的某些键位变为无法使用，例如技能键、道具键、爪刀键等。\n另外，禁用技能键的效果俗称“沉默”，禁用爪刀键的效果俗称“缴械”。',
    detailedDescription:
      '使角色的某些键位变为无法使用，例如技能键、道具键、爪刀键等。大部分时候该效果会在对应键位上显示“禁止”图标以作提示，但并不绝对。\n另外，禁用技能键的效果俗称“沉默”，禁用爪刀键的效果俗称“缴械”。',
    source:
