...
const buffDefinitions: Record<string, BuffDefinition> = {
  ...
  速度保持: {
    ...
    target: '角色',
    description:
      '使角色保持当前$实际$font-bold#[$速度$font-bold#](包括横向和/或纵向速度，二者独立判定)，直到下一次[主动改变移动状态](角色有三种移动状态：向左移动，向右移动，静止。角色可以通过操作键改变该状态。当角色处于眩晕等无法移动的状态时，由于无法主动改变移动状态，因此速度保持状态会一直持续下去)。该状态持续期间，角色实际速度不因转向等操作而改变，但会因遇到斜面或从空中坠落等原因改变。',
    sourceDescription: '所有“可在移动中释放”的技能，释放时都会进入此状态。',
    source: [
      { name: '牛仔吉他', type: 'skill' },
  ...
  速度重置: {
    ...
    target: '角色',
    description:
      '使角色的$实际$font-bold#[$速度$font-bold#](包括横向和/或纵向速度，二者独立判定)重置为0或某个特定值。',
    sourceDescription: '猫咪释放爪刀时会自动重置纵向速度为0。',
    source: [
      { name: '降落伞', type: 'skill' },
      { name: '幻风礼服', type: 'skill' },
    ],
  ...
  惯性保持: {
    ...
    target: '角色',
    description:
      '使角色的$实际$font-bold#[$速度$font-bold#](包括横向和/或纵向速度，二者独立判定)在停止移动后不立刻归零，而是缓慢降低至0。',
  ...
  转向: {
    ...
    global: false,
    target: '角色',
    description: '使角色的朝向发生改变，会影响投掷物和部分技能的默认释放方向或影响效果。',
    sourceDescription: '角色主动向左/向右移动时，会自动进行转向。',
    source: [
      { name: '香水瓶', type: 'item' },
      { name: '香风折扇', type: 'skill' },
    ],
  ...
  受力: {
    ...
    duration: '一次性',
    failure: '根据状态来源决定',
    description: '使物体瞬间改变$实际速度$font-bold#，具体效果因物体而异。',
    source: [
      { name: '小鞭炮', type: 'item' },
      { name: '大鞭炮', type: 'item' },
  ...
  完全失重: {
    ...
    duration: '不固定',
    failure: '根据状态来源决定',
    description: '使受到的重力归零。此状态下受到{受力}效果时会直接沿受力方向飞出。',
    detailedDescription:
      '使受到的重力归零。此状态下受到{受力}效果时会直接沿受力方向飞出。\n游戏内默认重力环境下的重力加速度为3000/秒²，角色速度上限为2000/秒。失重不会改变速度上限的大小。',
  ...
  伤害: {
    ...
    sourceDescription: '伤害在游戏中广泛存在，此处不再赘述。',
    unuseImage: true,
  },
  持续伤害: {
    type: '负面',
  ...
  攻击增伤: {
    ...{
      ...
      aliases: ['兴奋', '攻击力', '增伤'],
      description:
        '按固定值提高自身造成的[所有](不包括归属于部分伤害分型的伤害，详见伤害相关界面)或指定类型的伤害。',
  ...
  攻击减伤: {
    ...{
      ...
      description:
        '按固定值或百分比降低自身造成的[所有](不包括归属于部分伤害分型的伤害，详见伤害相关界面)或指定类型的伤害（不低于0）。',
      source: [
  ...
  恢复: {
    ...
    global: false,
    target: '角色',
    description: '使角色每隔一段时间（通常是每秒）获得一次回复。',
    detailedDescription:
      '使角色每隔一段时间（通常是每秒）获得一次回复。\n注：一部分{加速}、{霸体}状态也会应用恢复恢复的显示特效，需注意甄别。',
  ...
  硬直: {
    ...
    aliases: ['僵直'],
    description:
      '无法移动、跳跃、使用技能和道具，但通常$不$font-bold#具备掉落手中道具/老鼠的效果（有特别注明时除外）。',
    stack: commonStack,
    source: [
      { name: '碎片', type: 'item' },
  ...
  冰冻: {
    ...
    aliases: ['冰冻眩晕'],
    description:
      '无法移动、跳跃、使用技能和道具，此外通常兼具掉落手中道具/老鼠的效果（有特别注明时除外）。该效果与{眩晕}的效果和特性基本一致，仅表现外观有区别。',
    stack: commonStack,
    source: [{ name: '冰块', type: 'item' }],
  },
  爆炸: {
    type: '负面',
    global: false,
  ...
  电击: {
    ...
    aliases: ['#电击'],
    description:
      '无法移动、跳跃、使用技能和道具，并叠加一层{感电}，此外通常兼具掉落手中道具/老鼠的效果（有特别注明时除外）。',
    stack: commonStack,
    source: [
      { name: '电风扇', type: 'item' },
      { name: '迅', type: 'skill' },
  ...
  拍扁: {
    ...
    aliases: ['#拍扁'],
    description:
      '无法移动、跳跃、使用技能和道具，并掉落手中道具/老鼠。此外，老鼠在该状态期间可被{直接抓起}。',
    stack: commonStack,
  ...
  定身: {
    ...
    target: '角色',
    aliases: ['#拍扁'],
    description: '无法移动、跳跃、使用技能和道具，横向运动速度立即归零，并{完全失重}。',
    stack: commonStack,
  ...
  夹住: {
    ...
    aliases: ['#夹住'],
    description:
      '无法移动、跳跃、使用技能和道具，并掉落手中道具/老鼠。此外，屏幕下方出现进度条，只有通过挣扎键增加挣扎进度条，进度条充满时才能挣脱。',
  ...
  改变体型: {
    ...
    target: '角色',
    aliases: ['增大体型', '缩小体型'],
    description: '改变角色体型，并因此影响碰撞体积与部分特效大小。',
