...
export const mouseCards: Record<string, Card> = {
  ...
  '回家': {
    ...
    detailedDescription: '为所有爱执着的痛，再痛我也要回家！墙缝出现后立刻解除虚弱和受伤，恢复全部Hp，并额外获得**增益**。',
    levels: [
  ...
  '有难同当': {
    ...
    detailedDescription: '当自身Hp在50%以上、附近队友受到敌方伤害时，牺牲自己大量Hp来减少部分队友所受伤害，被“牺牲”Hp的一部分会在10秒内缓慢恢复，牺牲者会至少保留一定健康值。有内置**CD**。“为众人抱薪者，不可使其冻毙于风雪。”',
    levels: [
  ...
  '铁血': {
    ...
    detailedDescription: '即将虚弱时，可以继续行动**一段时间**，但无法使用技能和道具，也无法获得护盾和无敌，随后再进入虚弱。(CD: 60秒)',
    levels: [
  ...
  '冲冠一怒': {
    ...
    detailedDescription: '冲冠一怒！当同伴被猫咪抓住时，攻击力提升15%；如果猫咪不在附近，额外**提升**移动和跳跃速度。',
    levels: [
  ...
  '祝愿': {
    ...
    detailedDescription: '这是心的呼唤，这是爱的奉献！自己被放飞时，全体队友回复部分Hp、获得经验，并**短暂**提升移动和跳跃速度。',
    levels: [
  ...
  '翩若惊鸿': {
    ...
    detailedDescription: '老鼠掌握更酷的技巧，经过冰面或冰块命中后获得短暂**加速**。“身轻若健燕，潇洒若游龙，翩若惊鸿，婉若游龙。',
    levels: [      { level: 1, description: '获得**小幅**加速。'},
  ...
  '逃窜': {
    ...
    // detailedDescription: '',
    levels: [      { level: 1, description: '效果持续**8秒**。'},
  ...
  '闭门羹': {
    ...
    levels: [      { level: 1, description: '加速持续**4.5秒**。'},
  ...
  '夹不住我': {
    ...
    detailedDescription: '增加挣脱捕鼠夹速度；每次挣脱捕鼠夹后（自起排夹不算），下次挣脱捕鼠夹将会**更快**，最多叠加3层。',
    levels: [      { level: 1, description: '每层提升**12%**挣脱速度。'},
  ...
  '孤军奋战': {
    ...
    // detailedDescription: '',
    levels: [      { level: 1, description: '移速提升**3%**。'},
  ...
  '求生欲': {
    ...
    detailedDescription: '拥有强烈求生欲的老鼠，当同一房间内没有其他老鼠时，在猫爪和火箭上的挣扎速度**提升**。',
    levels: [
