  ...
  航海士杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '放置一个{火炮}。老鼠可通过交互键进入火炮（交互动作时长1秒），通过拖拽投掷键选择方向发射自身，无视部分平台阻挡，碰到敌方会[反弹](速度不变，方向遵循反射定律且反射面必定为竖直面)并对其造成[50](基础伤害50，受被发射者的攻击增伤影响，视作被发射者造成的伤害。例如航海士杰瑞自己使用时会造成70伤害)伤害与1.5秒眩晕，碰到绑在火箭上的队友时自动进行救援交互，碰到地面或跳跃时结束被发射状态。火炮内不会被投掷道具及部分技能命中。若火炮内老鼠进入虚弱，则火炮会提前消失。同一房间最多出现两个火炮。火炮持续数秒后消失。火炮会在小地图上全程暴露位置。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        // cancelableSkill: '不确定是否可被打断', // FIXME
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '可存储2个仙人掌，且减速和伤害效果加强。被踩中后会分裂为3个效果稍弱的{小仙人掌}。',
            cooldown: 18,
            detailedDescription:
              '可存储2个仙人掌，效果提升至20%减速、10/s的伤害，[持续5s](只造成四次伤害)。{大仙人掌}被踩中后会分裂为3个{小仙人掌}，猫咪踩中受到0.8秒的硬直、13%减速、7.5/s的伤害，[持续3s](只造成两次伤害)；减速最多叠加三层；小仙人掌的减速与持续伤害与大仙人掌独立计算，同时小仙人掌继承大仙人掌的持续时间。小仙人掌被鼠方踩踏两次后消失，大仙人掌老鼠踩一次就会分裂。',
          },
          {
            level: 3,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '技能可储存2次；持续时间提高到15秒，友方[站上藤蔓平台](离开再重新回到平台/在平台和平台边缘间来回走动也能触发回复，并刷新持续恢复的持续时间)立刻回复27Hp并获得8Hp/秒的恢复效果，持续3秒。该效果结束后有5秒内置CD。',
            cooldown: 15,
          },
          {
            level: 3,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '召唤{魔镜}。魔镜[存在60秒](可同时存在多个)。[所有角色](包括敌方角色)均可与魔镜交互，消耗三颗星星获得随机道具、或[消耗六颗星星传送至任意房间](进入传送界面即扣除星星，取消传送不返还星星)。使用魔镜不能借用队友的星星。\n一、二级道具概率：{盘子}或{碗}:20%、{高尔夫球}:15%、{胡椒瓶}:15%、{香水瓶}:10%、{冰块}:10%、{遥控器}:10%、{苍蝇拍}:10%、{老鼠夹}:5%、{神秘饮料}:4%、{奶酪}:1%。\n三级道具概率：{盘子}或{碗}:10%(↓)、{高尔夫球}:15%、{胡椒瓶}:15%、{香水瓶}:10%、{冰块}:10%、{遥控器}:10%、{苍蝇拍}:5%(↓)、{老鼠夹}:5%(↓)、{神秘饮料}:5%(↑)、{奶酪}:1%、{鞭炮束}:5%(+)、{狗骨头}:5%(+)、Lv.3{火药桶}或{花洒}或{披萨}（[有特殊阵营归属](召唤的火药桶和花洒属于中立衍生物，会对双方造成同等效果；由仙女鼠召唤的披萨属于仙女鼠的衍生物，只会撞击敌方角色)）:4%(+)。', //ToDo: 修正以上概率数据（取自梦回视频）
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键*', '跳跃键'],
        canHitInPipe: false,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '被绑上15秒以下的火箭后，火箭引线会返回到15秒。被放飞后以“局外人”返场，Hp上限为624，且Hp以2/秒的速度降低，无法进行大部分交互，无法受到治疗，Hp清零时立即被放飞。返场期间可以用道具键投掷{柠檬}（造成2.5伤害并在2.5秒内降低10%移速，可触发[投掷效果](指的是以投掷命中为条件的效果，包括知识卡-缴械/精准投射/投手/追风，特技-干扰投掷/勇气投掷)）。与{库博}-{虚幻梦影}的天堂火箭[有特殊互动关系](表演者•杰瑞在只被绑上天堂火箭的时候不能触发复活，但如果表演者•杰瑞既被绑上天堂火箭又被绑上了普通火箭，那么引线燃烧完后仍然能触发复活)。',
          },
        ],
      },
    ],
    ...
    skills: [
      {
        ...
        detailedDescription:
          '莱恩扔出{蓝图(投射物)(衍生物)}，碰到敌方/平台/地面（不包括{方块}/{强化方块}）、或莱恩再次使用本技能时，[展开](蓝图的贴图需要一小段时间才能完全展开，该动画期间莱恩无法使用技能收回蓝图，但蓝图效果在未完全展开时就已经生效)一个大小1000×666的{蓝图(召唤物)(衍生物)}。接触蓝图(召唤物)的{火箭}变为{线条火箭}（燃烧速度减半），猫咪[隐身状态暂时失效](离开蓝图时恢复)且受到伤害时会短暂变为线条猫，持续8秒，变身结束后20秒内{免疫线条猫效果}，并使手中老鼠掉落。再次使用技能或持续较长时间后收回蓝图，蓝图收起后才会进入CD。\n线条猫：只可使用移动、跳跃和爪刀，但受到的伤害、爪刀CD、受控时间、虚弱时间减半。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        forecast: 0.6,
        aftercast: 0.5,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '提高强化图形持续时间；技能可多储存一次。',
            cooldown: 8,
            detailedDescription:
              '提高强化图形持续时间，方块60秒，圆形20秒，三角15秒；技能可多储存一次。',
          },
        ],
        cancelableAftercast: ['跳跃键', '移动键', '道具键*'],
        cueRange: '本房间可见',
  ...
  梦游杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '抛出{毛线球(衍生物)}，毛线球伸出{毛线}与自身绑定，毛线随自身移动逐渐拉长，踩到毛线的敌方会受到极少量伤害并被减速。毛线球停留一段时间自动收回，带回碰到的虚弱队友和[部分道具](包括奶酪、盘子、高尔夫球、灰花瓶、蓝花瓶、打开的老鼠夹)。被毛线球带回的奶酪碰到空洞口会自动放入；被带回的[其它道具](不包括奶酪和打开的老鼠夹)在[碰到敌方时会直接命中](除高尔夫球以外的道具会直接被碰碎，高尔夫球会持续产生碰撞，直到被毛线强制拉回)，[碰到洞口的奶酪时](除高尔夫球以外的道具会直接被碰碎，高尔夫球会在碰撞后脱离毛线球的控制)会立即增加一定奶酪推入进度。单次携带的[道具](即不包括倒地队友)数量有上限。',
        detailedDescription:
