...
const mouseCharacterDefinitions: Record<string, CharacterDefinition> = {
  ...
  杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '吹响鸟哨召唤金丝雀。金丝雀会来回盘旋，持续掉落{小鞭炮(鸟哨)}，命中敌方时爆炸，造成伤害和眩晕，且可触发[投掷效果](指的是以投掷命中为条件的效果，包括知识卡-缴械/精准投射/投手/追风，特技-干扰投掷/勇气投掷)；{小鞭炮(鸟哨)}掉落一定时间后也会自行爆炸。金丝雀轰炸一段时间后自行飞离。同一房间内最多只能有1只由鸟哨召唤的金丝雀。敌方被{小鞭炮(鸟哨)}命中并眩晕后，短暂免疫{小鞭炮(鸟哨)}效果。',
        detailedDescription:
          '在1秒前摇后吹响鸟哨，召唤金丝雀[飞到吹响鸟哨的位置](金丝雀会由地图左上角飞到目标位置，因此距离地图左上角越近，到达速度越快)，技能后摇1秒。金丝雀会[在一定范围内来回盘旋](金丝雀可穿墙)，每隔一段时间会垂直掉落一枚{小鞭炮(鸟哨)}，命中敌方时爆炸，对目标造成55伤害和2秒眩晕，且可触发[投掷效果](指的是以投掷命中为条件的效果，包括知识卡-缴械/精准投射/投手/追风，特技-干扰投掷/勇气投掷)；{小鞭炮(鸟哨)}掉落一定时间后也会自行爆炸，不造成伤害和眩晕。金丝雀轰炸一段时间后自行飞离。[同一房间内最多只能有1只由鸟哨召唤的金丝雀](以吹响鸟哨的位置判定金丝雀所属房间，即使之后金丝雀穿越墙壁飞入其他房间也不会改变所属位置。金丝雀在飞到与飞离目标位置的过程中仍然算作存在于该房间内。与金丝雀NPC分开计数)。敌方被{小鞭炮(鸟哨)}[命中并眩晕](若眩晕被敌方护盾、霸体、无敌等效果免疫，则不会触发后续免疫炸弹的效果)后，在眩晕期间及眩晕结束后1秒内免疫{小鞭炮(鸟哨)}效果。',
  ...
  泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '发射一枚{火箭筒}，命中后爆炸造成伤害和眩晕，直接命中敌方时额外造成一段伤害，且可触发[投掷效果](指的是以投掷命中为条件的效果，包括知识卡-缴械/精准投射/投手/追风，特技-干扰投掷/勇气投掷)。也可对墙缝造成伤害。爆炸产生的冲击波可以炸飞老鼠夹、叉子等道具。',
        detailedDescription:
          '发射一枚{火箭筒}，命中敌方角色/墙壁/平台/其他道具后爆炸造成伤害和眩晕，直接命中敌方时额外造成一段伤害，且可触发[投掷效果](指的是以投掷命中为条件的效果，包括知识卡-缴械/精准投射/投手/追风，特技-干扰投掷/勇气投掷)，该伤害先于爆炸伤害结算。也可对墙缝造成伤害。爆炸产生的冲击波可以炸飞老鼠夹、叉子等道具。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: '不可取消后摇',
        ...
        skillLevels: [
          {
            ...
            description: '',
            detailedDescription:
              '{火箭筒}直接命中造成{55}伤害，命中后爆炸造成{20}伤害和1.5秒爆炸眩晕。',
            cooldown: 30,
          },
          {
            level: 2,
  ...
  恶魔泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '释放小淘气们影响附近道具。\n[部分易碎道具](玻璃杯/碗/盘子/扁盘)变成蓝色小淘气：自动索敌，命中时造成伤害并使敌方3秒内无法使用技能和道具；\n[部分控制道具](灰花瓶/蓝花瓶/冰块)变成红色小淘气：可穿墙投掷，命中时向右击退敌方；\n高尔夫球变成绿色小淘气：有比高尔夫球有更大的弹性，命中敌方不会消耗黑暗印记。\n此外，小淘气还可以影响[捕鼠夹](指未打开的捕鼠夹)和奶酪；捕鼠夹受影响会立刻打开；奶酪受影响后变轻、拾取后加速、并可投掷进洞。\n所有小淘气道具均可以被猫鼠双方使用。',
        detailedDescription:
          '释放小淘气们影响附近道具。\n[部分易碎道具](玻璃杯/碗/盘子/扁盘)变成蓝色小淘气：被投掷后留在原地自动索敌，命中时造成20[基础伤害](会受攻击增伤的影响，例如被恶魔泰菲投掷时的实际伤害为35)，并使敌方3秒内无法使用技能和道具；\n[部分控制道具](灰花瓶/蓝花瓶/冰块)变成红色小淘气：[投掷轨迹为一条直线，可穿墙](无法穿越部分实体类的墙体，如地面及部分障碍物等)，命中时向右击退敌方；\n高尔夫球变成绿色小淘气：有比高尔夫球有更大的弹性，且命中敌方不会消耗黑暗印记。\n此外，小淘气还可以影响[捕鼠夹](指未打开的捕鼠夹)和奶酪；捕鼠夹受影响会立刻打开；奶酪受影响后变轻、拾取后加速、并可投掷进洞。\n所有小淘气道具均可以被猫鼠双方使用。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: ['道具键*'],
        ...
        skillLevels: [
          {
            ...
            detailedDescription:
              '每20秒自然增长一层黑暗印记；被爪刀、技能、投掷攻击时获得一层印记；绿色小淘气以外的道具投掷命中敌方时移除一层。一层印记时，移速和跳跃高度提升。',
          },
          {
            level: 2,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '朵朵为[手中部分类型的道具](包括奶酪、电球和大部分常规类投掷道具，不包括小鞭炮、鞭炮束、冰块、番茄以及其他类型的道具)充能，充能需要10.5秒，充能期间道具将[悬浮在身边](被充能的道具模型暂时消失，充能期间自身可拿取其他道具)等待充能完成，充能期间被击倒将放下手中道具；充能完成后进入5秒读条，期间点击技能可取出被充能的道具并替换手中的道具，5秒后将自动取出并替换，此时会中断当前的交互行为。处于充能状态的道具将被电流包裹，[电流独立存在](电流伤害独立于道具，且先于道具触发，控制时间不会和道具叠加，道具被丢弃时电流不会被触发)，持续时间为15秒；该道具[碰到敌方单位](奶酪除外)或地面时失去电流充能效果，并对半径150单位的敌方单位造成{40}的[电击伤害](电击伤害会使目标感电，每层感电使受到的电击伤害增加15，可叠加)和0.8秒眩晕。当充能对象为奶酪时，此块奶酪[第一次](同一块奶酪可被多次充能，但进度加成只对第一次充能有效)在[充能状态下丢入洞口](充能状态的奶酪碰到地面会失去充能，因此因惯性滑入洞口的奶酪不在此列)将直接增加25%的奶酪进度。处于过载状态时，充能速度增加100%。被充能的道具可以被再次充能，以重置电流的附着时间。该技能需要手中有能被充能的道具才能释放，反之则[释放失败](会有文字提示，但不进入CD)。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          },
          {
            level: 3,
            description:
              '手中没有道具时，使用技能会产生{电球}，电球命中会直接触发电流伤害。过载时生成的电球更大。',
            cooldown: 20,
            detailedDescription:
              '手中没有道具时，使用技能会产生{电球}，电球命中敌方造成{80}电击伤害和1.2秒眩晕效果，命中墙缝造成1.5伤害。电球可被二次充能。过载时，电球贴图被替换为大电球，除碰撞体积变大外，其余属性均不变。',
          },
        ],
        cueRange: '本房间可见',
        cooldownTiming: '释放后',
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '加装强力能源装置，获得一个电量条（满值100），随时间缓慢下降，可通过食物、药水回满电量，虚弱时会直接清空电量，从猫手上掉落或被火箭上救下将立即回复80电量。开启能源装置立刻回满电量并获得强化效果。\n根据指示灯颜色分为数个形态。\n常态-绿色指示灯：无特殊效果。\n过载状态-黄色爆闪指示灯：使用武器技能后获得，期间爆发性提高移速，提高投掷物的速度，提高攻击力，过载会加速消耗电量，消耗电量至亏电状态时自动结束过载状态，可以主动关闭。\n亏电状态-红色指示灯：电量低于30时将进入亏电状态，移动速度和跳跃速度降低，无法释放武器技能。当电量耗尽时，强制原地充能5s，恢复到80电量。',
        detailedDescription:
          '加装强力能源装置，获得一个电量条（满值100），可通过食物、药水回满电量，虚弱时会直接清空电量，从猫手上掉落或被火箭上救下将立即回复80电量。开启能源装置立刻回满电量并获得强化效果。\n根据指示灯颜色分为数个形态。\n常态-绿色指示灯：无特殊效果，电量将以0.5/s的速度下降。\n过载状态-黄色爆闪指示灯：使用武器技能后获得，立刻回满电量，期间移动速度和跳跃速度提升20%，投掷物的速度提高至2000，攻击力提高20点，充能速度增加100%，消耗电量速度提升至4.45/s（过载最大持续时间为15.85s），消耗能量至亏电状态时自动结束过载状态，可以主动关闭。\n亏电状态-红色指示灯：电量低于30时将进入亏电状态，电量将以0.5/s的速度下降，移动速度和跳跃速度降低13%，无法释放武器技能。当能量耗尽时，强制原地充能5s（5s眩晕，充电速度为20/s，充电4s，后摇1s），恢复到80电量。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '加装能源重构系统，朵朵进入虚弱时，电池将固定面朝前方飞出，前方为墙壁时将反方向弹出，当朵朵接触到电池时将解除虚弱状态，恢复少量Hp和全部电量，并向周围放电，对周围敌人造成伤害和短暂眩晕。电池可以被队友捡起和投掷，投掷命中敌方时会造成少量伤害和短暂眩晕。队友投掷电池未命中朵朵（命中猫或碰到平台、地面）将会消失。电池会存在一段时间，朵朵会在解除虚弱时重构一个电池。（电池可被牛撞没）',
            detailedDescription:
              '加装能源重构系统，朵朵进入虚弱时，电池将固定面朝前方飞出，前方为墙壁时将反方向弹出，当朵朵接触到电池时将解除虚弱状态，恢复50Hp和全部电量，并向自身半径250范围内释放电流，造成{40}伤害并眩晕0.7s。电池可以被队友捡起和投掷，投掷命中敌方时会造成{40}点伤害并眩晕0.7s。队友投掷电池未命中朵朵（命中猫或碰到平台、地面）将会消失。电池会存在12s，朵朵会在解除虚弱时重构一个电池。（电池可被牛撞没）',
            cooldown: 22,
          },
          {
            level: 3,
            description:
              '过载状态可以持续更久，开启瞬间将在近身一定范围施放电流，造成伤害和眩晕效果。',
            cooldown: 22,
            detailedDescription:
              '过载状态消耗电量降低至提升至2.44/s（过载最大持续时间提高至28.9s），开启瞬间将在自身半径250范围内释放电流，造成{60}伤害和1.5s眩晕。',
          },
        ],
        cooldownTiming: '释放后',
        cueRange: '本房间可见',
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 3,
            description:
              '当朵朵生命值降低到一定比例时，施放一次电流保护自己，造成伤害和眩晕，如果处于过载状态，还会提高眩晕时间。',
            detailedDescription:
              '当朵朵生命值降低到现血量上限的50%时，立即向自身半径250范围内释放电流，造成{40}伤害并眩晕0.9s，如果处于过载状态，还会提高眩晕时间至1.2s。',
          },
        ],
      },
    ],
    ...
    skills: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '分金符或定身符命中敌方时，推速和救援队友的速度短暂提升。',
            detailedDescription:
              '分金符或定身符命中敌方时，推速增加100%，救援队友的速度增加50%，持续5秒。',
          },
          {
            level: 3,
            description:
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 3,
            description:
              '被绑上15秒以下的火箭后，火箭引线会返回到15秒。被放飞后以“局外人”返场，Hp上限为624，且Hp以2/s降低，无法进行大部分交互，无法受到治疗，血量清零时立即被放飞。返场期间可以用道具键无限投掷柠檬，造成极少量伤害和减速。',
            detailedDescription:
              '被绑上15秒以下的火箭后，火箭引线会返回到15秒。被放飞后以“局外人”返场，Hp上限为624，且Hp以2/s降低，无法进行大部分交互，无法受到治疗，血量清零时立即被放飞。返场期间可以用道具键无限投掷柠檬，造成2.5伤害和10%减速，持续2.5秒。与库博的天堂火箭[有特殊互动关系](表演者•杰瑞在只被绑上天堂火箭的时候，不能触发复活，但如果表演者•杰瑞既被绑上天堂火箭又被绑上了普通火箭，引线燃烧完后仍然能触发复活)。',
          },
        ],
      },
    ],
  ...
  梦游杰瑞: {
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '进入梦境，期间提高推奶酪速度，受到伤害时解除此伤害带来的控制，然后在短时间内免疫虚弱并进入强制移动状态，该状态下碰到敌方会造成减速和伤害。[香甜梦境持续期间](未进入强制移动状态前)再次点按本技能键可退出梦境状态。',
        detailedDescription:
          '在前摇1.25秒后进入梦境，技能后摇1秒。梦境期间推奶酪速度增加50%，受到伤害会解除此伤害带来的控制，然后[在1.9秒内免疫虚弱并以800的速度强制移动](强制移动期间可跳跃和改变移动方向，只能通过点按“进入机械鼠”按键的方式自行取消。强制移动不会因受到伤害打断，但会被眩晕打断。若在触发受伤但未导致虚弱的伤害导致的强制移动状态期间被攻击至虚弱，则刷新持续时间。若强制移动期间因受力等原因改变速度，则会持续保持，这可能造成自身被“硬控在原地”)，强制移动时碰到敌方会对其造成20点伤害并降低20%移速，持续1.5秒。[香甜梦境持续期间](未进入强制移动状态前)再次点击技能可在1.25秒前摇后结束梦境，后摇1秒。梦境可持续40s。该技能效果先于知识卡-铁血触发。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        skillLevels: [
          {
          ...
          },
          {
            level: 2,
            description:
              '释放技能立刻恢复大量健康值。梦境期间隐藏自身在小地图上的位置，且受到可导致虚弱的伤害时，加快自身移动速度。',
            cooldown: 18,
            detailedDescription:
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '抛出毛线球，毛线球伸出毛线与自身绑定，毛线随自身移动逐渐拉长，踩到毛线的敌方会被减速。毛线球停留一段时间自动收回，带回碰到的虚弱队友和[部分道具](包括奶酪、盘子、高尔夫球、棕色花瓶、蓝花瓶、打开的老鼠夹)。被毛线球带回的奶酪碰到空洞口会自动放入；被带回的[其它道具](不包括奶酪和打开的老鼠夹)在[碰到敌方时会直接命中](除高尔夫球以外的道具会直接被碰碎，高尔夫球会持续产生碰撞，直到被毛线强制拉回)，[碰到洞口的奶酪时](除高尔夫球以外的道具会直接被碰碎，高尔夫球会在碰撞后脱离毛线球的控制)会立即增加一定奶酪推入进度。单次携带的[道具](即不包括倒地队友)数量有上限。',
        detailedDescription:
          '在前摇0.5秒后，[向上方固定角度抛出毛线球](约为自身正上方偏后5-15°左右，该角度固定，无法改变，平抛时约落在自身身后600距离；毛线球在落地前会被墙壁及敌方角色反弹)，后摇1.25秒；[毛线球伸出毛线与自身绑定，毛线随自身移动逐渐拉长](毛线球在落地前会被墙壁及敌方角色反弹，在落地后立刻与梦游杰瑞所在位置形成第一根毛线连接并打结，随后每隔一段时间以最新的打结处与梦游杰瑞实际位置为两端点形成一道连接并打结，然后若新生成的连接与上一个连接之间的夹角接近0°或180°、且上一个连接的连接对象不为毛线球、且上一个连接的长度不等于0，则清除这两道连接之间的打结，重新生成一个更长的连接。毛线球和已打结的部分不会因隐身药水隐藏)，踩到毛线的敌方会受到持续2.5s的10%减速和2.5点伤害。毛线球停留4秒后自动收回，带回碰到的虚弱队友和[部分道具](包括奶酪、盘子、高尔夫球、棕色花瓶、蓝花瓶、打开的老鼠夹)。被毛线球带回的奶酪碰到空洞口会自动放入；被带回的[其它道具](不包括奶酪)在[碰到敌方时会直接命中](除高尔夫球以外的道具会直接被碰碎，高尔夫球会持续产生碰撞，直到被毛线强制拉回)，[碰到洞口的奶酪时](除高尔夫球以外的道具会直接被碰碎，高尔夫球会在碰撞后脱离毛线球的控制)会立即将奶酪推入一部分。单次携带的[道具](即不包括倒地队友)数量有上限。\n注：若梦游杰瑞被击倒，则毛线球会立即消失，技能进入CD。若敌人在毛线球抛出环节未碰到毛线球，则在之后的收线环节时碰到毛线球时造成伤害和减速，并使毛线球损坏。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '不可被打断',
        cancelableAftercast: '不可取消后摇',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '当敌方处于眩晕或虚弱状态时，站在敌方附近并面朝敌方时将会进行嘲笑，恢复健康值并减少技能冷却时间。',
            detailedDescription:
              '当敌方处于眩晕或虚弱状态时，[站在距离敌方400的范围内并面朝敌方时将会进行嘲笑](梦游杰瑞移动时不会进行嘲笑，静止不动时面朝眩晕中的敌人自动开始嘲笑，可被跳跃及道具键打断)，动作持续1s，可恢复30健康值并减少主动和武器技能CD上限的50%。该效果有10秒CD。',
          },
          {
            level: 3,
            description: '自身被绑上的火箭的燃烧速度减少20%(该效果仅在对局120秒后生效)。',
    ...
    specialSkills: [
      {
        name: '急速翻滚',
        description: '搭配毛线球可提高搬奶酪效率。',
      },
      {
        name: '绝处逢生',
        description: '香甜梦境持续期间受到伤害带来的移速加成可拉开与敌人的距离。',
      },
    ],
    aliases: ['梦游'],
    counteredBy: [
