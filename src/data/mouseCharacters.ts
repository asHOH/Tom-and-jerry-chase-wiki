      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '[猫咪](不论是否隐身)靠近印记时，猫对所有友方暴露小地图视野，且侦探泰菲移速、跳跃速度提升。若饮料召唤出分身，将立即结束加速效果和猫咪视野暴露。',
            cooldown: 28,
            detailedDescription:
              '[猫咪](不论是否隐身)进入印记半径1250范围内时，猫对所有友方暴露小地图视野25秒，且侦探泰菲加速20%、跳跃速度提升20%，持续20秒。若饮料召唤出分身，将立即结束加速效果和猫咪视野暴露。',
          },
          {
            level: 3,
