...
const mouseCharacterDefinitions: Record<string, CharacterDefinition> = {
  ...
  泰菲: {
    ...
    counters: [
      ...
      {
        id: '如玉',
        description: '花枪反击追不上圆滚滚，并且如玉本身血量上限低，伤害也低，被绝反克制。',
        isMinor: false,
      },
    ],
    specialSkills: [
      {
        name: '魔术漂浮',
        description: '用来打卡视野漂浮落炮，或踏空骗刀落炮。',
      },
      {
        name: '绝处逢生',
      ...
      {
        name: '应急治疗',
        description: '舍己跳救圆滚滚后秒点治疗，用于续航，也可以用于防止被米特的胡椒粉毒死。',
      },
      {
        name: '干扰投掷',
        description:
    ...
    counteredBy: [
      ...
      },
      {
        id: '侍卫汤姆',
        description:
          '侍卫视野太大，远程炮被死克，并且侍卫还能用火炮一直刷盾，每打中一次就有两层盾，炮的两段伤害完全被抵消。',
        isMinor: false,
      },
      {
        id: '追风汤姆',
      ...
      },
      {
        id: '米特',
        description:
          '米特的野性叠加到7层可以一刀秒泰菲，并且当手持胡椒粉抓着老鼠时，即使被远程炮或地雷炸下来，残血队友也会被胡椒粉毒死，更不用说绑火箭的时候还有野性层数赋予的霸体，浪费了一次技能，却无收获。',
        isMinor: false,
      },
      {
        id: '塔拉',
  ...
  剑客泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '蓄力投掷长枪。蓄力期间获得远视。蓄力时间越长，投掷速度越快、距离越长。长枪对触碰的敌方造成伤害和减速。投掷后，短时间内可再次点击技能瞬移到长枪尾部跟随飞行。长枪碰到队友后，可携带1名友方进行飞行。期间剑客泰菲和友方均可通过跳跃键、道具键、药水键离开。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰色花瓶/蓝白花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪在碰到墙壁、地面、向下碰到平台时将消失。',
        detailedDescription:
          '前摇0.15s，蓄力投掷长枪。蓄力期间视野扩大到原来的2倍，同时清除原有的视野提升效果。蓄力时间越长，投掷速度越快、距离越长。蓄力至最大值需0.8s。长枪对触碰的敌方造成{60}伤害和20%减速，持续2.4s。在投掷后的1.8s内，可再次点击技能瞬移到长枪尾部跟随飞行。长枪碰到队友后，可携带1名友方进行飞行，期间剑客泰菲和友方均可通过跳跃键、道具键、药水键离开，受到眩晕或虚弱会强制离开。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰色花瓶/蓝白花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪最大存在时间为9.9s，在碰到墙壁、地面、向下碰到平台时将消失。长枪消失或剑菲上长枪后技能进入CD。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
        skillLevels: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '卡牌命中后，自身投掷的下一个[易碎道具](包括：玻璃杯/碗/盘子/扁盘/灰色花瓶/蓝白花瓶/香水瓶/胡椒瓶/冰块/番茄)命中猫咪时对其附加卡牌效果。',
            detailedDescription:
              '主动技能的卡牌命中[任意目标](包括：猫咪/兔子大表哥/森林牧场大鸭子)时，若魔术师[手中的道具](如果此时魔术师手中没有道具，则为下一个道具)是[易碎道具](包括：玻璃杯/碗/盘子/扁盘/灰色花瓶/蓝白花瓶/香水瓶/胡椒瓶/冰块/番茄)，则它被魔术师投掷命中[其他角色](包括猫咪和被冰块误伤的其他老鼠，不包括兔子大表哥等)时，额外[为该角色附加卡牌效果](卡色取决于上一次命中的卡牌；只触发卡牌效果，不会触发Lv.1被动)，[直到魔术师获得下一张卡牌](被该技能影响的道具被放下/被装入蓝白花瓶中时，效果依然存在；魔术师获得新卡牌时，上一个被该技能影响的道具的效果会被清除)；若该道具不是[易碎道具](包括：玻璃杯/碗/盘子/扁盘/灰色花瓶/蓝白花瓶/香水瓶/胡椒瓶/冰块/番茄)，则无事发生。',
          },
          {
            level: 3,
            description:
              '受到致命伤害时，有低概率消耗手中的魔术卡牌或[易碎道具](包括：玻璃杯/碗/盘子/扁盘/灰色花瓶/蓝白花瓶/香水瓶/胡椒瓶/冰块/番茄)，然后免疫当次伤害。',
            detailedDescription:
              '当魔术师即将进入虚弱状态时，若手持魔术卡牌或[易碎道具](包括：玻璃杯/碗/盘子/扁盘/灰色花瓶/蓝白花瓶/香水瓶/胡椒瓶/冰块/番茄)，则有35%的概率消耗该道具并[免疫这次虚弱](仍会受到伤害和其他效果，如受伤、减速和眩晕等)。',
          },
        ],
      },
    ],
  ...
  罗宾汉泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '释放技能0.7秒后，在[自身前方150处](若拟生成藤蔓的位置有硬性墙体阻挡，实际位置会向罗宾汉泰菲进行移动，最低距离25)生成藤蔓。藤蔓生成时先出现高1100、宽250的可攀爬区域；该区域生成1.2秒后，在其顶端生成宽为350的平台和一个[特殊大纸盒](只会开出以下8种道具：玻璃杯、碗、盘子、扁盘、灰色花瓶、高尔夫球、叉子、奶酪。携带“美食家”知识卡时，改为开出牛奶或蛋糕，与普通纸盒共计次数)。老鼠攀爬藤蔓的速度是爬普通梯子的4倍，猫咪不变。猫登上藤蔓顶端时受到1秒减速效果，在藤蔓顶端跳跃时会使藤蔓持续时间减少。',
        canMoveWhileUsing: true,
        canUseInAir: false,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: '无后摇',
  ...
  梦游杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '抛出毛线球，毛线球伸出毛线与自身绑定，毛线随自身移动逐渐拉长，踩到毛线的敌方会被减速。毛线球停留一段时间自动收回，带回碰到的虚弱队友和[部分道具](包括奶酪、盘子、高尔夫球、棕色花瓶、蓝白花瓶、打开的老鼠夹)。被毛线球带回的奶酪碰到空洞口会自动放入；被带回的[其它道具](不包括奶酪和打开的老鼠夹)在[碰到敌方时会直接命中](除高尔夫球以外的道具会直接被碰碎，高尔夫球会持续产生碰撞，直到被毛线强制拉回)，[碰到洞口的奶酪时](除高尔夫球以外的道具会直接被碰碎，高尔夫球会在碰撞后脱离毛线球的控制)会立即增加一定奶酪推入进度。单次携带的[道具](即不包括倒地队友)数量有上限。',
        detailedDescription:
          '在前摇0.5秒后，[向上方固定角度抛出毛线球](约为自身正上方偏后5-15°左右，该角度固定，无法改变，平抛时约落在自身身后600距离；毛线球在落地前会被墙壁及敌方角色反弹)，后摇1.25秒；[毛线球伸出毛线与自身绑定，毛线随自身移动逐渐拉长](毛线球在落地前会被墙壁及敌方角色反弹，在落地后立刻与梦游杰瑞所在位置形成第一根毛线连接并打结，随后每隔一段时间以最新的打结处与梦游杰瑞实际位置为两端点形成一道连接并打结，然后若新生成的连接与上一个连接之间的夹角接近0°或180°、且上一个连接的连接对象不为毛线球、且上一个连接的长度不等于0，则清除这两道连接之间的打结，重新生成一个更长的连接。毛线球和已打结的部分不会因隐身药水隐藏)，踩到毛线的敌方会受到持续2.5s的10%减速和2.5点伤害。毛线球停留4秒后自动收回，带回碰到的虚弱队友和[部分道具](包括奶酪、盘子、高尔夫球、棕色花瓶、蓝白花瓶、打开的老鼠夹)。被毛线球带回的奶酪碰到空洞口会自动放入；被带回的[其它道具](不包括奶酪)在[碰到敌方时会直接命中](除高尔夫球以外的道具会直接被碰碎，高尔夫球会持续产生碰撞，直到被毛线强制拉回)，[碰到洞口的奶酪时](除高尔夫球以外的道具会直接被碰碎，高尔夫球会在碰撞后脱离毛线球的控制)会立即将奶酪推入一部分。单次携带的[道具](即不包括倒地队友)数量有上限。\n注：若梦游杰瑞被击倒，则毛线球会立即消失，技能进入CD。若敌人在毛线球抛出环节未碰到毛线球，则在之后的收线环节时碰到毛线球时造成伤害和减速，并使毛线球损坏。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '不可被打断',
        cancelableAftercast: '不可取消后摇',
