      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '朵朵进入虚弱时，[向固定方向弹出](电池将固定面朝前上方飞出，前方为墙壁时将反方向弹出)一枚{电池}（可被朵朵碰触，解除虚弱并恢复Hp和电量，且对周围造成[电击伤害](电击伤害会使目标感电，每层感电使受到的电击伤害增加，可叠加)和眩晕；也可被其他老鼠拾取和投掷，命中敌方时破碎并造成[电击伤害](电击伤害会使目标感电，每层感电使受到的电击伤害增加，可叠加)和眩晕。电池存在一定时间后自行消失）。',
            detailedDescription:
