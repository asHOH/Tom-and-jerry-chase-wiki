    ...
    knowledgeCardGroups: [
      {
        ...
        description:
          '高风险高收益卡组，卡残血触发绝反伤害高，绝反应激相互配合，适合打Hp上限低、不带皮糙肉厚的猫',
      },
      {
      ...
      },
      {
        ...
        description:
          '这套卡也是主点被动，用于牵制救援充足的阵容，不屈加逃窜再加被动，速度快，回血快，续航稳定，增加容错，缺点是一被加Hp上限的时间较少。',
      },
    ],
    skills: [
      {
    ...
    skills: [
      {
        ...
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableAftercast: ['移动键', '跳跃键', '道具键', '药水键', '本技能键', '其他技能键'],
        forecast: 0.2,
        aftercast: 0.3,
        cooldownTiming: '释放后',
        cancelableSkill: '不可主动打断',
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '蓄力投掷{长枪}。蓄力期间获得远视。蓄力时间越长，投掷速度越快、距离越长。长枪对触碰的敌方造成伤害和减速。投掷后，短时间内可再次点击技能瞬移到长枪尾部跟随飞行。长枪碰到队友后，可携带1名友方进行飞行。期间剑客泰菲和友方均可通过跳跃键、道具键、药水键离开。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪在碰到墙壁、地面、向下碰到平台时将消失。',
        detailedDescription:
          '蓄力投掷{长枪}。蓄力期间视野扩大到原来的2倍，同时清除原有的视野提升效果。蓄力时间越长，投掷速度越快、距离越长。蓄力至最大值需0.8s。长枪对触碰的敌方造成{60}伤害和20%减速，持续2.4s。在投掷后的1.8s内，可再次点击技能瞬移到长枪尾部跟随飞行。长枪碰到队友后，可携带1名友方进行飞行，期间剑客泰菲和友方均可通过跳跃键、道具键、药水键离开，受到眩晕或虚弱会强制离开。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪最大存在时间为9.9s，在碰到墙壁、地面、向下碰到平台时将消失。长枪消失或剑菲上长枪后技能进入CD。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
        forecast: 0.15,
      ...
      },
      {
        ...
        type: 'passive',
        description:
          '勇气值机制：\n没有勇气期间不会被狗抓、禁用冲刺和头盔、勇气值自然增加；\n有勇气期间会被狗抓、解锁冲刺和头盔、攻击增伤提高、勇气值自然消耗。大多数交互行为都能增加勇气值。',
        detailedDescription:
          '勇气值机制：没有勇气期间不会被狗抓、禁用冲刺和头盔、勇气值自然增加，充满需27秒；有勇气期间会被狗抓，解锁冲刺和头盔，攻击增伤提高15，勇气值自然消耗，耗完需50秒。大多数交互行为都能增加勇气值。',
        skillLevels: [
          {
            level: 1,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '当敌方处于眩晕或虚弱状态时，[站在距离敌方400的范围内并面朝敌方时将会进行嘲笑](梦游杰瑞移动时不会进行嘲笑，静止不动时面朝眩晕中的敌人自动开始嘲笑，可被跳跃及道具键打断)，动作持续1s，可回复30Hp并减少{主动技能}和{武器技能}CD上限的50%。该效果有10秒CD。',
          },
          {
            level: 3,
