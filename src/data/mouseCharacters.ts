  ...
  天使泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '展开天使翅膀，使自身6秒内受到的伤害降低15，期间若受到来自敌方的伤害，则对其造成一次[等同于该次伤害值55%的伤害（若“该次伤害值”超过天使泰菲的剩余Hp，则对对方造成伤害改为天使泰菲剩余Hp的55%）](该伤害不受攻击增伤影响。"受到伤害"的计算时机晚于攻击者的攻击增/减伤，但早于天使泰菲的受击增/减伤，并且最终数值不会超过天使泰菲当前的Hp。{主动技能}的转移伤害没有伤害来源，因此不触发该效果)。若反弹伤害时自身的怜悯值超过25%，消耗25%怜悯值使反弹伤害额外增加。', //[本技能有争议](另一种说法：不考虑怜悯值时，消耗25变5伤害返还20，50变25伤害返还25，75变50伤害返还20，100变60伤害返还40，125直接虚弱返还50；每10％反伤5伤害)。
        canMoveWhileUsing: false,
        canUseInAir: true,
      ...
      },
      {
        ...
        description:
          '天使泰菲拥有怜悯值充能条，怜悯值会自然增加，也能在队友受到伤害时增加。怜悯值可供{主动技能}和{武器技能}消耗。',
        detailedDescription:
          '天使泰菲拥有怜悯值充能条，怜悯值会以1.5%/秒的速度自然增加，也能在同一房间内有队友受到伤害时增加（每1伤害增加0.7%怜悯值）。怜悯值可供{主动技能}和{武器技能}消耗。',
      },
    ],
    specialSkills: [
      {
