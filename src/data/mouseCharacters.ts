    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: 'CD减少至25秒；采访期间的固定移速提高、Hp恢复速度提高。',
            cooldown: 25,
          },
          {
            level: 3,
