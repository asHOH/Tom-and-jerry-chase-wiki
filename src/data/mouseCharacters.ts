    ...
    skills: [
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 2,
            description: '减少CD；对平台释放技能时回复Hp。',
            detailedDescription:
              '减少CD至8秒；对平台释放技能时回复25Hp；在平台下悬挂的最长时间提升至15秒。',
            cooldown: 8,
          },
          {
            level: 3,
            ...
            detailedDescription:
              '技能期间[免疫控制](包括隐身饮料的效果)，且[不会因受到伤害而打断技能](但是可以被某些角色技能造成的效果打断如：牛仔汤姆的牛、大型仙人掌，莱特宁的垃圾桶，追风汤姆的追风双翼、战术机动，汤姆的平底锅等)。全面加速状态最高叠加层数增加至5层。',
            cooldown: 8,
          },
        ],
        canHitInPipe: false,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '周围存在敌方时，CD倒计时速度加快。',
            detailedDescription: '周围存在敌方时，CD倒计时速度加快。（该数据待补充）',
          },
        ],
      },
    ],
  ...
  朵朵: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '加装强力能源装置，获得一个[电量条](电量上限100，获得电量条时电量为100)，随时间缓慢下降，虚弱时会直接清空电量；可通过食物、药水和被{仙女鼠}1星击中回复100电量，从猫手上掉落或从火箭上被救下回复80电量。\n电量条有三种颜色，对应以下三个形态：\n常态-绿色指示灯：无特殊效果。\n过载状态-黄色爆闪指示灯：开启本技能时立刻回复100电量并进入过载状态，再次使用可关闭并退出该状态。爆发性提高移速、跳跃速度、攻击增伤和投掷物的速度，但会加速消耗电量，电量小于30时自动结束过载状态。\n亏电状态-红色指示灯：电量低于30时将进入亏电状态。移速和跳跃速度降低，且无法释放本技能。当电量归零时，[强制原地充能5秒](无法进行移动、交互、使用道具和技能等操作)，恢复到80电量。',
        detailedDescription:
          '加装强力能源装置，获得一个[电量条](电量上限100，获得电量条时电量为100)，电量以0.5/秒的速度下降，虚弱时会直接清空电量；可通过食物、药水和被{仙女鼠}1星击中回复100电量，从猫手上掉落或被火箭上救下回复80电量。\n电量条有三种颜色，对应以下三个形态：\n常态-绿色指示灯：无特殊效果。\n过载状态-黄色爆闪指示灯：开启本技能时立刻回复100电量并进入过载状态，再次使用本技能可以主动关闭技能退出过载状态。期间移速和跳跃速度提高20%，攻击增伤提高20，投掷物被投掷时的初速度提高至2000，主动技能的充能速度增加100%，但消耗电量速度大幅提高，电量小于30时自动结束过载状态。\n亏电状态-红色指示灯：电量低于30时将进入亏电状态。移速和跳跃速度降低13%，且无法释放本技能。当电量归零时，[强制原地充能5秒](无法进行移动、交互、使用道具和技能等操作，同时以20/秒的速度恢复电量，持续4秒，结束后进入1秒动作后摇；过程中电量值回满不会提前结束此动作），恢复到80电量。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
