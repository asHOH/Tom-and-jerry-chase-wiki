    ...
    skills: [
      {
        ...
        detailedDescription:
          '前摇1.5s，召唤魔镜，后摇0.32s。魔镜处可消耗三星获得随机道具、消耗六星传送至任意房间（进入传送界面即扣除星星，取消传送不返还星星）（猫咪也可用魔镜）。\n一、二级出道具概率:易碎道具:20%、胡椒粉:15% 、高尔夫球:15%、香水瓶:10%、遥控器:10%、苍蝇拍:10% 、冰块:10%、捕鼠夹:5%、药水:4%、奶酪:1%。\n三级出道具概率：高尔夫球:15%(0)、胡椒粉:15%(0)、易碎道具:10%(↓)、香水瓶:10%(0)、冰块:10%(0)、遥控器:10%(0)、苍蝇拍:5%(↓)、鞭炮束:5%(+)、狗骨头:5%、捕鼠夹:5%(↓)、神秘药水:5%(↑)、[技能产物](包括拿破里的饼和饼的碎片、海盗炸药桶、花洒（可以治疗猫）):4%(+)、奶酪:1%(0)。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键*', '跳跃键'],
        canHitInPipe: false,
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '消耗一定数量的星星来投掷可穿墙的星星，并对命中者施加对应的效果：\n1星：队友隐身；减少猫咪Hp和移速\n2星：队友获得二段跳效果；猫咪同1星\n4星：队友缓慢恢复Hp；猫咪同1星\n6星：队友变为小星星，免疫虚弱和眩晕；猫咪同1星\n8星：对队友无效；猫咪变为大星星、手上的老鼠掉落\n星星的获取方式：\n老鼠：主要为投掷或技能命中猫咪；仙女鼠拥有本技能时额外自动获取星星\n猫咪：每次对老鼠造成伤害最多夺取3颗\n每个角色最多存储9颗星星；当仙女鼠附近半径1800范围内有队友时，仙女鼠可以[借用队友的星星](有借无还)。',
        detailedDescription:
          '前摇0.32s，消耗一定数量的星星来投掷可穿墙的[星星](飞行速度2000)，后摇0.15s，并对命中者施加对应的效果：\n1星：队友隐身3s；对猫咪造成[20伤害](无法被护盾、无敌抵消)，减速17%\n2星：队友获得二段跳效果，持续5s；猫咪同1星\n4星：队友回复10Hp，并持续回血8s，每秒7.5Hp；猫咪同1星\n6星：队友变为小星星，持续5.9s，命中时[解除并免疫虚弱和眩晕](不免疫剑汤挑起)，小星星移速665，可使用星星翻滚，CD为2s，向前方滚动1.3s，期间移速增加50%；猫咪同1星\n8星：对队友无效；猫咪[变为大星星](不会取消苏蕊跳舞、恶魔汤姆打碟)，持续8s，命中时解除并免疫虚弱和眩晕、手上的老鼠掉落。大星星移速为725，可[吐出小星星](前摇0.3s，不可移动、不可取消；CD为1s，最多存储3发)，小星星飞行速度为2000，会对老鼠造成[20点伤害](无法被护盾、无敌抵消)和10%减速，持续2s，大星星拥有爪刀，爪刀判定范围与附加效果不受影响。\n星星的获取方式：\n老鼠：推入奶酪、投掷命中、击倒猫咪、[救下队友](包括被猫抓住和被绑上火箭的队友)；仙女鼠拥有本技能时额外自动获取星星\n猫咪：每次对老鼠造成伤害最多夺取3颗\n每个角色最多存储9颗星星；当仙女鼠附近半径1800范围内有队友时，仙女鼠可以[借用队友的星星](有借无还)。', //FIXME：有盾但空血的时候吃小星星会不会被打死；有无免疫小星星的例外;老鼠星星获得机制目前的文本肯定是不对的，听说是对猫造成负面效果就能得到星星;借星星的机制，如果有多个人可以借，优先借谁的
        canMoveWhileUsing: true,
        canUseInAir: true,
        ...
        skillLevels: [
          {
            level: 1,
            description: '自身星星额外以每7秒一颗的速度增长。', //FIXME
            cooldown: 8,
          },
          {
            level: 2,
