  ...
  恶魔泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '释放小淘气们影响附近道具。\n易碎道具变成蓝色小淘气：自动索敌，命中时造成伤害并使敌方3秒内无法使用技能和道具；\n控制道具变成红色小淘气：可穿墙投掷，命中时向右击退敌方；\n高尔夫球变成绿色小淘气：有比高尔夫球有更大的弹性，命中敌方不会消耗黑暗印记。\n此外，小淘气还可以影响[捕鼠夹](指未打开的捕鼠夹)和奶酪；捕鼠夹受影响会立刻打开；奶酪受影响后变轻、拾取后加速、并可投掷进洞。\n所有小淘气道具均可以被猫鼠双方使用。',
        detailedDescription:
          '释放小淘气们影响附近道具。\n易碎道具变成蓝色小淘气：被投掷后留在原地自动索敌，命中时造成20[基础伤害](会受攻击增伤的影响，例如被恶魔泰菲投掷时的实际伤害为35)，并使敌方3秒内无法使用技能和道具；\n控制道具变成红色小淘气：[投掷轨迹为一条直线，可穿墙](无法穿越部分实体类的墙体，如地面及部分障碍物等)，命中时向右击退敌方；\n高尔夫球变成绿色小淘气：有比高尔夫球有更大的弹性，且命中敌方不会消耗黑暗印记。\n此外，小淘气还可以影响[捕鼠夹](指未打开的捕鼠夹)和奶酪；捕鼠夹受影响会立刻打开；奶酪受影响后变轻、拾取后加速、并可投掷进洞。\n所有小淘气道具均可以被猫鼠双方使用。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: ['道具键*'],
