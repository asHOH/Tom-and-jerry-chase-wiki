    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '获得一枚{金币(道具)}（能穿过大部分平台，命中敌方造成眩晕，被命中的敌方短暂免疫该道具效果）。获得金币时会替换并掉落手中的其他道具。',
        detailedDescription:
          '获得一枚{金币(道具)}（能穿过大部分平台，命中敌方造成2秒眩晕，但被命中的敌方[在眩晕期间及眩晕结束后1秒内](若眩晕被敌方护盾、霸体、无敌等效果免疫，则不会触发后续免疫效果)免疫该道具效果）。获得金币时会替换并掉落手中的其他道具，金币不会因虚弱而从手中掉落。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
        skillLevels: [
          ...
          {
            level: 3,
            description: '金币命中敌方会连续造成两段伤害和眩晕，但猫咪每次只会受到一段伤害。',
            detailedDescription:
              '金币命中敌方会连续造成两段{55}伤害和眩晕，但猫咪每次只会受到一段伤害（或只能击破一层护盾）。',
            cooldown: 15,
          },
        ],
      },
      {
        ...
        detailedDescription:
          '放置一个火药桶，延迟数秒后爆炸，对周围造成不分敌我的伤害和眩晕，[对墙缝造成伤害](会直接炸毁墙缝上的泡泡，且仍造成全额伤害)，并[炸毁范围内的火箭](猫咪在绑老鼠前需要先修复火箭；火药桶的下端判定相对较大)，若其上有老鼠则[将其救下](视作航海士杰瑞进行的救援，可触发知识卡-无畏/舍己等)。猫咪可以[通过交互拆除火药桶](动作时长1秒)，老鼠可以通过交互推动火药桶。火药桶被部分其他道具命中时，引爆时间缩短5秒。\n火药桶与其他道具的互动关系：火药桶可被{小鞭炮}或{鞭炮束}炸飞，在火药桶左侧的鞭炮会使火药桶呈抛物线飞出，右侧的鞭炮会使火药桶水平滑行。使用特定道具斜向下45°打击桶外侧可使桶产生横向加速，其中{扁盘}产生的加速较大，约为{玻璃杯}的两倍。未引爆的鞭炮也可以使桶位移，且不会缩短引线。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        detailedDescription:
          '莱恩在0.6秒前摇后扔出{蓝图(道具)}，同时技能进入读条；蓝图飞行期间，碰到敌方/平台/墙体、或莱恩再次使用本技能时[展开](蓝图的贴图需要一小段时间才能完全展开，该动画期间莱恩无法使用技能收回蓝图，但蓝图效果在未完全展开时就已经生效)一个[蓝图(场景物)](大小1000×666)，动作后摇0.5秒。蓝图内的火箭燃烧速度减半；隐身的猫咪会[暂时显形](隐身效果在离开蓝图时依然存在)；在蓝图内受到伤害的猫咪会变为线条猫，并使手中老鼠掉落，线条猫状态持续8秒，变身结束后20秒内不会再次变为线条猫。同一时间只可存在一个蓝图。再次使用技能或较长时间后收回蓝图，蓝图收起后才会进入CD。\n线条猫：只可使用移动、跳跃和爪刀，但受到的伤害、爪刀CD、受控时间、虚弱时间减半。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: '不可取消后摇',
        skillLevels: [
          ...
          {
            level: 3,
            description: '扔出的蓝图命中猫咪时会使其直接变成线条猫。',
            cooldown: 25,
          },
        ],
        cancelableSkill: '不可被打断',
  ...
  梦游杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '抛出{毛线球}，毛线球伸出毛线与自身绑定，毛线随自身移动逐渐拉长，踩到毛线的敌方会被减速。毛线球停留一段时间自动收回，带回碰到的虚弱队友和[部分道具](包括奶酪、盘子、高尔夫球、灰花瓶、蓝花瓶、打开的老鼠夹)。被毛线球带回的奶酪碰到空洞口会自动放入；被带回的[其它道具](不包括奶酪和打开的老鼠夹)在[碰到敌方时会直接命中](除高尔夫球以外的道具会直接被碰碎，高尔夫球会持续产生碰撞，直到被毛线强制拉回)，[碰到洞口的奶酪时](除高尔夫球以外的道具会直接被碰碎，高尔夫球会在碰撞后脱离毛线球的控制)会立即增加一定奶酪推入进度。单次携带的[道具](即不包括倒地队友)数量有上限。',
        detailedDescription:
          '在前摇0.5秒后，[向上方固定角度](约为自身正上方偏后5-15°左右，该角度固定，无法改变，平抛时约落在自身身后600距离)抛出{毛线球}，后摇1.25秒；[毛线球伸出毛线与自身绑定，毛线随自身移动逐渐拉长](毛线球在落地前会被墙壁及敌方角色反弹，在落地后立刻与梦游杰瑞所在位置形成第一根毛线连接并打结，随后每隔一段时间以最新的打结处与梦游杰瑞实际位置为两端点形成一道连接并打结，然后若新生成的连接与上一个连接之间的夹角接近0°或180°、且上一个连接的连接对象不为毛线球、且上一个连接的长度不等于0，则清除这两道连接之间的打结，重新生成一个更长的连接。毛线球和已打结的部分不会因隐身药水隐藏)，踩到毛线的敌方会受到2.5伤害并在2.5秒内降低10%移速。毛线球停留4秒后自动收回，带回碰到的虚弱队友和[部分道具](包括奶酪、盘子、高尔夫球、灰花瓶、蓝花瓶、打开的老鼠夹)。被毛线球带回的奶酪碰到空洞口会自动放入；被带回的[其它道具](不包括奶酪)在[碰到敌方时会直接命中](除高尔夫球以外的道具会直接被碰碎，高尔夫球会持续产生碰撞，直到被毛线强制拉回)，[碰到洞口的奶酪时](除高尔夫球以外的道具会直接被碰碎，高尔夫球会在碰撞后脱离毛线球的控制)会立即将奶酪推入一部分。单次携带的[道具](即不包括倒地队友)数量有上限。若梦游杰瑞被击倒，则毛线球会立即消失，技能进入CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '不可被打断',
        cancelableAftercast: '不可取消后摇',
