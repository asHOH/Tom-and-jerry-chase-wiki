  ...
  剑客泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '举起头盔保护自己和队友，期间无敌，但惯性增大、移速降低3.5%、跳跃速度降低15%；小范围内的队友也无敌，但不能使用技能。头盔[受击](包括爪刀、道具、技能、来自友方的伤害)会减少0.5s；救下队友后头盔剩余时间减半。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        canHitInPipe: false,
        cancelableAftercast: '无后摇',
    ...
    skills: [
      {
        ...
        detailedDescription:
          '莱恩扔出{蓝图(投射物)(衍生物)}，碰到敌方/平台/地面（不包括{方块}/{强化方块}）、或莱恩再次使用本技能时，[展开](蓝图的贴图需要一小段时间才能完全展开，该动画期间莱恩无法使用技能收回蓝图，但蓝图效果在未完全展开时就已经生效)一个大小1000×666的{蓝图(召唤物)(衍生物)}。接触蓝图(召唤物)的{火箭}变为{线条火箭}（燃烧速度减半），猫咪[隐身状态暂时失效](离开蓝图时恢复)且受到伤害时会短暂变为线条猫，持续8秒（变身结束后20秒内不会再次变为线条猫），并使手中老鼠掉落。再次使用技能或持续较长时间后收回蓝图，蓝图收起后才会进入CD。\n线条猫：只可使用移动、跳跃和爪刀，但受到的伤害、爪刀CD、受控时间、虚弱时间减半。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        forecast: 0.6,
        aftercast: 0.5,
