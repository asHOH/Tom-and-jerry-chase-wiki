    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 1.5,
            detailedDescription:
              '冲刺将造成减速，持续4.8s，在减速期间再次命中将[叠加](覆盖原有减速效果)：第一层4.5%，第二层9%，第三层13.5%，第四层18%。该减速期间内击中猫咪5次后，使猫咪眩晕2.8s并受到额外的{50}伤害（受减伤机制影响后为40），同时清除减速效果。',
          },
          {
            level: 3,
            ...
            cooldown: 1.5,
            detailedDescription:
              '冲刺将造成减速，持续4.8s，在减速期间再次命中将[叠加](覆盖原有减速效果)：第一层4.5%，第二层9%。该减速期间内击中猫咪3次后，使猫咪眩晕2.8s并受到额外的{50}伤害（受减伤机制影响后为40），同时清除减速效果。',
          },
        ],
      },
      {
