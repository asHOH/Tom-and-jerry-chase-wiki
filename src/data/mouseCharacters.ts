  ...
  天使杰瑞: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '点按技能射出一发{弓箭}，命中友方为其回复一定Hp并提高移速；命中敌方造成伤害。长按技能开始蓄力，蓄力满射出一发大弓箭，命中友方为其回复更多Hp并提高移速，命中敌方造成更高伤害和眩晕。中途可以取消释放，会返还一半CD。',
        detailedDescription:
          '点按技能射出一发{弓箭}，命中友方为其回复25Hp且移速提高10%，持续1.6秒；命中敌方造成{30}伤害。长按技能开始蓄力，蓄力至少1.83秒后可以射出一发大弓箭，命中友方为其回复50Hp和1.6秒的5%加速；命中敌方造成{55}伤害和1.4秒[眩晕](无视苏蕊的跳舞，但不打断跳舞或队友的跟随；无视天使汤姆二级被动的霸体，且可救下队友)。点按可以在空中射出，但蓄力弓箭无法在空中射出。射箭时天使可以调整[出射角度](约上下15度)。射出后的弓箭飞行[无视地形](平台，地板，天花板均不会影响；经典之家的厨房挡板除外)，直到击中其他角色或森林牧场大鸭子。弓箭射出方向为出射时所按的方向键，若未按则为拉弓时角色朝向。弓箭受到重力，但[速度大小不变，只改变方向](不受外力时，箭的竖直速度逐渐增大而水平速度逐渐减小，并非严格的抛物线)。弓箭可被鞭炮影响而改变飞行轨迹。中途可以取消释放，会返还一半CD。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 12,
            detailedDescription:
              '普通弓箭伤害提高为{55}，蓄力箭提高为{105}；普通弓箭对友方治疗效果提高为50，蓄力箭提高为99。蓄力箭命中虚弱友方老鼠会解除其虚弱状态。',
          },
        ],
      },
      {
