    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            level: 2,
            description:
              '弹射期间获得弱霸体，对猫咪不再造成减速，而是眩晕。猫咪在4秒内不会重复受到该技能的伤害和控制。',
            detailedDescription:
              '弹射期间获得弱霸体，对猫咪不再造成减速，而是2秒眩晕，可击落手中的道具，但不击落手中的老鼠。猫咪在眩晕期间和结束后的4秒内不会重复受到该技能的伤害和控制。',
            cooldown: 7,
          },
          {
            level: 3,
