  ...
  仙女鼠: {
    ...
    skills: [
      ...
      },
      {
        ...
        detailedDescription:
          '前摇0.32s，消耗一定数量的星星来投掷可穿墙的[星星](飞行速度2000)，后摇0.15s，并对命中者施加对应的效果：\n1星：队友隐身3s；对猫咪造成[20伤害](无法被护盾、无敌抵消（例外：如果该伤害将导致虚弱，则不会进入虚弱，而是破盾并保留0Hp）)，减速17%\n2星：队友获得二段跳效果，持续5s；猫咪同1星\n4星：队友回复10Hp，并持续回血8s，每秒7.5Hp；猫咪同1星\n6星：队友变为小星星，持续5.9s，命中时[解除并免疫虚弱和眩晕](不免疫剑汤挑起)，小星星移速665，可使用星星翻滚，CD为2s，向前方滚动1.3s，期间移速增加50%；猫咪同1星\n8星：对队友无效；猫咪[变为大星星](不会取消苏蕊跳舞、恶魔汤姆打碟)，持续8s，命中时解除并免疫虚弱和眩晕、手上的老鼠掉落。大星星移速为725，可[吐出小星星](前摇0.3s，不可移动、不可取消；CD为1s，最多存储3发)，小星星飞行速度为2000，会对老鼠造成[20点伤害](无法被护盾、无敌抵消（例外：如果该伤害将导致虚弱，则不会进入虚弱，而是破盾并保留0Hp）)和10%减速，持续2s，大星星拥有爪刀，爪刀判定范围与附加效果不受影响。\n星星的获取方式：\n老鼠：对猫咪造成负面效果、推入奶酪、[救下队友](包括被猫抓住和被绑上火箭的队友)；仙女鼠拥有本技能时额外自动获取星星\n猫咪：每次对老鼠造成伤害最多夺取3颗\n每个角色最多存储9颗星星；当仙女鼠半径1800范围内有队友时，可以[借用队友的星星](有借无还；先用队友的星星；如果有多个队友，则先借最近队友的星星)。',
        canMoveWhileUsing: true,
        canUseInAir: true,
