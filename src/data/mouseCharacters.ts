  ...
  侦探杰瑞: {
    ...
    skills: [
      ...
      },
      {
        name: '烟雾弹',
        type: 'weapon1',
        description: '引爆烟雾弹产生{烟雾}遮挡猫的视野。在烟雾中猫咪无法查看小地图。',
        detailedDescription:
          '引爆烟雾弹产生{烟雾}遮挡猫的视野。在烟雾中猫咪无法查看小地图。此效果可以被一层护盾抵消。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: '不可主动打断',
        cancelableAftercast: '不可取消',
      ...
      },
      {
        name: '视觉干扰器',
        type: 'weapon2',
        description: '投掷{干扰器}，落地后对范围内的老鼠施加短暂的隐身效果。',
        detailedDescription:
          '投掷{干扰器}，落地或碰到墙壁后对范围内的老鼠施加3.5秒隐身效果。[干扰器在技能触发后会持续存在1秒](仅有贴图作用)。',
        forecast: 0.3,
        canMoveWhileUsing: true,
        canUseInAir: true,
    ...
    skills: [
      {
        ...
        detailedDescription:
          '全体队友短暂[获得二段跳状态](可被部分免疫状态的效果免疫，例如自身的降落伞降落期间)（加速10%，且可在空中[进行1次额外跳跃](从上一次接触平台/地面起，至多进行2次跳跃，再次接触平台/地面时重置。多个额外跳跃效果取次数最高的生效)）。不同等级二段跳提供的移速加成可叠加。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '无后摇',
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 25,
            detailedDescription: '二段跳持续时间增加至6.45秒。',
          },
          {
            level: 3,
            ...
            cooldown: 25,
            detailedDescription:
              '二段跳状态额外使跳跃高度提高12.5%。自身在[二段跳状态](包括因其他罗宾汉杰瑞技能而获得的二段跳状态)下改为可在空中[进行2次额外跳跃](从上一次接触平台/地面起，至多进行3次跳跃，再次接触平台/地面时重置。多个额外跳跃效果取次数最高的生效)。',
          },
        ],
        cooldownTiming: '释放时',
      },
      {
        ...
        type: 'weapon1',
        description:
          '打开降落伞，从高处落下不受到任何阻碍，[期间免疫大部分效果](包括绝大多数负面和正面效果)，可随时跳跃取消。若落地则进入后摇。',
        detailedDescription:
          '打开降落伞，[重置自身竖直方向的初速度为向上的100](因此会向上飘一小段距离)，并获得使重力加速度变为1000/秒²的[失重状态](失重：改变重力加速度的值。通常认为正常重力环境下重力加速度为3000/秒²，角色合速度上限为2000/秒)；降落期间无视所有平台，且[免疫大部分效果](包括绝大多数负面和正面效果，如二段跳，干扰器隐身；部分“接触地面时”延迟触发的效果除外，如平底锅的落地伤害和眩晕、Lv.3魅力甲油的使敌方粘在地板上的效果)，接触地面后进入0.65秒不可取消的后摇；降落过程中可随时[进行1次额外跳跃](该跳跃属于技能效果，额外跳跃不受跳跃次数的限制，但仍记为一次跳跃（例如在二段跳情况下可通过普通跳跃+降落伞跳跃进行二段跳，但此时无法再通过二段跳效果进行三段跳；反之若通过普通跳跃+二段跳跳跃进行二段跳，那仍可通过降落伞效果进行三段跳）)，{绝处逢生}也可终止技能。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: '无前摇',
        cancelableAftercast: '不可取消',
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 10,
            detailedDescription: '降落伞状态结束后，自身移速和救援速度提高20%，持续3秒。',
          },
          {
            level: 3,
            description: '',
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '只有在[接触平台](包括已接触但未站立在其上的平台)或墙壁时才能使用飞镐。\n对平台释放：[尝试翻越并悬挂在平台下方](只要平台不贴地即可出现翻越效果，但未必能挂住)。悬挂期间可快速[左右移动](若超过平台范围则掉落)，同时逐渐叠加全面加速状态（移速、跳跃速度、救援速度、推速短暂提高，可叠加），悬挂期间可点击特殊技能主动取消，也可跳跃打断，跳跃打断将获得短时间的免疫碎片和老鼠夹的效果，同时小幅提高救援速度。\n对墙壁释放：短暂悬挂在墙壁上。\n悬挂期间可手持道具和喝饮料；如果手上有奶酪，则奶酪会掉落；获得变身效果会结束悬挂。',
        detailedDescription:
          '只有在[接触可翻越平台](包括已接触但未站立在其上的平台——以这种方式触发则不会有翻越平台的过渡时间)或竖直墙壁时才能使用飞镐。\n对平台释放：[尝试翻越到并悬挂在平台下方](只要平台不贴地即可出现翻越效果，但未必能挂住)，持续一段时间。悬挂期间可快速[左右移动](若超过平台范围则掉落)，可使用二段跳和除{魔术漂浮}以外的特技；同时[每1.5秒](进入悬挂状态时立刻触发，此后每1.5秒再触发一次)增加一层全面加速状态（移速提高10%、跳跃速度提高18%、救援速度提高11.5%、推速提高25%，持续3.75秒。除跳跃加成外的其余加成均可乘算叠加，最多叠加数层）；悬挂期间可点击特殊技能主动取消，也可跳跃打断，跳跃打断将获得免疫碎片和老鼠夹的效果，且救援速度提高6%，持续2.9秒，受到眩晕将掉落；悬挂有0.15秒后摇，若使用道具键解除后摇，或[无法进行悬挂](当两个平台距离过近时，会导致悬挂在第一个平台下时被第二个平台挤压，这种情况无法悬挂)，则会[直接解除技能](根据平台的穿越所需时间，可能出现穿越平台或仍在平台上方两种结果)，不进行悬挂，仍会触发获得全面加速效果及Lv.2的回复效果。\n对墙壁释放：悬挂在墙壁上，持续2秒，无后摇。\n悬挂期间可手持道具和喝饮料；如果手上有奶酪，则奶酪会掉落；获得变身效果会结束悬挂。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        skillLevels: [
          {
          ...
          },
          {
            level: 3,
            description:
              '技能期间免疫控制，且不会因受到伤害而打断技能。全面加速状态改为最多叠加5层。',
            detailedDescription:
              '技能期间[免疫控制](包括隐身饮料的效果)，且[不会因受到伤害而打断技能](但是可以被某些角色技能造成的效果打断如：牛仔汤姆的牛、大型仙人掌，莱特宁的垃圾桶，追风汤姆的追风双翼、战术机动，汤姆的平底锅等)。全面加速状态改为最多叠加5层。',
            cooldown: 8,
            charges: 3,
          },
        ],
      ...
      },
      {
        ...
        skillLevels: [
          ...
          {
            level: 3,
            description: '附近有敌方角色时，自身CD倒计时速度加快。',
            detailedDescription:
              '附近1000范围内有敌方角色时，自身[CD倒计时速度加快33%](效果触发时，技能键上CD的显示值不变，但减少1秒CD所需的实际时间变为0.75秒)。',
          },
        ],
      },
    ],
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '拿出一枚{金币(衍生物)}（能穿过大部分平台，命中敌方造成眩晕，被命中的敌方短暂免疫该道具效果）。获得金币时会替换并掉落手中的其他道具。',
        detailedDescription:
          '拿出一枚{金币(衍生物)}（能穿过大部分平台，命中敌方造成2秒眩晕，但被命中的敌方[在眩晕期间及眩晕结束后1秒内](若眩晕被敌方护盾、霸体、无敌等效果免疫，则不会触发后续免疫效果)免疫该道具效果）。获得金币时会替换并掉落手中的其他道具，金币不会因虚弱而从手中掉落。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        aliases: ['桶', '炸药桶'],
        description:
          '放置一个{火药桶(衍生物)}，延迟数秒后爆炸，对周围造成不分敌我的伤害和眩晕，对墙缝造成伤害，并[炸毁范围内的火箭](猫咪在绑老鼠前需要先修复火箭)。猫咪可以通过交互拆除火药桶，老鼠可以通过交互推动火药桶。火药桶被部分其他道具命中时缩短引爆时间。',
        detailedDescription:
          '放置一个{火药桶(衍生物)}，延迟数秒后爆炸，对周围造成不分敌我的[伤害](对其他角色（包括敌方和队友，不包括自身）的伤害会受攻击增伤的影响)和眩晕，[对墙缝造成伤害](会直接炸毁墙缝上的泡泡，且仍造成全额伤害)，并[炸毁范围内的火箭](猫咪在绑老鼠前需要先修复火箭；火药桶的下端判定相对较大)，若其上有老鼠则[将其救下](视作航海士杰瑞进行的救援，可触发知识卡-无畏/舍己等)。猫咪可以[通过交互拆除火药桶](动作时长1秒)，老鼠可以通过交互推动火药桶。火药桶被部分其他道具命中时，引爆时间缩短5秒。\n火药桶与其他道具的互动关系：火药桶可被{小鞭炮}或{鞭炮束}炸飞，在火药桶左侧的鞭炮会使火药桶呈抛物线飞出，右侧的鞭炮会使火药桶水平滑行。使用特定道具斜向下45°打击桶外侧可使桶产生横向加速，其中{扁盘}产生的加速较大，约为{玻璃杯}的两倍。未引爆的鞭炮也可以使桶位移，且不会缩短引线。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        cancelableSkill: ['跳跃键'],
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '放置一个{火炮}。老鼠可通过交互键进入火炮，通过投掷键发射自身，对碰到的敌方造成伤害与眩晕，碰到绑在火箭上的队友时自动进行救援交互。火炮内不会被投掷道具及部分技能命中。若火炮内老鼠进入虚弱，则火炮会提前消失。同一房间最多出现两个火炮。火炮持续数秒后消失。火炮会在小地图上全程暴露位置。',
        detailedDescription:
          '放置一个{火炮}。老鼠可通过交互键进入火炮（交互动作时长1秒），通过拖拽投掷键选择方向发射自身，无视部分平台阻挡，碰到敌方或[部分物体](包括墙缝泡泡，雪夜古堡卧室国王，天宫嫦娥等)会[反弹](速度不变，方向遵循反射定律，碰撞角色时的反射面固定为竖直面)，若为敌方则对其造成[50](基础伤害50，受被发射者的攻击增伤影响，视作被发射者造成的伤害。例如航海士杰瑞自己使用时会造成70伤害)伤害与1.5秒眩晕，碰到绑在火箭上的队友时自动进行救援交互，碰到地面或跳跃时结束被发射状态。火炮内不会被投掷道具及部分技能命中。若火炮内老鼠进入虚弱，则火炮会提前消失。同一房间最多出现两个火炮。火炮持续数秒后消失。火炮会在小地图上全程暴露位置。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        // cancelableSkill: '不确定是否可被打断', // FIXME
  ...
  泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '放下{感应雷}，一段时间后隐形，在敌方靠近时解除隐形，并在1.5秒后飞向敌方并爆炸，造成伤害和控制。',
        detailedDescription:
          '放下{感应雷}，一段时间后感应雷隐形。感应雷在敌方靠近时解除隐形，并在1.5秒后飞向敌方并爆炸，对周围的敌方和墙缝造成一定伤害、1.9秒爆炸眩晕和击退。爆炸也会弹飞老鼠，但不造成伤害。隐身状态的猫咪不会触发雷。雷被道具攻击后会在一段时间后原地爆炸。雷会在30秒后自然消失。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableSkill: ['道具键*'],
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '免疫鞭炮、泡泡等爆炸（不免疫{3级追求者出击}的爆炸等）；Hp恢复提升增加至5；吃食物速度提升增加至45%。',
          },
        ],
      },
    ],
    counters: [
      ...
      {
        id: '图茨',
        description: '圆滚滚的无敌克制喵喵叫，并且图茨的Hp上限低，被绝反克制。',
        isMinor: false,
      },
      {
        id: '莱特宁',
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '向前冲刺一段时间，冲刺期间移速提高，并恢复少量勇气。途径敌方会对其造成伤害，但消耗一定的勇气。只有处于勇气释放期间才能释放本技能。',
        detailedDescription:
          '向前冲刺0.7秒，冲刺期间移速提高50%，并恢复少量勇气。途径敌方会对其造成{40}伤害，但消耗一定的勇气。只有处于勇气释放期间才能释放本技能。',
        canMoveWhileUsing: false,
        canUseInAir: false,
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '举起{头盔(衍生物)}保护自己和队友，期间{无敌}，但惯性增大；小范围内的队友也{无敌}，但{禁用技能}。头盔受击会减少0.5s；救下队友后头盔剩余时间减半。',
        detailedDescription:
          '举起{头盔(衍生物)}保护自己和队友，期间{无敌}，但惯性增大、移速降低3.5%、跳跃速度降低15%；小范围内的队友也{无敌}，但{禁用技能}。头盔[受击](包括爪刀、道具、技能、来自友方的伤害)会减少0.5s；救下队友后头盔剩余时间减半。',
        canMoveWhileUsing: false,
        canUseInAir: false,
        canHitInPipe: false,
        cancelableAftercast: '无后摇',
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '蓄力投掷{长枪}。蓄力期间获得远视。蓄力时间越长，长枪速度越快。长枪对触碰的敌方造成伤害和减速。投掷后，短时间内可再次点击技能[上枪](瞬移到长枪尾部跟随飞行)。长枪碰到队友后，可携带1名友方进行飞行。期间剑客泰菲和友方进行任何操作都将离开长枪。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪在碰到墙壁、地面、向下碰到平台时将消失。',
        detailedDescription:
          '蓄力投掷{长枪}。蓄力期间视野扩大到原来的2倍，同时清除原有的视野提升效果。蓄力时间越长，长枪速度越快。蓄力至最大值需0.8s。长枪在空中会缓慢旋转。长枪对触碰的敌方造成{60}伤害和20%减速，持续2.4s。在投掷后的1.8s内，可再次点击技能[上枪](瞬移到长枪尾部跟随飞行)。长枪碰到队友后，可携带1名友方进行飞行，期间剑客泰菲和友方进行[任何操作](包括松开/按下；按键包括移动键、跳跃键、道具键、药水键（需要有药水）、技能键和特技键（包括未冷却完成和被禁用的技能；不包括被动技能的图标）、技能加点（包括被动加点）、交互键、进机器鼠键、商店购买道具（仅松开时；若上枪前已经开始购买，那么在长枪上购买完毕不会导致离开长枪）)都将离开长枪，受到眩晕或虚弱会强制离开；如果上枪时长枪恰好经过平台也会导致立刻脱离长枪。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪最大存在时间为9.9s，在碰到墙壁、地面、向下碰到平台时将消失。长枪消失、投掷1.8秒后或自己上枪后技能进入CD。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
        forecast: 0.15,
        ...
        skillLevels: [
          ...
          },
          {
            ...
            cooldown: 8,
            detailedDescription:
              '长枪速度大幅提高，蓄力超过2/3但未到最大值时，命中敌方效果改为造成[2.8s眩晕](不会减速)（无法与部分眩晕效果叠加，详见{眩晕}）；蓄力达到最大值时改为[造成3s眩晕](不会减速)。在勇气释放过程中，长枪命中猫咪时将使其无法使用技能4.8s并掉落手中道具，带飞友方时解除其受伤和虚弱。',
          },
          {
            level: 3,
      ...
      },
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '每当勇气值达到最高时，解除自身受伤状态，并获得一个持续9.8秒的护盾。（无内置CD）',
          },
        ],
      },
    ],
    ...
    skills: [
      {
        ...
        skillLevels: [
          ...
          },
          {
            ...
            detailedDescription:
              '分身存在时间增加至11.9秒，隐身持续时间增加至9.8秒。分身存在期间，可以再次点击技能键与分身换位（CD：5秒），但爬梯子、被眩晕时无法换位。',
            cooldown: 15,
          },
        ],
        canHitInPipe: false,
  ...
  剑客莉莉: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon1',
        description:
          '挥出一道{剑气}。剑气击中角色和部分墙壁可反弹一次，再次击中时剑气消失；击中平台形成{幻影}，再次点击技能按钮可传送至幻影处。剑气击中敌方将造成伤害和减速；击中友方将给予移速、救援及跳跃高度提升，且其在此期间可用额外技能键瞬移至幻影处。',
        detailedDescription:
          '挥出一道{剑气}，剑气飞行速度1750，击中角色和部分墙壁可反弹一次，再次击中时剑气消失；同时技能进入5秒读条。剑气击中平台形成{幻影}，若技能读条未结束则可再次点击技能按钮传送至幻影处，幻影存在5秒。剑气击中敌方将造成{30}伤害，并降低其40%移速、跳跃高度，持续5秒；击中[友方](包括处于虚弱状态的友方)使其移速、救援速度、跳跃高度提高25%，持续5秒，且友方可用额外技能键瞬移至幻影处。幻影未形成时，剑客莉莉自身进入读条的本技能以及队友被击中获得的额外技能均处于不可使用状态。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        // cancelableSkill: '不确定是否可被打断', // FIXME
        cancelableAftercast: '无后摇',
    ...
    mousePositioningTags: [
      {
        tagName: '辅助',
        isMinor: false,
        description: '队友{铁血}时，可用{主动技能}救活队友，建议车队配合。',
        additionalDescription: '自身也可变作道具偷袭猫，或让队友投掷。',
      },
      {
        tagName: '砸墙',
        isMinor: false,
        description: '后期15秒一个变大；{3级武器}对墙缝的增伤也很可观。',
        additionalDescription: '',
      },
    ],
    skillAllocations: [
    ...
    skills: [
      {
        ...
        type: 'active',
        description:
          '莱恩扔出{蓝图(投射物)(衍生物)}，落地后生成一张{蓝图(召唤物)(衍生物)}。接触蓝图(召唤物)的{火箭}变为{线条火箭}（燃烧速度减半），猫咪[隐身状态暂时失效](离开蓝图时恢复)且受到伤害时会短暂变为线条猫（有内置CD），并使手中老鼠掉落。再次使用技能或持续较长时间后收回蓝图。\n线条猫：只可使用移动、跳跃和爪刀，但减少受到的伤害、爪刀CD与受控时间。',
        detailedDescription:
          '莱恩扔出{蓝图(投射物)(衍生物)}，碰到敌方/平台/地面（不包括{方块}/{强化方块}）、[部分npc](如{大鸭子})或莱恩再次使用本技能时，[展开](蓝图的贴图需要一小段时间才能完全展开，该动画期间莱恩无法使用技能收回蓝图，但蓝图效果在未完全展开时就已经生效)一个大小1000×666的{蓝图(召唤物)(衍生物)}。接触蓝图(召唤物)的{火箭}变为{线条火箭}（燃烧速度减半），猫咪[隐身状态暂时失效](离开蓝图时恢复)且受到伤害时会短暂变为线条猫，持续6秒，变身时手持道具与老鼠自然掉落。变身结束后一段时间内{免疫线条猫效果}。再次使用技能或持续较长时间后收回蓝图，蓝图收起后才会进入CD。\n线条猫：只可使用移动、跳跃和爪刀，但受到的伤害和[受控时间](包括虚弱时间)减少50%，爪刀CD减少40%。',
        canMoveWhileUsing: true,
        canUseInAir: true,
        cancelableAftercast: '不可取消',
        skillLevels: [
