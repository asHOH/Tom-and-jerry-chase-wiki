    ...
    skills: [
      {
        ...
        aliases: ['庇护'],
        detailedDescription:
          '（本技能改动频繁，特性复杂，仍有机制暂未探明，数据仅供参考）展开光盾，12秒内受到的伤害降低15，并[转移范围内队友所受伤害和控制效果到自身](结算对方受到的增减伤等效果后再进行转移，不受自身增减伤影响；转移视作受到无来源的伤害和控制效果)，火箭在庇护范围内减缓燃烧速度，且倒计时归零时暂时不放飞（对[秒飞火箭](因绑上老鼠立刻减少倒计时而导致倒计时归零的火箭)不生效）。优先使用怜悯值抵扣转移的伤害，100%怜悯值可承担50伤害。', //[本技能有争议](另一种减伤说法：25伤害变10,50伤害变35,65伤害变45,75伤害变55,100伤害变65,115虚弱；另一种怜悯值消耗说法：100%怜悯值可承担60伤害)。
      },
      {
        name: '天使翅膀',
        aliases: ['翅膀'],
