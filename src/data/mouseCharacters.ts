  ...
  剑客泰菲: {
    ...
    skills: [
      ...
      },
      {
        ...
        type: 'weapon2',
        description:
          '蓄力投掷{长枪}。蓄力期间获得远视。蓄力时间越长，投掷速度越快、距离越长。长枪对触碰的敌方造成伤害和减速。投掷后，短时间内可再次点击技能瞬移到长枪尾部跟随飞行。长枪碰到队友后，可携带1名友方进行飞行。期间剑客泰菲和友方进行任何操作都将离开长枪。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪在碰到墙壁、地面、向下碰到平台时将消失。',
        detailedDescription:
          '蓄力投掷{长枪}。蓄力期间视野扩大到原来的2倍，同时清除原有的视野提升效果。蓄力时间越长，投掷速度越快、距离越长。蓄力至最大值需0.8s。长枪对触碰的敌方造成{60}伤害和20%减速，持续2.4s。在投掷后的1.8s内，可再次点击技能瞬移到长枪尾部跟随飞行。长枪碰到队友后，可携带1名友方进行飞行，期间剑客泰菲和友方进行[任何操作](包括松开/按下；按键包括移动键、跳跃键、道具键、药水键（需要有药水）、技能键和特技键（包括未冷却完成和被禁用的技能；不包括被动技能的图标）、技能加点（包括被动加点）、进机器鼠键、商店购买道具（仅松开时）)都将离开长枪，受到眩晕或虚弱会强制离开；如果瞬移时长枪恰好经过平台也会导致立刻脱离长枪。飞行中碰到[易碎道具](玻璃杯/碗/盘子/扁盘/灰花瓶/蓝花瓶/香水瓶/胡椒瓶)和打开的捕鼠夹，也会挂着该道具飞行。长枪最大存在时间为9.9s，在碰到墙壁、地面、向下碰到平台时将消失。长枪消失、投掷1.8秒后或剑菲上长枪后技能进入CD。',
        canMoveWhileUsing: false,
        canUseInAir: true,
        cancelableAftercast: '无后摇',
        forecast: 0.15,
