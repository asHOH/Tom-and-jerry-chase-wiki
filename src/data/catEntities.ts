...
export const catEntitiesDefinitions: Record<string, EntityDefinition> = {
  ...
  百科全书: {
    ...
    detailedDescription:
      '书籍被投掷时的初速度1500，对直接命中的老鼠造成{30}伤害；落地后书籍会打开，书籍打开5/5/10秒后会自动闭合，也可以再次施放技能让书籍闭合，闭合后存在10秒。书籍闭合时[造成伤害](受其他攻击增伤影响)并将老鼠夹住，随后技能进入CD。书籍闭合后存在一定时间，凯特可以通过交互键捡起书籍返还5秒冷却并将被夹住的老鼠直接抓在手中。当书籍在凯特附近闭合时，{追求者}会快速冲向书籍将其捡起并送还凯特。\n书籍与夹子有相似和不同之处（可以触发{捕鼠夹}，但无法触发{夹不住我}、{狡诈}）。被投掷的书籍也无法触发{乾坤一掷}。\n\n升级效果：Lv.3书籍对直接命中的老鼠叠加3层破绽（详见{骄傲的学霸}）。',
