...
export const catEntitiesDefinitions = {
  ...
  闪电仙人球: {
    ...
    gravity: false,
    description:
      '被召唤时向指定位置直线飞行，到达位置后停止移动，若中等范围内存在其它未连线的闪电仙人球，则与其进行连线并重置双方的存在时间，自身存在一定时间后消失。敌方男性角色碰触连线时，对其造成一定[固定{伤害}](即“不受增减伤影响”类型的伤害，详见状态效果相关界面)，使其{减速}且救援速度降低一段时间；塔拉碰触连线时，使其主动技能CD缩短至10/5/5秒，并{更改爪刀CD}为2秒(未命中)/2.5秒(命中)，获得该状态时不会影响已处于CD中的主动技能/爪刀的当次CD。',
    create: '由塔拉-牛仔的礼物选择位置发射。',
  },
  弹簧仙人球: {
    entitytype: ['投射物', '召唤物'],
