...
const itemDefinitions: Record<string, ItemDefinition> = {
  ...
  蓝花瓶: {
    ...
    walldamage: 8,
    description:
      '击中敌人时造成2.8秒眩晕以及50点伤害，击中地面时生成数个碎片。可将至多3个其他投掷类（不包括番茄和其他蓝花瓶）装入蓝花瓶内，击中敌人或地面时使花瓶内的道具掉出。',
    detailedDescription:
      '击中敌人时造成2.8秒眩晕以及50点伤害，击中地面时生成数个碎片。可将至多3个其他投掷类（不包括番茄和其他蓝花瓶）装入蓝花瓶内，击中敌人或地面时使花瓶内的道具掉出。角色处于由冰块/鞭炮/花瓶导致的眩晕时，不会再次受到来自它们的眩晕。',
    create:
      '自然刷新，每个房间初始最多刷新以下道具中的一个：果盘，冰桶，鞭炮堆，灰花瓶，蓝花瓶，拳套盒子，鞭炮束。',
    store: true,
    price: 2400,
