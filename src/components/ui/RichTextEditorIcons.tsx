...
export const BoldIcon = React.memo<IconProps>(({ className = 'h-4 w-4' }) => (
  <svg
...
export const ItalicIcon = React.memo<IconProps>(({ className = 'h-4 w-4' }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 24 24'
...
export const UnderlineIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
...
export const StrikethroughIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
...
export const InlineCodeIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
...
// List icons
export const BulletListIcon = React.memo<IconProps>(({ className = 'w-4 h-4' }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 24 24'
...
export const OrderedListIcon = React.memo<IconProps>(({ className = 'w-4 h-4' }) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    fill='none'
    viewBox='0 0 24 24'
...
// Alignment icons
export const AlignLeftIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='currentColor' viewBox='0 0 20 20'>
    <path
      fillRule='evenodd'
...
export const AlignCenterIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='currentColor' viewBox='0 0 20 20'>
    <path
      fillRule='evenodd'
...
export const AlignRightIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='currentColor' viewBox='0 0 20 20'>
    <path
      fillRule='evenodd'
...
export const BlockquoteIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='currentColor' viewBox='0 0 24 24'>
...
export const CodeBlockIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='currentColor' viewBox='0 0 20 20'>
    <path
      fillRule='evenodd'
      d='M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z'
...
export const LinkIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='none' viewBox='0 0 24 24' stroke='currentColor'>
    <path
      strokeLinecap='round'
      strokeLinejoin='round'
...
export const ImageIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='none' viewBox='0 0 24 24' stroke='currentColor'>
    <path
      strokeLinecap='round'
      strokeLinejoin='round'
...
// Undo/Redo icons
export const UndoIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='none' viewBox='0 0 24 24' stroke='currentColor'>
    <path
      strokeLinecap='round'
      strokeLinejoin='round'
...
export const RedoIcon = React.memo<IconProps>(({ className = 'size-4' }) => (
  <svg className={className} fill='none' viewBox='0 0 24 24' stroke='currentColor'>
    <path
      strokeLinecap='round'
      strokeLinejoin='round'
