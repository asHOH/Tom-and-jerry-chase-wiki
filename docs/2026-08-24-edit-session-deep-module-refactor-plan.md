...
Phase 2 left the card-rank repair of character knowledge-card references on the existing
raw-runtime path; Phase 3 migrated that cross-domain character mutation.
